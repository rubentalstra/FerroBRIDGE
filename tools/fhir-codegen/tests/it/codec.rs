...
fn every_r4_root_set_resource_round_trips() {
    round_trip_all::<fhir_types::r4::resource::Resource>("hl7.fhir.r4.core");
}

#[test]
fn every_r4b_root_set_resource_round_trips() {
    round_trip_all::<fhir_types::r4b::resource::Resource>("hl7.fhir.r4b.core");
}

#[test]
fn every_r5_root_set_resource_round_trips() {
    round_trip_all::<fhir_types::r5::resource::Resource>("hl7.fhir.r5.core");
}
...
fn decode_coding(
    ...
    fhir_types::r4b::coding::Coding::from_json(object, &mut path)
}
...
fn primitive_extensions_and_choice_types_round_trip() {
    ...
    let decoded =
        fhir_types::r4b::parameters::Parameters::from_json(object, &mut path).expect("decodes");
    ...
    let mut path = ElementPath::root("Parameters");
    let err = fhir_types::r4b::parameters::Parameters::from_json(
