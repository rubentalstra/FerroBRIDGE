...
FHIRconnect context resolution: a context mapping, its model mappings and its extensions compiled into one immutable program per profile and template.
...
[FerroBRIDGE issue #83](https://github.com/rubentalstra/FerroBRIDGE/issues/83),
