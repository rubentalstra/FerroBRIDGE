...
pub struct BodyStructure {
    ...
    /// structure.
    pub location: Option<super::codeable_concept::CodeableConcept>,
    /// Body site modifier
    ///
    ...
    pub location_qualifier: Vec<super::codeable_concept::CodeableConcept>,
    /// Text description
    ///
...
impl super::super::codec::Json for BodyStructure {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.location_qualifier.is_empty() {
            let mut items = Vec::with_capacity(self.location_qualifier.len());
            for item in &self.location_qualifier {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("locationQualifier"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_location_qualifier: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "locationQualifier" => {
                    raw_location_qualifier = Some(value);
                }
                "description" => {
        ...
        let field_location = raw_location
            ...
            .transpose()?;
        let mut field_location_qualifier = Vec::new();
        if let Some(raw) = raw_location_qualifier {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_location_qualifier.push(path.with_index(
                    "locationQualifier",
                    index,
                    |path| {
                        super::super::codec::Json::from_json(
        ...
        Ok(Self {
            ...
            location_qualifier: field_location_qualifier,
