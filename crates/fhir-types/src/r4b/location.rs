...
pub struct LocationHoursOfOperation {
    ...
    pub opening_time: Option<super::primitives::Time>,
    /// Time that the Location closes.
    pub closing_time: Option<super::primitives::Time>,
}

impl super::super::codec::Json for LocationHoursOfOperation {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if let Some(item) = &self.opening_time {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("openingTime"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_openingTime"), e);
            }
        }
        if let Some(item) = &self.closing_time {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("closingTime"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_closingTime"), e);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut raw_opening_time: Option<&super::super::codec::Value> = None;
        let mut raw_opening_time_element: Option<&super::super::codec::Value> = None;
        let mut raw_closing_time: Option<&super::super::codec::Value> = None;
        let mut raw_closing_time_element: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "openingTime" => {
                    raw_opening_time = Some(value);
                }
                "_openingTime" => {
                    raw_opening_time_element = Some(value);
                }
                "closingTime" => {
                    raw_closing_time = Some(value);
                }
                "_closingTime" => {
                    raw_closing_time_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_opening_time = match (raw_opening_time, raw_opening_time_element) {
            (None, None) => None,
            (value, element) => Some(path.with("openingTime", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        let field_closing_time = match (raw_closing_time, raw_closing_time_element) {
            (None, None) => None,
            (value, element) => Some(path.with("closingTime", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        Ok(Self {
            ...
            opening_time: field_opening_time,
            closing_time: field_closing_time,
        })
    }
}
...
impl serde::Serialize for LocationHoursOfOperation {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.closing_time {
            super::super::codec::element_entry(&mut map, "_closingTime", item)?;
        }
        super::super::codec::element_list_entry(&mut map, "_daysOfWeek", &self.days_of_week)?;
        if let Some(item) = &self.opening_time {
            super::super::codec::element_entry(&mut map, "_openingTime", item)?;
        }
        if let Some(item) = &self.all_day {
            super::super::codec::value_entry(&mut map, "allDay", item)?;
        }
        if let Some(item) = &self.closing_time {
            super::super::codec::value_entry(&mut map, "closingTime", item)?;
        }
        ...
        if let Some(item) = &self.opening_time {
            super::super::codec::value_entry(&mut map, "openingTime", item)?;
        }
        serde::ser::SerializeMap::end(map)
    }
}

impl<'de> serde::Deserialize<'de> for LocationHoursOfOperation {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("LocationHoursOfOperation");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
