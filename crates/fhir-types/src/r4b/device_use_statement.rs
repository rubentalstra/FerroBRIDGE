...
pub struct DeviceUseStatement {
    ...
    pub recorded_on: Option<super::primitives::DateTime>,
...
impl super::super::codec::Json for DeviceUseStatement {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("DeviceUseStatement")),
        );
        ...
        if let Some(item) = &self.recorded_on {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("recordedOn"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_recordedOn"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_recorded_on: Option<&super::super::codec::Value> = None;
        let mut raw_recorded_on_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("DeviceUseStatement") {
                ...
                "recordedOn" => {
                    raw_recorded_on = Some(value);
                }
                "_recordedOn" => {
                    raw_recorded_on_element = Some(value);
                }
                "source" => {
        ...
        let field_timing = match raw_timing.suffix {
            ...
            Some(suffix) => Some(path.with("timing", |path| {
                DeviceUseStatementTiming::from_json_parts(
                    suffix,
                    raw_timing.value,
                    raw_timing.element,
                    path,
        ...
        let field_recorded_on = match (raw_recorded_on, raw_recorded_on_element) {
            (None, None) => None,
            (value, element) => Some(path.with("recordedOn", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
...
impl serde::Serialize for DeviceUseStatement {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.recorded_on {
            super::super::codec::element_entry(&mut map, "_recordedOn", item)?;
        }
        super::super::codec::element_entry(&mut map, "_status", &self.status)?;
        if let Some(DeviceUseStatementTiming::DateTime(inner)) = &self.timing {
        ...
        if let Some(item) = &self.recorded_on {
            super::super::codec::value_entry(&mut map, "recordedOn", item)?;
        }
        serde::ser::SerializeMap::serialize_entry(&mut map, "resourceType", "DeviceUseStatement")?;
        if let Some(item) = &self.source {
        ...
        match &self.timing {
            Some(DeviceUseStatementTiming::DateTime(inner)) => {
                super::super::codec::value_entry(&mut map, "timingDateTime", inner)?;
            }
            Some(DeviceUseStatementTiming::Period(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "timingPeriod",
                    inner.as_ref(),
            ...
            Some(DeviceUseStatementTiming::Timing(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "timingTiming",
                    inner.as_ref(),
...
impl<'de> serde::Deserialize<'de> for DeviceUseStatement {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("DeviceUseStatement");
        let object =
...
/// The \`timing\[x\]\` choice of \`DeviceUseStatement\`.
///
/// How often the device was used.
