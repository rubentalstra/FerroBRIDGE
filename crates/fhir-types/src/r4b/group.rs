...
pub struct Group {
    ...
    pub actual: super::primitives::Boolean,
...
impl super::super::codec::Json for Group {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(v) = super::super::codec::Primitive::value_json(&self.actual)? {
            object.insert(std::string::String::from("actual"), v);
        }
        if let Some(e) = super::super::codec::Primitive::element_json(&self.actual)? {
    ...
    fn from_json(
        ...
        let field_actual = path.with("actual", |path| {
            super::super::codec::Primitive::from_json_parts(raw_actual, raw_actual_element, path)
        })?;
...
impl serde::Serialize for Group {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        super::super::codec::element_entry(&mut map, "_actual", &self.actual)?;
        if let Some(item) = &self.implicit_rules {
        ...
        super::super::codec::value_entry(&mut map, "actual", &self.actual)?;
        if !self.characteristic.is_empty() {
