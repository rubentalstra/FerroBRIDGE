...
//! FHIR R4B types: the root set the enabled features select and the complete
//! closure of the datatypes and primitives it references, from `hl7.fhir.r4b.core` 4.3.0.
//!
