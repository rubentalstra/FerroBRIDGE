...
pub struct GuidanceResponse {
    ...
    pub result: Option<super::reference::Reference>,
...
impl super::super::codec::Json for GuidanceResponse {
    ...
    fn from_json(
        ...
        let field_output_parameters = raw_output_parameters
            ...
            .transpose()?;
        let field_result = raw_result
            .map(|value| {
                path.with("result", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
...
impl serde::Serialize for GuidanceResponse {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.result {
            serde::ser::SerializeMap::serialize_entry(&mut map, "result", item)?;
        }
