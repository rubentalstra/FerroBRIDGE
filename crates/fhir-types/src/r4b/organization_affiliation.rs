...
pub struct OrganizationAffiliation {
    ...
    /// of).
    pub participating_organization: Option<super::reference::Reference>,
...
impl super::super::codec::Json for OrganizationAffiliation {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.participating_organization {
            object.insert(
                std::string::String::from("participatingOrganization"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_participating_organization: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("OrganizationAffiliation") {
                ...
                "participatingOrganization" => {
                    raw_participating_organization = Some(value);
                }
                "network" => {
        ...
        let field_organization = raw_organization
            ...
            .transpose()?;
        let field_participating_organization = raw_participating_organization
            .map(|value| {
                path.with("participatingOrganization", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            participating_organization: field_participating_organization,
...
impl serde::Serialize for OrganizationAffiliation {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.participating_organization {
            serde::ser::SerializeMap::serialize_entry(&mut map, "participatingOrganization", item)?;
        }
        if let Some(item) = &self.period {
...
impl<'de> serde::Deserialize<'de> for OrganizationAffiliation {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("OrganizationAffiliation");
        let object =
