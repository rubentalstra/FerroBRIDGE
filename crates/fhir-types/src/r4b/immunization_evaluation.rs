    ...
    fn from_json(
        ...
        let field_dose_number = match raw_dose_number.suffix {
            ...
            Some(suffix) => Some(path.with("doseNumber", |path| {
                ImmunizationEvaluationDoseNumber::from_json_parts(
                    suffix,
        ...
        let field_series_doses = match raw_series_doses.suffix {
            ...
            Some(suffix) => Some(path.with("seriesDoses", |path| {
                ImmunizationEvaluationSeriesDoses::from_json_parts(
                    suffix,
...
impl serde::Serialize for ImmunizationEvaluation {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.dose_number {
            Some(ImmunizationEvaluationDoseNumber::PositiveInt(inner)) => {
                super::super::codec::element_entry(&mut map, "_doseNumberPositiveInt", inner)?;
            }
            Some(ImmunizationEvaluationDoseNumber::String(inner)) => {
        ...
        match &self.series_doses {
            Some(ImmunizationEvaluationSeriesDoses::PositiveInt(inner)) => {
                super::super::codec::element_entry(&mut map, "_seriesDosesPositiveInt", inner)?;
            }
            Some(ImmunizationEvaluationSeriesDoses::String(inner)) => {
...
/// The \`doseNumber\[x\]\` choice of \`ImmunizationEvaluation\`.
///
/// Nominal position in a series.
...
impl ImmunizationEvaluationDoseNumber {
...
/// The \`seriesDoses\[x\]\` choice of \`ImmunizationEvaluation\`.
///
/// The recommended number of doses to achieve immunity.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl ImmunizationEvaluationSeriesDoses {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
