...
pub struct PlanDefinitionAction {
    ...
    pub input: Vec<super::data_requirement::DataRequirement>,
    /// Output data definition
    ///
    /// Defines the outputs of the action, if any.
    pub output: Vec<super::data_requirement::DataRequirement>,
...
impl serde::Serialize for PlanDefinitionAction {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(PlanDefinitionActionTiming::DateTime(inner)) = &self.timing {
        ...
        match &self.timing {
            ...
            Some(PlanDefinitionActionTiming::DateTime(inner)) => {
            ...
            Some(PlanDefinitionActionTiming::Period(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "timingPeriod",
                    inner.as_ref(),
