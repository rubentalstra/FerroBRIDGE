...
pub struct ActivityDefinition {
    ...
    pub specimen_requirement: Vec<super::reference::Reference>,
    /// What observations are required to perform this action
    ///
    /// Defines observation requirements for the action to be performed, such as
    /// body weight or surface area.
    pub observation_requirement: Vec<super::reference::Reference>,
    /// What observations must be produced by this action
    ///
    /// Defines the observations that are expected to be produced by the action.
    pub observation_result_requirement: Vec<super::reference::Reference>,
...
impl super::super::codec::Json for ActivityDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.specimen_requirement.is_empty() {
            let mut items = Vec::with_capacity(self.specimen_requirement.len());
            for item in &self.specimen_requirement {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("specimenRequirement"),
                super::super::codec::Value::Array(items),
            );
        }
        if !self.observation_requirement.is_empty() {
            let mut items = Vec::with_capacity(self.observation_requirement.len());
            for item in &self.observation_requirement {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("observationRequirement"),
                super::super::codec::Value::Array(items),
            );
        }
        if !self.observation_result_requirement.is_empty() {
            let mut items = Vec::with_capacity(self.observation_result_requirement.len());
            for item in &self.observation_result_requirement {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
    ...
    fn from_json(
        ...
        if let Some(raw) = raw_specimen_requirement {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
        ...
        if let Some(raw) = raw_observation_requirement {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
        ...
        if let Some(raw) = raw_observation_result_requirement {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
...
impl serde::Serialize for ActivityDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ActivityDefinitionTiming::DateTime(inner)) = &self.timing {
        ...
        match &self.timing {
            ...
            Some(ActivityDefinitionTiming::DateTime(inner)) => {
            ...
            Some(ActivityDefinitionTiming::Period(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "timingPeriod",
                    inner.as_ref(),
