...
pub struct Goal {
    ...
    pub expressed_by: Option<super::reference::Reference>,
    ...
    pub outcome_code: Vec<super::codeable_concept::CodeableConcept>,
...
impl super::super::codec::Json for Goal {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.expressed_by {
            object.insert(
                std::string::String::from("expressedBy"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        ...
        if !self.outcome_code.is_empty() {
            let mut items = Vec::with_capacity(self.outcome_code.len());
            for item in &self.outcome_code {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("outcomeCode"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_expressed_by: Option<&super::super::codec::Value> = None;
        let mut raw_addresses: Option<&super::super::codec::Value> = None;
        let mut raw_note: Option<&super::super::codec::Value> = None;
        let mut raw_outcome_code: Option<&super::super::codec::Value> = None;
        ...
        let field_expressed_by = raw_expressed_by
            .map(|value| {
                path.with("expressedBy", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        let mut field_outcome_code = Vec::new();
        if let Some(raw) = raw_outcome_code {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_outcome_code.push(path.with_index("outcomeCode", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        Ok(Self {
            ...
            expressed_by: field_expressed_by,
            addresses: field_addresses,
            note: field_note,
            outcome_code: field_outcome_code,
...
impl serde::Serialize for Goal {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.expressed_by {
            serde::ser::SerializeMap::serialize_entry(&mut map, "expressedBy", item)?;
        }
        if !self.extension.is_empty() {
        ...
        if !self.outcome_code.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "outcomeCode", &self.outcome_code)?;
        }
        if !self.outcome_reference.is_empty() {
            serde::ser::SerializeMap::serialize_entry(
                &mut map,
