...
impl super::super::codec::Json for PaymentNotice {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::Object(super::super::codec::Json::to_json(&self.payment)?),
        );
    ...
    fn from_json(
        ...
        let field_provider = raw_provider
            ...
            .transpose()?;
        let field_payment = path.with("payment", |path| {
            let value = raw_payment
...
impl serde::Serialize for PaymentNotice {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        serde::ser::SerializeMap::serialize_entry(&mut map, "payment", &self.payment)?;
        if let Some(item) = &self.payment_date {
