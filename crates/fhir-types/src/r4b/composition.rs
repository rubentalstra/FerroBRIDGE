...
pub struct Composition {
    ...
    pub confidentiality: Option<super::primitives::Code>,
...
impl super::super::codec::Json for Composition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.confidentiality {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("confidentiality"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_confidentiality"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_confidentiality_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "_confidentiality" => {
                    raw_confidentiality_element = Some(value);
                }
                "attester" => {
        ...
        let field_confidentiality = match (raw_confidentiality, raw_confidentiality_element) {
            (None, None) => None,
            (value, element) => Some(path.with("confidentiality", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
...
impl serde::Serialize for Composition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.confidentiality {
            super::super::codec::element_entry(&mut map, "_confidentiality", item)?;
        }
        ...
        if let Some(item) = &self.confidentiality {
            super::super::codec::value_entry(&mut map, "confidentiality", item)?;
        }
        if !self.contained.is_empty() {
...
impl serde::Serialize for CompositionRelatesTo {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.target {
            CompositionRelatesToTarget::Identifier(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "targetIdentifier",
                    inner.as_ref(),
