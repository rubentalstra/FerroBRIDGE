...
pub struct ResearchDefinition {
    ...
    pub exposure_alternative: Option<super::reference::Reference>,
    /// What outcome?
    ///
    /// A reference to a ResearchElementDefinition resomece that defines the outcome
    /// for the research.
    pub outcome: Option<super::reference::Reference>,
}

impl super::super::codec::Json for ResearchDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("ResearchDefinition")),
        );
        ...
        if let Some(item) = &self.exposure_alternative {
            object.insert(
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("ResearchDefinition") {
        ...
        let field_subject = match raw_subject.suffix {
            ...
            Some(suffix) => Some(path.with("subject", |path| {
                ResearchDefinitionSubject::from_json_parts(
                    suffix,
                    raw_subject.value,
                    raw_subject.element,
                    path,
        ...
        let field_exposure = raw_exposure
            ...
            .transpose()?;
        let field_exposure_alternative = raw_exposure_alternative
            .map(|value| {
                path.with("exposureAlternative", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
...
impl serde::Serialize for ResearchDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.exposure_alternative {
            serde::ser::SerializeMap::serialize_entry(&mut map, "exposureAlternative", item)?;
        }
        if !self.extension.is_empty() {
        ...
        serde::ser::SerializeMap::serialize_entry(&mut map, "resourceType", "ResearchDefinition")?;
        if !self.reviewer.is_empty() {
        ...
        match &self.subject {
            Some(ResearchDefinitionSubject::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "subjectCodeableConcept",
                    inner.as_ref(),
            ...
            Some(ResearchDefinitionSubject::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "subjectReference",
                    inner.as_ref(),
...
impl<'de> serde::Deserialize<'de> for ResearchDefinition {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("ResearchDefinition");
        let object =
...
/// The \`subject\[x\]\` choice of \`ResearchDefinition\`.
///
/// The intended subjects for the ResearchDefinition. If this element is not
/// provided, a Patient subject is assumed, but the subject of the
/// ResearchDefinition can be anything.
...
impl ResearchDefinitionSubject {
