...
pub struct ImplementationGuideDefinitionPage {
    ...
    pub name: ImplementationGuideDefinitionPageName,
...
impl super::super::codec::Json for ImplementationGuideDefinitionPage {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        let (suffix, value, element) = self.name.to_json_parts()?;
        if let Some(value) = value {
            object.insert(format!("name{suffix}"), value);
        }
        if let Some(element) = element {
            object.insert(format!("_name{suffix}"), element);
        }
    ...
    fn from_json(
        ...
        let mut raw_extension: Option<&super::super::codec::Value> = None;
        let mut raw_modifier_extension: Option<&super::super::codec::Value> = None;
        let mut raw_name = super::super::codec::ChoiceSlot::default();
        let mut raw_title: Option<&super::super::codec::Value> = None;
        let mut raw_title_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "nameUrl" => {
                    raw_name.value("Url", value, path)?;
                }
                "_nameUrl" => {
                    raw_name.element("Url", value, path)?;
                }
                "nameReference" => {
                    raw_name.value("Reference", value, path)?;
                }
                "_nameReference" => {
                    raw_name.element("Reference", value, path)?;
                }
                "title" => {
                    raw_title = Some(value);
                }
        ...
        let field_name = path.with("name", |path| {
            ...
            ImplementationGuideDefinitionPageName::from_json_parts(
                suffix,
                raw_name.value,
                raw_name.element,
                path,
...
impl serde::Serialize for ImplementationGuideDefinitionPage {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let ImplementationGuideDefinitionPageName::Url(inner) = &self.name {
            super::super::codec::element_entry(&mut map, "_nameUrl", inner)?;
        }
        ...
        match &self.name {
            ImplementationGuideDefinitionPageName::Reference(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "nameReference",
                    inner.as_ref(),
            ...
            ImplementationGuideDefinitionPageName::Url(inner) => {
                super::super::codec::value_entry(&mut map, "nameUrl", inner)?;
            }
        }
        if !self.page.is_empty() {
...
/// The \`name\[x\]\` choice of \`ImplementationGuideDefinitionPage\`.
///
/// The source address for the page.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl ImplementationGuideDefinitionPageName {
...
impl super::super::codec::Json for ImplementationGuideDefinitionResource {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.example {
            let (suffix, value, element) = item.to_json_parts()?;
            if let Some(value) = value {
                object.insert(format!("example{suffix}"), value);
            }
            if let Some(element) = element {
                object.insert(format!("_example{suffix}"), element);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_description: Option<&super::super::codec::Value> = None;
        let mut raw_description_element: Option<&super::super::codec::Value> = None;
        let mut raw_example = super::super::codec::ChoiceSlot::default();
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "exampleBoolean" => {
                    raw_example.value("Boolean", value, path)?;
                }
                "_exampleBoolean" => {
                    raw_example.element("Boolean", value, path)?;
                }
                "exampleCanonical" => {
                    raw_example.value("Canonical", value, path)?;
                }
                "_exampleCanonical" => {
                    raw_example.element("Canonical", value, path)?;
                }
                "groupingId" => {
        ...
        let field_example = match raw_example.suffix {
            None => None,
            Some(suffix) => Some(path.with("example", |path| {
                ImplementationGuideDefinitionResourceExample::from_json_parts(
                    suffix,
                    raw_example.value,
                    raw_example.element,
                    path,
...
impl serde::Serialize for ImplementationGuideDefinitionResource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.example {
            Some(ImplementationGuideDefinitionResourceExample::Boolean(inner)) => {
                super::super::codec::element_entry(&mut map, "_exampleBoolean", inner)?;
            }
            Some(ImplementationGuideDefinitionResourceExample::Canonical(inner)) => {
                super::super::codec::element_entry(&mut map, "_exampleCanonical", inner)?;
            }
            None => {}
        }
        super::super::codec::element_list_entry(&mut map, "_fhirVersion", &self.fhir_version)?;
        ...
        match &self.example {
            Some(ImplementationGuideDefinitionResourceExample::Boolean(inner)) => {
                super::super::codec::value_entry(&mut map, "exampleBoolean", inner)?;
            }
            Some(ImplementationGuideDefinitionResourceExample::Canonical(inner)) => {
                super::super::codec::value_entry(&mut map, "exampleCanonical", inner)?;
            }
            None => {}
        }
        if !self.extension.is_empty() {
...
/// The \`example\[x\]\` choice of \`ImplementationGuideDefinitionResource\`.
///
/// If true or a reference, indicates the resource is an example instance. If a
/// reference is present, indicates that the example is an example of the
/// specified profile.
...
impl ImplementationGuideDefinitionResourceExample {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
...
impl super::super::codec::Json for ImplementationGuideManifestResource {
    ...
    fn from_json(
        ...
        let field_example = match raw_example.suffix {
            None => None,
            Some(suffix) => Some(path.with("example", |path| {
                ImplementationGuideManifestResourceExample::from_json_parts(
                    suffix,
                    raw_example.value,
                    raw_example.element,
                    path,
...
impl serde::Serialize for ImplementationGuideManifestResource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        match &self.example {
            Some(ImplementationGuideManifestResourceExample::Boolean(inner)) => {
                super::super::codec::element_entry(&mut map, "_exampleBoolean", inner)?;
            }
            Some(ImplementationGuideManifestResourceExample::Canonical(inner)) => {
                super::super::codec::element_entry(&mut map, "_exampleCanonical", inner)?;
            }
            None => {}
        }
...
/// The \`example\[x\]\` choice of \`ImplementationGuideManifestResource\`.
///
/// If true or a reference, indicates the resource is an example instance. If a
/// reference is present, indicates that the example is an example of the
/// specified profile.
...
impl ImplementationGuideManifestResourceExample {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
