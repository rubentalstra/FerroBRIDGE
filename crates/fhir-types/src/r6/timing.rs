...
impl super::super::codec::Json for TimingRepeat {
    ...
    fn from_json(
        ...
        let mut raw_start_offset: Option<&super::super::codec::Value> = None;
        let mut raw_end_offset: Option<&super::super::codec::Value> = None;
...
impl serde::Serialize for TimingRepeat {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.end_offset {
            serde::ser::SerializeMap::serialize_entry(&mut map, "endOffset", item)?;
        }
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        ...
        if let Some(item) = &self.start_offset {
            serde::ser::SerializeMap::serialize_entry(&mut map, "startOffset", item)?;
        }
