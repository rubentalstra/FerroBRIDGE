...
pub struct QuestionnaireResponse {
    ...
    /// are being provided.
    pub questionnaire: super::primitives::Canonical,
...
impl super::super::codec::Json for QuestionnaireResponse {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(v) = super::super::codec::Primitive::value_json(&self.questionnaire)? {
            object.insert(std::string::String::from("questionnaire"), v);
        }
        if let Some(e) = super::super::codec::Primitive::element_json(&self.questionnaire)? {
    ...
    fn from_json(
        ...
        let field_questionnaire = path.with("questionnaire", |path| {
            super::super::codec::Primitive::from_json_parts(
                raw_questionnaire,
                raw_questionnaire_element,
                path,
            )
        })?;
...
impl serde::Serialize for QuestionnaireResponse {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        super::super::codec::element_entry(&mut map, "_questionnaire", &self.questionnaire)?;
        ...
        super::super::codec::value_entry(&mut map, "questionnaire", &self.questionnaire)?;
        serde::ser::SerializeMap::serialize_entry(
            &mut map,
            "resourceType",
...
pub struct QuestionnaireResponseItemAnswer {
    ...
    /// question.
    pub value: QuestionnaireResponseItemAnswerValue,
...
impl serde::Serialize for QuestionnaireResponseItemAnswer {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.value {
            QuestionnaireResponseItemAnswerValue::Attachment(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueAttachment",
                    inner.as_ref(),
            ...
            QuestionnaireResponseItemAnswerValue::Coding(inner) => {
            ...
            QuestionnaireResponseItemAnswerValue::Quantity(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueQuantity",
                    inner.as_ref(),
            ...
            QuestionnaireResponseItemAnswerValue::Reference(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueReference",
                    inner.as_ref(),
