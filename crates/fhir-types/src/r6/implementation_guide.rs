...
pub struct ImplementationGuide {
    ...
    /// Jurisdiction of the authority that maintains the implementation guide (if
    /// applicable)
    ///
    ...
    /// must conform to. If there is more than one profile for a type, then
    /// resources SHALL conform to one of them.
