...
pub struct BiologicallyDerivedProduct {
    ...
    /// multiple categories, for example a human heart valve can be categorized as
    /// an 'MPHO' and 'tissue'.
    pub product_category: Vec<super::codeable_concept::CodeableConcept>,
    ...
    /// BiologicallyDerivedProduct instances that are intended to be administered in
    /// the course of the same given therapy. The presence of the same identifier on
    /// each BiologicallyDerivedProduct ties those products together.
    pub therapy_identifier: Vec<super::identifier::Identifier>,
...
impl super::super::codec::Json for BiologicallyDerivedProduct {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.product_category.is_empty() {
            let mut items = Vec::with_capacity(self.product_category.len());
            for item in &self.product_category {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
        ...
        if !self.therapy_identifier.is_empty() {
            let mut items = Vec::with_capacity(self.therapy_identifier.len());
            for item in &self.therapy_identifier {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("therapyIdentifier"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_therapy_identifier: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "therapyIdentifier" => {
                    raw_therapy_identifier = Some(value);
                }
        ...
        let mut field_product_category = Vec::new();
        if let Some(raw) = raw_product_category {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_product_category.push(path.with_index("productCategory", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        let mut field_therapy_identifier = Vec::new();
        if let Some(raw) = raw_therapy_identifier {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_therapy_identifier.push(path.with_index(
                    "therapyIdentifier",
                    index,
                    |path| {
                        super::super::codec::Json::from_json(
        ...
        Ok(Self {
            ...
            therapy_identifier: field_therapy_identifier,
...
impl super::super::codec::Json for BiologicallyDerivedProductCollection {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.source_patient {
            object.insert(
                std::string::String::from("sourcePatient"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        if let Some(item) = &self.source_organization {
            object.insert(
                std::string::String::from("sourceOrganization"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_source_patient: Option<&super::super::codec::Value> = None;
        let mut raw_source_organization: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "sourcePatient" => {
                    raw_source_patient = Some(value);
                }
                "sourceOrganization" => {
                    raw_source_organization = Some(value);
                }
                "collectedDateTime" => {
        ...
        let field_collector = raw_collector
            ...
            .transpose()?;
        let field_source_patient = raw_source_patient
            .map(|value| {
                path.with("sourcePatient", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
            ...
            .transpose()?;
        let field_source_organization = raw_source_organization
            .map(|value| {
                path.with("sourceOrganization", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            source_patient: field_source_patient,
            source_organization: field_source_organization,
...
impl serde::Serialize for BiologicallyDerivedProductCollection {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.source_organization {
            serde::ser::SerializeMap::serialize_entry(&mut map, "sourceOrganization", item)?;
        }
        if let Some(item) = &self.source_patient {
            serde::ser::SerializeMap::serialize_entry(&mut map, "sourcePatient", item)?;
        }
        serde::ser::SerializeMap::end(map)
    }
}
