...
//! If a code is provided, either a system or inferSystem \*\*SHOULD\*\* be
//! provided. The operation returns a result (true / false), an error
//! message, and the recommended display for the code. When validating a
//! code or a coding, then the code, system and version output parameters
//! \*\*SHOULD\*\* be populated when possible. When a validating a
//! CodeableConcept, then the codeableConcept output parameter
//! \*\*SHOULD\*\* be populated when possible. Implementers should note that
...
pub struct ValueSetValidateCodeRequest {
    ...
    /// The version of the system, if one was provided in the source data. Note
    /// that this is a different parameter to system-version
    ...
    /// If this parameter has a value of true or the parameter is omitted, the
    ...
    /// Specifies the language for display validation. Note: the display value
    /// only needs to match 1 displayLanguage in order for the validate
    /// operation to return true.
    pub display_language: Vec<super::super::primitives::Code>,
    ...
    /// If true, the terminology server is required to infer the system from
    ...
    /// by no FHIR version. Whether an inactive concept is refused as outside
    /// the value set.
...
impl ValueSetValidateCodeRequest {
    ...
    pub fn from_parameter_list(
        ...
        let mut field_display_language: Vec<super::super::primitives::Code> = Vec::new();
        ...
        for parameter in list {
            ...
            match parameter_name {
                ...
                "displayLanguage" => {
                    field_display_language.push(match &parameter.value {
                        Some(super::super::parameters::ParametersParameterValue::Code(value)) => {
                            value.clone()
                        }
                        Some(super::super::parameters::ParametersParameterValue::String(value)) => {
    ...
    pub fn into_parameter_list(self) -> Vec<super::super::parameters::ParametersParameter> {
        ...
        for value in self.display_language {
            out.push(super::super::parameters::ParametersParameter {
