...
/// care for a patient, but who is not the primary target of healthcare.
...
impl super::super::codec::Json for RelatedPerson {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("RelatedPerson")),
        );
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("RelatedPerson") {
...
impl serde::Serialize for RelatedPerson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        serde::ser::SerializeMap::serialize_entry(&mut map, "resourceType", "RelatedPerson")?;
        if !self.role.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RelatedPerson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RelatedPerson");
        let object =
...
impl super::super::codec::Json for RelatedPersonCommunication {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl<'de> serde::Deserialize<'de> for RelatedPersonCommunication {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RelatedPersonCommunication");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
