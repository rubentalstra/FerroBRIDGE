...
pub struct Dosage {
    ...
    pub condition: Vec<super::dosage_condition::DosageCondition>,
    ...
    pub site: Option<super::codeable_reference::CodeableReference>,
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "doseExpression" => {
                    raw_dose.value("Expression", value, path)?;
                }
                "_doseExpression" => {
                    raw_dose.element("Expression", value, path)?;
                }
                "rateRatio" => {
                ...
                "rateExpression" => {
                    raw_rate.value("Expression", value, path)?;
                }
                "_rateExpression" => {
                    raw_rate.element("Expression", value, path)?;
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
