...
pub struct Signature {
    ...
    pub when: Option<super::primitives::Instant>,
    /// Who signed
    ///
...
impl super::super::codec::Json for Signature {
    ...
    fn from_json(
        ...
        let mut raw_target_format: Option<&super::super::codec::Value> = None;
        let mut raw_target_format_element: Option<&super::super::codec::Value> = None;
        let mut raw_sig_format: Option<&super::super::codec::Value> = None;
        let mut raw_sig_format_element: Option<&super::super::codec::Value> = None;
        ...
        let field_when = match (raw_when, raw_when_element) {
            (None, None) => None,
            (value, element) => Some(path.with("when", |path| {
...
impl serde::Serialize for Signature {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.when {
            super::super::codec::element_entry(&mut map, "_when", item)?;
        }
        if let Some(item) = &self.data {
        ...
        if let Some(item) = &self.when {
            super::super::codec::value_entry(&mut map, "when", item)?;
        }
        if let Some(item) = &self.who {
