...
pub struct TerminologyCapabilities {
    ...
    /// Jurisdiction of the authority that maintains the terminology capabilities
    /// (if applicable)
    ///
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "codeSearch" => {
                    raw_code_search = Some(value);
                }
                "_codeSearch" => {
                    raw_code_search_element = Some(value);
                }
                "validateCode" => {
                    raw_validate_code = Some(value);
                }
                "translation" => {
        ...
        let field_supplements = raw_supplements
            .map(|value| {
                path.with("supplements", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
...
impl serde::Serialize for TerminologyCapabilities {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.supplements {
            serde::ser::SerializeMap::serialize_entry(&mut map, "supplements", item)?;
        }
        if let Some(item) = &self.text {
...
pub struct TerminologyCapabilitiesCodeSystem {
    ...
    /// modifierExtension itself).
    pub modifier_extension: Vec<super::extension::Extension>,
    /// Canonical identifier for the code system, represented as a URI (no version
    /// portion)
    ///
...
impl super::super::codec::Json for TerminologyCapabilitiesCodeSystem {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.supplement.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.supplement)?;
            object.insert(std::string::String::from("supplement"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_supplement"), elements);
            }
        }
        if let Some(item) = &self.version_algorithm {
            let (suffix, value, element) = item.to_json_parts()?;
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "_supplement" => {
                    raw_supplement_element = Some(value);
                }
                "versionAlgorithmString" => {
                    raw_version_algorithm.value("String", value, path)?;
                }
                ...
                "subsumption" => {
                    raw_subsumption = Some(value);
                }
                "_subsumption" => {
                    raw_subsumption_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_supplement, raw_supplement_element, path)?
                .into_iter()
                .enumerate()
        {
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            None => None,
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                TerminologyCapabilitiesCodeSystemVersionAlgorithm::from_json_parts(
                    suffix,
                    raw_version_algorithm.value,
                    raw_version_algorithm.element,
                    path,
...
impl serde::Serialize for TerminologyCapabilitiesCodeSystem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        super::super::codec::element_list_entry(&mut map, "_supplement", &self.supplement)?;
        if let Some(item) = &self.uri {
            super::super::codec::element_entry(&mut map, "_uri", item)?;
        }
        if let Some(TerminologyCapabilitiesCodeSystemVersionAlgorithm::String(inner)) =
            &self.version_algorithm
        {
            super::super::codec::element_entry(&mut map, "_versionAlgorithmString", inner)?;
        }
        ...
        super::super::codec::value_list_entry(&mut map, "supplement", &self.supplement)?;
        if let Some(item) = &self.uri {
        ...
        match &self.version_algorithm {
            Some(TerminologyCapabilitiesCodeSystemVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(TerminologyCapabilitiesCodeSystemVersionAlgorithm::String(inner)) => {
                super::super::codec::value_entry(&mut map, "versionAlgorithmString", inner)?;
            }
            None => {}
        }
...
pub struct TerminologyCapabilitiesCodeSystemVersion {
    ...
    /// defines) are represented in this resource instance.
    pub content: Option<super::primitives::Code>,
    /// Canonical identifier for a supported supplement to this code system version
    /// (including supplement version)
    ///
    /// Canonical identifier for a supported supplement to this code system.
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "isDefault" => {
                    raw_is_default = Some(value);
                }
                "_isDefault" => {
                    raw_is_default_element = Some(value);
                }
                "content" => {
                    raw_content = Some(value);
                }
...
/// The \`versionAlgorithm\[x\]\` choice of
...
impl TerminologyCapabilitiesCodeSystemVersionAlgorithm {
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "hierarchical" => {
                    raw_hierarchical = Some(value);
                }
                "_hierarchical" => {
                    raw_hierarchical_element = Some(value);
                }
                "paging" => {
                    raw_paging = Some(value);
                }
                "_paging" => {
                    raw_paging_element = Some(value);
                }
                "incomplete" => {
                    raw_incomplete = Some(value);
                }
                "_incomplete" => {
                    raw_incomplete_element = Some(value);
                }
                "parameter" => {
                    raw_parameter = Some(value);
                }
                "textFilter" => {
                    raw_text_filter = Some(value);
                }
                "_textFilter" => {
                    raw_text_filter_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
...
impl super::super::codec::Json for TerminologyCapabilitiesImplementation {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.fragment_support {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("fragmentSupport"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_fragmentSupport"), e);
            }
        }
        if let Some(item) = &self.supplement_support {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("supplementSupport"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_supplementSupport"), e);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "fragmentSupport" => {
                    raw_fragment_support = Some(value);
                }
                "_fragmentSupport" => {
                    raw_fragment_support_element = Some(value);
                }
                "supplementSupport" => {
                    raw_supplement_support = Some(value);
                }
                "_supplementSupport" => {
                    raw_supplement_support_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_fragment_support = match (raw_fragment_support, raw_fragment_support_element) {
            (None, None) => None,
            (value, element) => Some(path.with("fragmentSupport", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        let field_supplement_support =
            match (raw_supplement_support, raw_supplement_support_element) {
                (None, None) => None,
                (value, element) => Some(path.with("supplementSupport", |path| {
                    super::super::codec::Primitive::from_json_parts(value, element, path)
                })?),
            };
        Ok(Self {
            ...
            description: field_description,
            url: field_url,
            fragment_support: field_fragment_support,
            supplement_support: field_supplement_support,
        })
    }
}
...
impl serde::Serialize for TerminologyCapabilitiesImplementation {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.fragment_support {
            super::super::codec::element_entry(&mut map, "_fragmentSupport", item)?;
        }
        if let Some(item) = &self.supplement_support {
            super::super::codec::element_entry(&mut map, "_supplementSupport", item)?;
        }
        if let Some(item) = &self.url {
            super::super::codec::element_entry(&mut map, "_url", item)?;
        }
        ...
        if let Some(item) = &self.fragment_support {
            super::super::codec::value_entry(&mut map, "fragmentSupport", item)?;
        }
        if let Some(v) = &self.id {
            serde::ser::SerializeMap::serialize_entry(&mut map, "id", v)?;
        }
        ...
        if let Some(item) = &self.supplement_support {
            super::super::codec::value_entry(&mut map, "supplementSupport", item)?;
        }
        if let Some(item) = &self.url {
            super::super::codec::value_entry(&mut map, "url", item)?;
        }
...
pub struct TerminologyCapabilitiesSupplements {
    ...
    /// is, supplements that contain only designations for a single language that
    /// are marked as intended by the extension
    ...
    pub globals: Option<super::primitives::Code>,
}

impl super::super::codec::Json for TerminologyCapabilitiesSupplements {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if let Some(item) = &self.globals {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("globals"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_globals"), e);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "globals" => {
                    raw_globals = Some(value);
                }
                "_globals" => {
                    raw_globals_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_globals = match (raw_globals, raw_globals_element) {
            (None, None) => None,
            (value, element) => Some(path.with("globals", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        Ok(Self {
            ...
            extension: field_extension,
            modifier_extension: field_modifier_extension,
            globals: field_globals,
        })
    }
}

impl serde::Serialize for TerminologyCapabilitiesSupplements {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.globals {
            super::super::codec::element_entry(&mut map, "_globals", item)?;
        }
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        if let Some(item) = &self.globals {
            super::super::codec::value_entry(&mut map, "globals", item)?;
        }
        if let Some(v) = &self.id {
            serde::ser::SerializeMap::serialize_entry(&mut map, "id", v)?;
        }
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "needsMap" => {
                    raw_needs_map = Some(value);
                }
                "_needsMap" => {
                    raw_needs_map_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "translations" => {
                    raw_translations = Some(value);
                }
                "_translations" => {
                    raw_translations_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
