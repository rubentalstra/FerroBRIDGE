    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "probabilityQuantity" => {
                    raw_probability.value("Quantity", value, path)?;
                }
                "_probabilityQuantity" => {
                    raw_probability.element("Quantity", value, path)?;
                }
                "probabilityRange" => {
...
impl serde::Serialize for RiskAssessmentPrediction {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.probability {
            ...
            Some(RiskAssessmentPredictionProbability::Quantity(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "probabilityQuantity",
                    inner.as_ref(),
