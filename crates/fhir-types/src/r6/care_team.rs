    ...
    fn from_json(
        ...
        let field_effective = match raw_effective.suffix {
            ...
            Some(suffix) => Some(path.with("effective", |path| {
                CareTeamParticipantEffective::from_json_parts(
                    suffix,
                    raw_effective.value,
...
impl serde::Serialize for CareTeamParticipant {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.effective {
            Some(CareTeamParticipantEffective::Period(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "effectivePeriod",
                    inner.as_ref(),
            ...
            Some(CareTeamParticipantEffective::Timing(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "effectiveTiming",
                    inner.as_ref(),
...
/// The \`effective\[x\]\` choice of \`CareTeamParticipant\`.
///
/// When the member is generally available within this care team.
...
impl CareTeamParticipantEffective {
