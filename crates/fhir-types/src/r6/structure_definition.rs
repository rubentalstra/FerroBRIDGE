...
pub struct StructureDefinition {
    ...
    /// Jurisdiction of the authority that maintains the structure definition (if
    /// applicable)
    ///
    ...
    /// structure definition. The short copyright declaration (e.g. (c) '2015+ xyz
    ...
    /// may be used to assist with indexing and searching of templates by describing
