...
pub struct EventDefinition {
    ...
    /// expectation that versions can be placed in a lexicographical sequence. For
    /// more information on versioning knowledge artifacts, refer to the Canonical
    ...
    /// Jurisdiction of the authority that maintains the event definition (if
    /// applicable)
    ///
...
impl super::super::codec::Json for EventDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("EventDefinition")),
        );
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("EventDefinition") {
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                EventDefinitionVersionAlgorithm::from_json_parts(
                    suffix,
        ...
        let field_subject = match raw_subject.suffix {
            ...
            Some(suffix) => Some(path.with("subject", |path| {
                EventDefinitionSubject::from_json_parts(
                    suffix,
                    raw_subject.value,
                    raw_subject.element,
                    path,
...
impl serde::Serialize for EventDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(EventDefinitionVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        serde::ser::SerializeMap::serialize_entry(&mut map, "resourceType", "EventDefinition")?;
        if !self.reviewer.is_empty() {
        ...
        match &self.subject {
            Some(EventDefinitionSubject::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "subjectCodeableConcept",
                    inner.as_ref(),
            ...
            Some(EventDefinitionSubject::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "subjectReference",
                    inner.as_ref(),
        ...
        match &self.version_algorithm {
            Some(EventDefinitionVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(EventDefinitionVersionAlgorithm::String(inner)) => {
...
impl<'de> serde::Deserialize<'de> for EventDefinition {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("EventDefinition");
        let object =
...
/// The \`subject\[x\]\` choice of \`EventDefinition\`.
///
/// A code or group definition that describes the intended subject of the event
/// definition.
...
/// The \`versionAlgorithm\[x\]\` choice of \`EventDefinition\`.
///
/// Indicates the mechanism used to compare versions to determine which is more
/// current.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl EventDefinitionVersionAlgorithm {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
