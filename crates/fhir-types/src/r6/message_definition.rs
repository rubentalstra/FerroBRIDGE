...
pub struct MessageDefinition {
    ...
    /// Jurisdiction of the authority that maintains the message definition (if
    /// applicable)
    ///
    ...
    fn from_json(
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                MessageDefinitionVersionAlgorithm::from_json_parts(
                    suffix,
...
impl serde::Serialize for MessageDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(MessageDefinitionVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        match &self.version_algorithm {
            Some(MessageDefinitionVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(MessageDefinitionVersionAlgorithm::String(inner)) => {
...
/// The \`versionAlgorithm\[x\]\` choice of \`MessageDefinition\`.
///
/// Indicates the mechanism used to compare versions to determine which is more
/// current.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl MessageDefinitionVersionAlgorithm {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
