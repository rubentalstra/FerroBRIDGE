...
impl super::super::codec::Json for CodeableReference {
    ...
    fn from_json(
        ...
        let field_concept = raw_concept
            .map(|value| {
                path.with("concept", |path| {
                    super::super::codec::Json::from_json(
...
impl serde::Serialize for CodeableReference {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.concept {
            serde::ser::SerializeMap::serialize_entry(&mut map, "concept", item)?;
        }
        if !self.extension.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CodeableReference {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("CodeableReference");
        let object =
