...
pub struct Measure {
    ...
    /// at which an authoritative instance of this measure is (or will be)
    ...
    pub reporting_frequency: Option<super::quantity::Quantity>,
    ...
    pub risk_adjustment: Option<super::primitives::Markdown>,
    ...
    pub rate_aggregation: Option<super::primitives::Markdown>,
...
impl super::super::codec::Json for Measure {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.reporting_frequency {
            object.insert(
                std::string::String::from("reportingFrequency"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_reporting_frequency: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "reportingFrequency" => {
                    raw_reporting_frequency = Some(value);
                }
                "topic" => {
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                MeasureVersionAlgorithm::from_json_parts(
                    suffix,
        ...
        let field_effective_period = raw_effective_period
            ...
            .transpose()?;
        let field_reporting_frequency = raw_reporting_frequency
            .map(|value| {
                path.with("reportingFrequency", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            reporting_frequency: field_reporting_frequency,
            topic: field_topic,
            author: field_author,
            editor: field_editor,
...
impl serde::Serialize for Measure {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(MeasureVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        if let Some(item) = &self.reporting_frequency {
            serde::ser::SerializeMap::serialize_entry(&mut map, "reportingFrequency", item)?;
        }
        ...
        match &self.version_algorithm {
            Some(MeasureVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(MeasureVersionAlgorithm::String(inner)) => {
...
pub struct MeasureGroup {
    ...
    /// Title of the group. This title is expected in the corresponding
    ...
    /// there is no subject context (i.e. population criteria are evaluated from the
    ...
    /// the type of the population basis. For example, an encounter-based measure
    /// has a subject of Patient and a population basis of Encounter, and the
    /// population criteria all return lists of Encounters.
    pub basis: Option<super::primitives::Code>,
    ...
    /// basisRequirement. A data element satisfies a basisRequirement if the
    /// instance \`is\` of the type, conforms to ALL the specified profiles, and
    /// matches ALL the codeFilters. basisRequirements SHALL specify type, MAY
    /// specify profile and codeFilter, and SHALL NOT specify dateFilter,
    /// valueFilter, limit, or sort. If basis is specified, any basisRequirement
    /// SHALL be consistent with the specified basis (i.e. the type of each
    /// basisRequirement SHALL be the same type as, or a subtype of the basis type).
    pub basis_requirement: Vec<super::data_requirement::DataRequirement>,
    ...
    pub scoring_unit: Option<super::codeable_concept::CodeableConcept>,
    /// How many decimals (The number of decimal places to include in the score when
    /// the score is a decimal-valued result)
    ///
    /// When the score is a decimal value this should be used to specify the
    /// expected minimum number of digits after the decimal point to use for the
    /// precision of the value. When a scoringUnit is also specified, this value is
    /// the expected minimum number of digits after the decimal point when the score
    /// is expressed in the units specified.
    pub scoring_precision: Option<super::primitives::PositiveInt>,
    ...
    /// indicates better quality OR quality is within a range). Exercise caution
    /// when using any values besides increase or decrease for improvementNotation.
    ...
    pub improvement_notation_guidance: Option<super::primitives::Markdown>,
    ...
    ///
    /// A stratifier for the measure, specified as either a criteria expression, or
    /// a set of components that define value-based stratifier expressions.
...
impl super::super::codec::Json for MeasureGroup {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.basis_requirement.is_empty() {
            let mut items = Vec::with_capacity(self.basis_requirement.len());
            for item in &self.basis_requirement {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("basisRequirement"),
                super::super::codec::Value::Array(items),
            );
        }
        ...
        if let Some(item) = &self.scoring_unit {
            object.insert(
                std::string::String::from("scoringUnit"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        if let Some(item) = &self.scoring_precision {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("scoringPrecision"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_scoringPrecision"), e);
            }
        }
        ...
        if let Some(item) = &self.improvement_notation_guidance {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("improvementNotationGuidance"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_improvementNotationGuidance"), e);
            }
        }
        if !self.library.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.library)?;
    ...
    fn from_json(
        ...
        let mut raw_basis_requirement: Option<&super::super::codec::Value> = None;
        let mut raw_scoring: Option<&super::super::codec::Value> = None;
        let mut raw_scoring_unit: Option<&super::super::codec::Value> = None;
        let mut raw_scoring_precision: Option<&super::super::codec::Value> = None;
        let mut raw_scoring_precision_element: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_improvement_notation_guidance: Option<&super::super::codec::Value> = None;
        let mut raw_improvement_notation_guidance_element: Option<&super::super::codec::Value> =
            None;
        let mut raw_library: Option<&super::super::codec::Value> = None;
        let mut raw_library_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "basisRequirement" => {
                    raw_basis_requirement = Some(value);
                }
                "scoring" => {
                    raw_scoring = Some(value);
                }
                "scoringUnit" => {
                    raw_scoring_unit = Some(value);
                }
                "scoringPrecision" => {
                    raw_scoring_precision = Some(value);
                }
                "_scoringPrecision" => {
                    raw_scoring_precision_element = Some(value);
                }
                "compositeScoring" => {
                ...
                "improvementNotationGuidance" => {
                    raw_improvement_notation_guidance = Some(value);
                }
                "_improvementNotationGuidance" => {
                    raw_improvement_notation_guidance_element = Some(value);
                }
                "library" => {
                    raw_library = Some(value);
                }
        ...
        let field_subject = match raw_subject.suffix {
            None => None,
            Some(suffix) => Some(path.with("subject", |path| {
                MeasureGroupSubject::from_json_parts(
                    suffix,
                    raw_subject.value,
                    raw_subject.element,
                    path,
        ...
        let mut field_basis_requirement = Vec::new();
        if let Some(raw) = raw_basis_requirement {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_basis_requirement.push(path.with_index(
                    "basisRequirement",
                    index,
                    |path| {
                        super::super::codec::Json::from_json(
        ...
        let field_scoring = raw_scoring
            ...
            .transpose()?;
        let field_scoring_unit = raw_scoring_unit
            .map(|value| {
                path.with("scoringUnit", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
            ...
            .transpose()?;
        let field_scoring_precision = match (raw_scoring_precision, raw_scoring_precision_element) {
            (None, None) => None,
            (value, element) => Some(path.with("scoringPrecision", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        ...
        let field_improvement_notation = raw_improvement_notation
            ...
            .transpose()?;
        let field_improvement_notation_guidance = match (
            raw_improvement_notation_guidance,
            raw_improvement_notation_guidance_element,
        ) {
            (None, None) => None,
            (value, element) => Some(path.with("improvementNotationGuidance", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        let mut field_library = Vec::new();
        ...
        Ok(Self {
            ...
            subject: field_subject,
            basis: field_basis,
            basis_requirement: field_basis_requirement,
            scoring: field_scoring,
            scoring_unit: field_scoring_unit,
            scoring_precision: field_scoring_precision,
            composite_scoring: field_composite_scoring,
            component: field_component,
            rate_aggregation: field_rate_aggregation,
            improvement_notation: field_improvement_notation,
            improvement_notation_guidance: field_improvement_notation_guidance,
            library: field_library,
...
impl serde::Serialize for MeasureGroup {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.improvement_notation_guidance {
            super::super::codec::element_entry(&mut map, "_improvementNotationGuidance", item)?;
        }
        super::super::codec::element_list_entry(&mut map, "_library", &self.library)?;
        if let Some(item) = &self.link_id {
        ...
        if let Some(item) = &self.scoring_precision {
            super::super::codec::element_entry(&mut map, "_scoringPrecision", item)?;
        }
        if let Some(item) = &self.title {
            super::super::codec::element_entry(&mut map, "_title", item)?;
        }
        ...
        if let Some(item) = &self.improvement_notation_guidance {
            super::super::codec::value_entry(&mut map, "improvementNotationGuidance", item)?;
        }
        super::super::codec::value_list_entry(&mut map, "library", &self.library)?;
        if let Some(item) = &self.link_id {
        ...
        if let Some(item) = &self.scoring_precision {
            super::super::codec::value_entry(&mut map, "scoringPrecision", item)?;
        }
        if let Some(item) = &self.scoring_unit {
            serde::ser::SerializeMap::serialize_entry(&mut map, "scoringUnit", item)?;
        }
        if !self.stratifier.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "stratifier", &self.stratifier)?;
        }
        match &self.subject {
            Some(MeasureGroupSubject::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "subjectCodeableConcept",
                    inner.as_ref(),
            ...
            Some(MeasureGroupSubject::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "subjectReference",
                    inner.as_ref(),
...
pub struct MeasureGroupComponent {
    ...
    pub group_id: Option<super::primitives::String>,
    /// What weight?
    ///
    /// What is the weight of the contribution of this measure to the overall score.
    pub weight: Option<super::primitives::Decimal>,
}

impl super::super::codec::Json for MeasureGroupComponent {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if let Some(item) = &self.group_id {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("groupId"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_groupId"), e);
            }
        }
        if let Some(item) = &self.weight {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("weight"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_weight"), e);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut raw_group_id: Option<&super::super::codec::Value> = None;
        let mut raw_group_id_element: Option<&super::super::codec::Value> = None;
        let mut raw_weight: Option<&super::super::codec::Value> = None;
        let mut raw_weight_element: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "groupId" => {
                    raw_group_id = Some(value);
                }
                "_groupId" => {
                    raw_group_id_element = Some(value);
                }
                "weight" => {
                    raw_weight = Some(value);
                }
                "_weight" => {
                    raw_weight_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_group_id = match (raw_group_id, raw_group_id_element) {
            (None, None) => None,
            (value, element) => Some(path.with("groupId", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        let field_weight = match (raw_weight, raw_weight_element) {
            (None, None) => None,
            (value, element) => Some(path.with("weight", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        Ok(Self {
...
impl serde::Serialize for MeasureGroupComponent {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.group_id {
            super::super::codec::element_entry(&mut map, "_groupId", item)?;
        }
        if let Some(item) = &self.measure {
            super::super::codec::element_entry(&mut map, "_measure", item)?;
        }
        if let Some(item) = &self.weight {
            super::super::codec::element_entry(&mut map, "_weight", item)?;
        }
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        if let Some(item) = &self.group_id {
            super::super::codec::value_entry(&mut map, "groupId", item)?;
        }
        if let Some(v) = &self.id {
            serde::ser::SerializeMap::serialize_entry(&mut map, "id", v)?;
        }
        ...
        if let Some(item) = &self.weight {
            super::super::codec::value_entry(&mut map, "weight", item)?;
        }
        serde::ser::SerializeMap::end(map)
    }
}

impl<'de> serde::Deserialize<'de> for MeasureGroupComponent {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("MeasureGroupComponent");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
pub struct MeasureGroupPopulation {
    ...
    pub group_definition: Option<super::reference::Reference>,
    /// Which population
    ///
    /// The id of a population element in this measure that provides the input for
    /// this population criteria. In most cases, the scoring structure of the
    /// measure implies specific relationships (e.g. the Numerator uses the
    /// Denominator as the source in a proportion scoring). In some cases, however,
    /// multiple possible choices exist and must be resolved explicitly. For example
    /// in a ratio measure with multiple initial populations, the denominator must
    /// specify which population should be used as the starting point.
    pub input_population_id: Option<super::primitives::String>,
    /// Aggregation method for a measure score (e.g. sum, average, median, minimum,
    /// maximum, count)
    ///
    ...
    /// variables, however, this information must be specified to ensure correct
    /// calculation.
    pub aggregate_method: Option<super::codeable_concept::CodeableConcept>,
}
...
impl super::super::codec::Json for MeasureGroupPopulation {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.group_definition {
            object.insert(
                std::string::String::from("groupDefinition"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        if let Some(item) = &self.input_population_id {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("inputPopulationId"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_inputPopulationId"), e);
            }
        }
        if let Some(item) = &self.aggregate_method {
            object.insert(
                std::string::String::from("aggregateMethod"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        Ok(object)
    ...
    fn from_json(
        ...
        let mut raw_group_definition: Option<&super::super::codec::Value> = None;
        let mut raw_input_population_id: Option<&super::super::codec::Value> = None;
        let mut raw_input_population_id_element: Option<&super::super::codec::Value> = None;
        let mut raw_aggregate_method: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "groupDefinition" => {
                    raw_group_definition = Some(value);
                }
                "inputPopulationId" => {
                    raw_input_population_id = Some(value);
                }
                "_inputPopulationId" => {
                    raw_input_population_id_element = Some(value);
                }
                "aggregateMethod" => {
                    raw_aggregate_method = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_criteria = raw_criteria
            ...
            .transpose()?;
        let field_group_definition = raw_group_definition
            .map(|value| {
                path.with("groupDefinition", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
            ...
            .transpose()?;
        let field_input_population_id =
            match (raw_input_population_id, raw_input_population_id_element) {
                (None, None) => None,
                (value, element) => Some(path.with("inputPopulationId", |path| {
                    super::super::codec::Primitive::from_json_parts(value, element, path)
                })?),
            };
        let field_aggregate_method = raw_aggregate_method
            .map(|value| {
                path.with("aggregateMethod", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            group_definition: field_group_definition,
            input_population_id: field_input_population_id,
            aggregate_method: field_aggregate_method,
        })
    }
}
...
impl serde::Serialize for MeasureGroupPopulation {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.input_population_id {
            super::super::codec::element_entry(&mut map, "_inputPopulationId", item)?;
        }
        if let Some(item) = &self.link_id {
            super::super::codec::element_entry(&mut map, "_linkId", item)?;
        }
        ...
        if let Some(item) = &self.aggregate_method {
            serde::ser::SerializeMap::serialize_entry(&mut map, "aggregateMethod", item)?;
        }
        if let Some(item) = &self.code {
            serde::ser::SerializeMap::serialize_entry(&mut map, "code", item)?;
        }
        ...
        if let Some(item) = &self.group_definition {
            serde::ser::SerializeMap::serialize_entry(&mut map, "groupDefinition", item)?;
        }
        if let Some(v) = &self.id {
            serde::ser::SerializeMap::serialize_entry(&mut map, "id", v)?;
        }
        if let Some(item) = &self.input_population_id {
            super::super::codec::value_entry(&mut map, "inputPopulationId", item)?;
        }
        if let Some(item) = &self.link_id {
            super::super::codec::value_entry(&mut map, "linkId", item)?;
        }
...
pub struct MeasureGroupStratifier {
    ...
    /// equivalent item in a MeasureReport resource.
    pub link_id: Option<super::primitives::String>,
    /// Title of a group's stratifier. This title is expected in the corresponding
    /// MeasureReport.group.title
    ///
...
pub struct MeasureGroupStratifierComponent {
    ...
    /// stratifier element, evaluated from the perspective of the measure subject.
    /// If this is a non-subject-based measure, the expression may be a reference to
    /// a function that takes an argument of the type of the measure basis, allowing
...
/// The \`subject\[x\]\` choice of \`MeasureGroup\`.
///
/// The intended subjects for the measure. If this element is not provided,
/// there is no subject context (i.e. population criteria are evaluated from the
/// perspective of the entire system, rather than from the perspective of a
...
pub struct MeasureSupplementalData {
    ...
    ///
    /// A value set defining the set of possible values for supplemental data in
    /// this element. If criteria and valueSet are both present, they SHALL be
    /// consistent (i.e. criteria expressions SHALL produce supplemental data values
    /// that are codes in the value set referenced by this element). Note that this
    /// MAY be strictly at the code level (e.g. an Age Range code that is just the
    /// string value \`01Y--05Y\` with the system ignored).
    pub value_set: Option<super::primitives::Canonical>,
    /// What units?
    ///
...
impl super::super::codec::Json for MeasureTerm {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for MeasureTerm {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.definition {
...
impl<'de> serde::Deserialize<'de> for MeasureTerm {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("MeasureTerm");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
/// The \`versionAlgorithm\[x\]\` choice of \`Measure\`.
///
/// Indicates the mechanism used to compare versions to determine which is more
/// current.
#[derive(Debug, Clone, PartialEq, Eq)]
