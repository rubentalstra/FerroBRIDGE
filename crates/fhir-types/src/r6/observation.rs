...
pub struct Observation {
    ...
    /// registered | in-process | specimen-in-process | preliminary | final |
    ...
    /// use case, a caregiver (RelatedPerson) has back strain and is unable to
    /// provide ADL support to a patient (Subject).
    ...
    pub organizer: Option<super::primitives::Boolean>,
    /// Healthcare event during which this observation is made. If you need to place
    /// the observation within one or more episodes of care, use the
    ...
    pub context: Vec<super::codeable_reference::CodeableReference>,
...
impl super::super::codec::Json for Observation {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.triggered_by.is_empty() {
            let mut items = Vec::with_capacity(self.triggered_by.len());
            for item in &self.triggered_by {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("triggeredBy"),
                super::super::codec::Value::Array(items),
            );
        }
        ...
        if let Some(item) = &self.organizer {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("organizer"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_organizer"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_triggered_by: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_organizer: Option<&super::super::codec::Value> = None;
        let mut raw_organizer_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "organizer" => {
                    raw_organizer = Some(value);
                }
                "_organizer" => {
                    raw_organizer_element = Some(value);
                }
                "encounter" => {
        ...
        let mut field_triggered_by = Vec::new();
        if let Some(raw) = raw_triggered_by {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_triggered_by.push(path.with_index("triggeredBy", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        let field_organizer = match (raw_organizer, raw_organizer_element) {
            (None, None) => None,
            (value, element) => Some(path.with("organizer", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        ...
        Ok(Self {
            ...
            triggered_by: field_triggered_by,
...
impl serde::Serialize for Observation {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.organizer {
            super::super::codec::element_entry(&mut map, "_organizer", item)?;
        }
        ...
        if let Some(item) = &self.organizer {
            super::super::codec::value_entry(&mut map, "organizer", item)?;
        }
        if !self.part_of.is_empty() {
        ...
        if !self.triggered_by.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "triggeredBy", &self.triggered_by)?;
        }
        match &self.value {
            Some(ObservationValue::Attachment(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueAttachment",
                    inner.as_ref(),
...
impl serde::Serialize for ObservationComponent {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.value {
            Some(ObservationComponentValue::Attachment(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueAttachment",
                    inner.as_ref(),
...
pub struct ObservationReferenceRange {
    ...
    pub normal_value: Option<super::codeable_concept::CodeableConcept>,
...
impl super::super::codec::Json for ObservationReferenceRange {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.normal_value {
            object.insert(
                std::string::String::from("normalValue"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_normal_value: Option<&super::super::codec::Value> = None;
        ...
        let field_high = raw_high
            ...
            .transpose()?;
        let field_normal_value = raw_normal_value
            .map(|value| {
                path.with("normalValue", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            low: field_low,
            high: field_high,
            normal_value: field_normal_value,
            r#type: field_type,
...
impl serde::Serialize for ObservationReferenceRange {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.normal_value {
            serde::ser::SerializeMap::serialize_entry(&mut map, "normalValue", item)?;
        }
        if let Some(item) = &self.text {
...
impl super::super::codec::Json for ObservationTriggeredBy {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for ObservationTriggeredBy {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.reason {
...
impl<'de> serde::Deserialize<'de> for ObservationTriggeredBy {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("ObservationTriggeredBy");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
