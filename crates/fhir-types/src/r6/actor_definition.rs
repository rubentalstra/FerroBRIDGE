...
/// A system or non-system participant involved in an information exchange
/// process
///
/// Provides a definition of an actor - a system, individual, non-system device,
/// or collective - that plays a role in a process, such as data exchange, along
...
pub struct ActorDefinition {
    ...
    ///
    /// A formal identifier that is used to identify this actor definition when it
    ...
    /// an arbitrary value managed by the actor definition author and is not
    ...
    ///
    /// A natural language name identifying the actor definition. This name should
    ...
    /// and may be used to assist with indexing and searching for appropriate actor
    /// definition instances.
    pub use_context: Vec<super::usage_context::UsageContext>,
    /// Jurisdiction of the authority that maintains the actor definition (if
    /// applicable)
    ///
    ...
    pub base_definition: Vec<super::primitives::Canonical>,
}

impl super::super::codec::Json for ActorDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("ActorDefinition")),
        );
        ...
        if !self.base_definition.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.base_definition)?;
            object.insert(std::string::String::from("baseDefinition"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_baseDefinition"), elements);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("ActorDefinition") {
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                ActorDefinitionVersionAlgorithm::from_json_parts(
                    suffix,
        ...
        let mut field_base_definition = Vec::new();
        for (index, (value, element)) in super::super::codec::pair_arrays(
            raw_base_definition,
            raw_base_definition_element,
            path,
        )?
        .into_iter()
        .enumerate()
        {
            field_base_definition.push(path.with_index("baseDefinition", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        Ok(Self {
...
impl serde::Serialize for ActorDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ActorDefinitionVersionAlgorithm::String(inner)) = &self.version_algorithm {
            super::super::codec::element_entry(&mut map, "_versionAlgorithmString", inner)?;
        }
        super::super::codec::value_list_entry(&mut map, "baseDefinition", &self.base_definition)?;
        if !self.category.is_empty() {
        ...
        serde::ser::SerializeMap::serialize_entry(&mut map, "resourceType", "ActorDefinition")?;
        ...
        match &self.version_algorithm {
            Some(ActorDefinitionVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(ActorDefinitionVersionAlgorithm::String(inner)) => {
...
impl<'de> serde::Deserialize<'de> for ActorDefinition {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("ActorDefinition");
        let object =
...
/// The \`versionAlgorithm\[x\]\` choice of \`ActorDefinition\`.
///
/// Indicates the mechanism used to compare versions to determine which is more
/// current.
...
impl ActorDefinitionVersionAlgorithm {
