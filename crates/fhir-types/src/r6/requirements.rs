...
pub struct Requirements {
    ...
    /// a managed version is not available. There is also no expectation that
    ...
    /// Jurisdiction of the authority that maintains the Requirements (if
    /// applicable)
    ///
    ...
    /// expressed elsewhere. This URI is intended to point to a specific web page
    /// for an artifact, not a canonical URL. If pointing to HL7 specifications, it
    /// is best to point to the version-specific URL.
    pub reference: Vec<super::primitives::Url>,
...
impl super::super::codec::Json for Requirements {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("Requirements")),
        );
        ...
        if !self.imports.is_empty() {
            let mut items = Vec::with_capacity(self.imports.len());
            ...
            object.insert(
                std::string::String::from("imports"),
                super::super::codec::Value::Array(items),
            );
        }
        if !self.reference.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.reference)?;
            object.insert(std::string::String::from("reference"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_reference"), elements);
            }
        }
        ...
        if !self.statement.is_empty() {
            let mut items = Vec::with_capacity(self.statement.len());
            ...
            object.insert(
                std::string::String::from("statement"),
                super::super::codec::Value::Array(items),
            );
        }
        Ok(object)
    ...
    fn from_json(
        ...
        let mut raw_imports: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_statement: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("Requirements") {
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                RequirementsVersionAlgorithm::from_json_parts(
                    suffix,
        ...
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_reference, raw_reference_element, path)?
                .into_iter()
                .enumerate()
        {
        ...
        let mut field_statement = Vec::new();
        if let Some(raw) = raw_statement {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_statement.push(path.with_index("statement", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
...
impl serde::Serialize for Requirements {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        super::super::codec::element_list_entry(&mut map, "_reference", &self.reference)?;
        ...
        if let Some(RequirementsVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        if !self.imports.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "imports", &self.imports)?;
        }
        if !self.jurisdiction.is_empty() {
        ...
        super::super::codec::value_list_entry(&mut map, "reference", &self.reference)?;
        serde::ser::SerializeMap::serialize_entry(&mut map, "resourceType", "Requirements")?;
        if !self.statement.is_empty() {
        ...
        match &self.version_algorithm {
            Some(RequirementsVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(RequirementsVersionAlgorithm::String(inner)) => {
...
impl<'de> serde::Deserialize<'de> for Requirements {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        let mut path = super::super::codec::Path::root("Requirements");
        let object =
...
pub struct RequirementsActor {
    ...
    pub reference: super::primitives::Canonical,
...
impl super::super::codec::Json for RequirementsActor {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if let Some(v) = super::super::codec::Primitive::value_json(&self.reference)? {
            object.insert(std::string::String::from("reference"), v);
        }
        if let Some(e) = super::super::codec::Primitive::element_json(&self.reference)? {
...
impl serde::Serialize for RequirementsActor {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.key {
            super::super::codec::element_entry(&mut map, "_key", item)?;
        }
        super::super::codec::element_entry(&mut map, "_reference", &self.reference)?;
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        if let Some(v) = &self.id {
        ...
        super::super::codec::value_entry(&mut map, "reference", &self.reference)?;
        serde::ser::SerializeMap::end(map)
    }
}

impl<'de> serde::Deserialize<'de> for RequirementsActor {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RequirementsActor");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
pub struct RequirementsImports {
    ...
    /// Statement key
    ///
    /// The key of a statement to treat as part of the set of requirements defined
    /// in this instance.
    pub key: Vec<super::primitives::Id>,
}

impl super::super::codec::Json for RequirementsImports {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if !self.key.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.key)?;
            object.insert(std::string::String::from("key"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_key"), elements);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut field_key = Vec::new();
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_key, raw_key_element, path)?
                .into_iter()
                .enumerate()
        {
            field_key.push(path.with_index("key", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        Ok(Self {
...
impl serde::Serialize for RequirementsImports {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_list_entry(&mut map, "_key", &self.key)?;
        super::super::codec::element_entry(&mut map, "_reference", &self.reference)?;
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        ...
        super::super::codec::value_list_entry(&mut map, "key", &self.key)?;
        if !self.modifier_extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(
                &mut map,
                "modifierExtension",
...
impl<'de> serde::Deserialize<'de> for RequirementsImports {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RequirementsImports");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
pub struct RequirementsStatement {
    ...
    ///
    /// A short human usable label for this statement.
    pub conformance: Vec<super::primitives::Code>,
    ...
    /// highlighting etc.
    pub conditionality: Option<super::primitives::Boolean>,
    /// The actual requirement
    ///
    /// The actual requirement for human consumption.
    pub requirement: super::primitives::Markdown,
    ...
    /// how data that cannot be categorized will be handled. As well, some
    /// categories might not be mutually exclusive, so systems should prepare for
    /// multiple declared categories - even within a single category 'axis'.
    pub category: Vec<super::coding::Coding>,
    /// Another statement this is refining, tightening, or establishing more context
    /// for
    ///
    ...
    /// CodeSystem(/code), ValueSet, Library etc.
    pub satisfied_by: Vec<super::primitives::Url>,
    ...
    pub actor: Vec<super::primitives::Id>,
}

impl super::super::codec::Json for RequirementsStatement {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if !self.conformance.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.conformance)?;
            object.insert(std::string::String::from("conformance"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_conformance"), elements);
            }
        }
        if let Some(item) = &self.conditionality {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("conditionality"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_conditionality"), e);
            }
        }
        if let Some(v) = super::super::codec::Primitive::value_json(&self.requirement)? {
            object.insert(std::string::String::from("requirement"), v);
        }
        if let Some(e) = super::super::codec::Primitive::element_json(&self.requirement)? {
        ...
        if !self.satisfied_by.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.satisfied_by)?;
            object.insert(std::string::String::from("satisfiedBy"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_satisfiedBy"), elements);
            }
        }
        if !self.reference.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.reference)?;
        ...
        if !self.actor.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.actor)?;
            object.insert(std::string::String::from("actor"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_actor"), elements);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut raw_conformance_element: Option<&super::super::codec::Value> = None;
        let mut raw_conditionality: Option<&super::super::codec::Value> = None;
        let mut raw_conditionality_element: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_satisfied_by: Option<&super::super::codec::Value> = None;
        let mut raw_satisfied_by_element: Option<&super::super::codec::Value> = None;
        let mut raw_reference: Option<&super::super::codec::Value> = None;
        let mut raw_reference_element: Option<&super::super::codec::Value> = None;
        let mut raw_source: Option<&super::super::codec::Value> = None;
        let mut raw_actor: Option<&super::super::codec::Value> = None;
        let mut raw_actor_element: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "_conformance" => {
                    raw_conformance_element = Some(value);
                }
                "conditionality" => {
                    raw_conditionality = Some(value);
                }
                "_conditionality" => {
                    raw_conditionality_element = Some(value);
                }
                "requirement" => {
                ...
                "satisfiedBy" => {
                    raw_satisfied_by = Some(value);
                }
                "_satisfiedBy" => {
                    raw_satisfied_by_element = Some(value);
                }
                "reference" => {
                    raw_reference = Some(value);
                }
        ...
        let mut field_conformance = Vec::new();
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_conformance, raw_conformance_element, path)?
                .into_iter()
                .enumerate()
        {
            field_conformance.push(path.with_index("conformance", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        let field_conditionality = match (raw_conditionality, raw_conditionality_element) {
            (None, None) => None,
            (value, element) => Some(path.with("conditionality", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        let field_requirement = path.with("requirement", |path| {
            super::super::codec::Primitive::from_json_parts(
                raw_requirement,
                raw_requirement_element,
                path,
            )
        })?;
        ...
        let field_part_of = raw_part_of
            ...
            .transpose()?;
        let mut field_satisfied_by = Vec::new();
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_satisfied_by, raw_satisfied_by_element, path)?
                .into_iter()
                .enumerate()
        {
            field_satisfied_by.push(path.with_index("satisfiedBy", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        let mut field_reference = Vec::new();
        ...
        let mut field_actor = Vec::new();
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_actor, raw_actor_element, path)?
                .into_iter()
                .enumerate()
        {
            field_actor.push(path.with_index("actor", index, |path| {
        ...
        Ok(Self {
            ...
            conditionality: field_conditionality,
            requirement: field_requirement,
            category: field_category,
            derived_from: field_derived_from,
            part_of: field_part_of,
            satisfied_by: field_satisfied_by,
            reference: field_reference,
            source: field_source,
            actor: field_actor,
        })
...
impl serde::Serialize for RequirementsStatement {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_list_entry(&mut map, "_actor", &self.actor)?;
        if let Some(item) = &self.conditionality {
            super::super::codec::element_entry(&mut map, "_conditionality", item)?;
        }
        super::super::codec::element_list_entry(&mut map, "_conformance", &self.conformance)?;
        super::super::codec::element_entry(&mut map, "_key", &self.key)?;
        if let Some(item) = &self.label {
            super::super::codec::element_entry(&mut map, "_label", item)?;
        }
        super::super::codec::element_list_entry(&mut map, "_reference", &self.reference)?;
        super::super::codec::element_entry(&mut map, "_requirement", &self.requirement)?;
        super::super::codec::element_list_entry(&mut map, "_satisfiedBy", &self.satisfied_by)?;
        super::super::codec::value_list_entry(&mut map, "actor", &self.actor)?;
        if !self.category.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "category", &self.category)?;
        }
        if let Some(item) = &self.conditionality {
            super::super::codec::value_entry(&mut map, "conditionality", item)?;
        }
        super::super::codec::value_list_entry(&mut map, "conformance", &self.conformance)?;
        if let Some(item) = &self.derived_from {
        ...
        super::super::codec::value_list_entry(&mut map, "reference", &self.reference)?;
        super::super::codec::value_entry(&mut map, "requirement", &self.requirement)?;
        super::super::codec::value_list_entry(&mut map, "satisfiedBy", &self.satisfied_by)?;
        if !self.source.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RequirementsStatement {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RequirementsStatement");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
pub struct RequirementsStatementDerivedFrom {
    ...
    pub reference: Option<super::primitives::Canonical>,
...
impl super::super::codec::Json for RequirementsStatementDerivedFrom {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for RequirementsStatementDerivedFrom {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_entry(&mut map, "_key", &self.key)?;
        if let Some(item) = &self.reference {
...
impl<'de> serde::Deserialize<'de> for RequirementsStatementDerivedFrom {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RequirementsStatementDerivedFrom");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for RequirementsStatementPartOf {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for RequirementsStatementPartOf {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_entry(&mut map, "_key", &self.key)?;
        if let Some(item) = &self.reference {
...
impl<'de> serde::Deserialize<'de> for RequirementsStatementPartOf {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RequirementsStatementPartOf");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
/// The \`versionAlgorithm\[x\]\` choice of \`Requirements\`.
///
/// Indicates the mechanism used to compare versions to determine which is more
/// current.
...
impl RequirementsVersionAlgorithm {
