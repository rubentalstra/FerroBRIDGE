...
impl super::super::codec::Json for SampledData {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::Object(super::super::codec::Json::to_json(&self.origin)?),
        );
    ...
    fn from_json(
        ...
        let mut raw_interval: Option<&super::super::codec::Value> = None;
        let mut raw_interval_element: Option<&super::super::codec::Value> = None;
        let mut raw_interval_unit: Option<&super::super::codec::Value> = None;
        let mut raw_interval_unit_element: Option<&super::super::codec::Value> = None;
        let mut raw_factor: Option<&super::super::codec::Value> = None;
        let mut raw_factor_element: Option<&super::super::codec::Value> = None;
        let mut raw_lower_limit: Option<&super::super::codec::Value> = None;
        let mut raw_lower_limit_element: Option<&super::super::codec::Value> = None;
        let mut raw_upper_limit: Option<&super::super::codec::Value> = None;
        let mut raw_upper_limit_element: Option<&super::super::codec::Value> = None;
        let mut raw_dimensions: Option<&super::super::codec::Value> = None;
        let mut raw_dimensions_element: Option<&super::super::codec::Value> = None;
        let mut raw_code_map: Option<&super::super::codec::Value> = None;
        let mut raw_code_map_element: Option<&super::super::codec::Value> = None;
        let mut raw_offsets: Option<&super::super::codec::Value> = None;
        let mut raw_offsets_element: Option<&super::super::codec::Value> = None;
