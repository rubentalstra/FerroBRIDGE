...
pub struct Location {
    ...
    pub hours_of_operation: Option<super::availability::Availability>,
...
impl super::super::codec::Json for Location {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.hours_of_operation {
            object.insert(
    ...
    fn from_json(
        ...
        let field_hours_of_operation = raw_hours_of_operation
            .map(|value| {
                path.with("hoursOfOperation", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
...
impl serde::Serialize for Location {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.hours_of_operation {
            serde::ser::SerializeMap::serialize_entry(&mut map, "hoursOfOperation", item)?;
        }
        if let Some(v) = &self.id {
