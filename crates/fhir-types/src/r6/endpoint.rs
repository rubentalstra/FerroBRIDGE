...
pub struct Endpoint {
    ...
    /// active | limited | test | suspended | error | off | entered-in-error |
    /// unknown
    ///
    /// The endpoint status represents whether the endpoint can currently be used
    ...
    ///
    /// Contact details for a human to contact about the endpoint. The primary use
...
impl super::super::codec::Json for Endpoint {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.connection_type.is_empty() {
            let mut items = Vec::with_capacity(self.connection_type.len());
        ...
        if !self.environment_type.is_empty() {
            let mut items = Vec::with_capacity(self.environment_type.len());
            ...
            object.insert(
                std::string::String::from("environmentType"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_environment_type: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "environmentType" => {
                    raw_environment_type = Some(value);
                }
        ...
        let mut field_connection_type = Vec::new();
        if let Some(raw) = raw_connection_type {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_connection_type.push(path.with_index("connectionType", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        let mut field_environment_type = Vec::new();
        if let Some(raw) = raw_environment_type {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_environment_type.push(path.with_index("environmentType", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        Ok(Self {
            ...
            environment_type: field_environment_type,
...
pub struct EndpointPayload {
    ...
    /// connectionType).
    pub mime_type: Vec<super::primitives::Code>,
    ...
    /// Sign Observations or QuestionnaireResponse. The \`profileUri\` may be used
    /// when a FHIR Structure Definition is not available/appropriate.
    pub profile_canonical: Vec<super::primitives::Canonical>,
    ...
    /// represented using a FHIR profile. e.g. CDA Template ID expressed as an OID
    /// (in the Uri).
    pub profile_uri: Vec<super::primitives::Uri>,
}

impl super::super::codec::Json for EndpointPayload {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if !self.mime_type.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.mime_type)?;
            object.insert(std::string::String::from("mimeType"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_mimeType"), elements);
            }
        }
        if !self.profile_canonical.is_empty() {
            let (values, elements) =
                super::super::codec::primitive_arrays(&self.profile_canonical)?;
            object.insert(std::string::String::from("profileCanonical"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_profileCanonical"), elements);
            }
        }
        if !self.profile_uri.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.profile_uri)?;
            object.insert(std::string::String::from("profileUri"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_profileUri"), elements);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut raw_mime_type: Option<&super::super::codec::Value> = None;
        let mut raw_mime_type_element: Option<&super::super::codec::Value> = None;
        let mut raw_profile_canonical: Option<&super::super::codec::Value> = None;
        let mut raw_profile_canonical_element: Option<&super::super::codec::Value> = None;
        let mut raw_profile_uri: Option<&super::super::codec::Value> = None;
        let mut raw_profile_uri_element: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "mimeType" => {
                    raw_mime_type = Some(value);
                }
                "_mimeType" => {
                    raw_mime_type_element = Some(value);
                }
                "profileCanonical" => {
                    raw_profile_canonical = Some(value);
                }
                "_profileCanonical" => {
                    raw_profile_canonical_element = Some(value);
                }
                "profileUri" => {
                    raw_profile_uri = Some(value);
                }
                "_profileUri" => {
                    raw_profile_uri_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let mut field_mime_type = Vec::new();
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_mime_type, raw_mime_type_element, path)?
                .into_iter()
                .enumerate()
        {
            field_mime_type.push(path.with_index("mimeType", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        let mut field_profile_canonical = Vec::new();
        for (index, (value, element)) in super::super::codec::pair_arrays(
            raw_profile_canonical,
            raw_profile_canonical_element,
            path,
        )?
        .into_iter()
        .enumerate()
        {
            field_profile_canonical.push(path.with_index("profileCanonical", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        let mut field_profile_uri = Vec::new();
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_profile_uri, raw_profile_uri_element, path)?
                .into_iter()
                .enumerate()
        {
            field_profile_uri.push(path.with_index("profileUri", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        Ok(Self {
            ...
            profile_canonical: field_profile_canonical,
            profile_uri: field_profile_uri,
        })
    }
}

impl serde::Serialize for EndpointPayload {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_list_entry(&mut map, "_mimeType", &self.mime_type)?;
        super::super::codec::element_list_entry(
            &mut map,
            "_profileCanonical",
            &self.profile_canonical,
        )?;
        super::super::codec::element_list_entry(&mut map, "_profileUri", &self.profile_uri)?;
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        if let Some(v) = &self.id {
        ...
        super::super::codec::value_list_entry(&mut map, "mimeType", &self.mime_type)?;
        if !self.modifier_extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(
                &mut map,
                "modifierExtension",
        ...
        super::super::codec::value_list_entry(&mut map, "profileUri", &self.profile_uri)?;
        if !self.r#type.is_empty() {
...
impl<'de> serde::Deserialize<'de> for EndpointPayload {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("EndpointPayload");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
