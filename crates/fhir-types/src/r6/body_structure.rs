...
pub struct BodyStructureIncludedStructure {
    ...
    /// morphologies.
    pub morphology: Vec<super::codeable_concept::CodeableConcept>,
    ...
    pub origin: Vec<super::codeable_concept::CodeableConcept>,
}
...
impl super::super::codec::Json for BodyStructureIncludedStructure {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.morphology.is_empty() {
            let mut items = Vec::with_capacity(self.morphology.len());
    ...
    fn from_json(
        ...
        let mut field_morphology = Vec::new();
        if let Some(raw) = raw_morphology {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_morphology.push(path.with_index("morphology", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
...
impl serde::Serialize for BodyStructureIncludedStructure {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if !self.morphology.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "morphology", &self.morphology)?;
        }
        if !self.origin.is_empty() {
