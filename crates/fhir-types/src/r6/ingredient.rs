...
pub struct Ingredient {
    ...
    /// used to describe that (rather than just a code), the allergen information
...
pub struct IngredientSubstanceStrength {
    ...
    ///
    /// A textual representation of either the whole of the concentration strength
    /// or a part of it - with the rest being in Strength.concentration as a ratio.
    ...
    /// is a salt).
    pub basis: Option<super::codeable_concept::CodeableConcept>,
...
impl super::super::codec::Json for IngredientSubstanceStrength {
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "presentationCodeableConcept" => {
                    raw_presentation.value("CodeableConcept", value, path)?;
                }
                "_presentationCodeableConcept" => {
                    raw_presentation.element("CodeableConcept", value, path)?;
                }
                "presentationQuantity" => {
                    raw_presentation.value("Quantity", value, path)?;
                }
                "_presentationQuantity" => {
                    raw_presentation.element("Quantity", value, path)?;
                }
                "textPresentation" => {
                ...
                "concentrationCodeableConcept" => {
                    raw_concentration.value("CodeableConcept", value, path)?;
                }
                "_concentrationCodeableConcept" => {
                    raw_concentration.element("CodeableConcept", value, path)?;
                }
                "concentrationQuantity" => {
                    raw_concentration.value("Quantity", value, path)?;
                }
                "_concentrationQuantity" => {
                    raw_concentration.element("Quantity", value, path)?;
                }
                "textConcentration" => {
        ...
        let field_basis = raw_basis
            .map(|value| {
                path.with("basis", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
...
impl serde::Serialize for IngredientSubstanceStrength {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.basis {
            serde::ser::SerializeMap::serialize_entry(&mut map, "basis", item)?;
        }
        match &self.concentration {
            Some(IngredientSubstanceStrengthConcentration::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "concentrationCodeableConcept",
                    inner.as_ref(),
            ...
            Some(IngredientSubstanceStrengthConcentration::Quantity(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "concentrationQuantity",
                    inner.as_ref(),
        ...
        match &self.presentation {
            Some(IngredientSubstanceStrengthPresentation::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "presentationCodeableConcept",
                    inner.as_ref(),
            ...
            Some(IngredientSubstanceStrengthPresentation::Quantity(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "presentationQuantity",
                    inner.as_ref(),
...
impl serde::Serialize for IngredientSubstanceStrengthReferenceStrength {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.strength {
            IngredientSubstanceStrengthReferenceStrengthStrength::Quantity(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "strengthQuantity",
                    inner.as_ref(),
