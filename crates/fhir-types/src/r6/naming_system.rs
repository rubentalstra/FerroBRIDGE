...
pub struct NamingSystem {
    ...
    /// an arbitrary value managed by the naming system author and is not expected
    ...
    /// Jurisdiction of the authority that maintains the naming system (if
    /// applicable)
    ///
    ...
    /// for officially endorsing the NamingSystem for use in some setting.
    ...
    /// artifacts. If the type is \`successor\` or \`predecessor\`, the related
    /// resource must be a NamingSystem.
    ...
    fn from_json(
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                NamingSystemVersionAlgorithm::from_json_parts(
                    suffix,
...
impl serde::Serialize for NamingSystem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(NamingSystemVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        match &self.version_algorithm {
            Some(NamingSystemVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(NamingSystemVersionAlgorithm::String(inner)) => {
...
pub struct NamingSystemUniqueId {
    ...
    pub authoritative: Option<super::primitives::Boolean>,
}
...
impl super::super::codec::Json for NamingSystemUniqueId {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.authoritative {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("authoritative"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_authoritative"), e);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut raw_authoritative: Option<&super::super::codec::Value> = None;
        let mut raw_authoritative_element: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "authoritative" => {
                    raw_authoritative = Some(value);
                }
                "_authoritative" => {
                    raw_authoritative_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_period = raw_period
            ...
            .transpose()?;
        let field_authoritative = match (raw_authoritative, raw_authoritative_element) {
            (None, None) => None,
            (value, element) => Some(path.with("authoritative", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        Ok(Self {
...
impl serde::Serialize for NamingSystemUniqueId {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.authoritative {
            super::super::codec::element_entry(&mut map, "_authoritative", item)?;
        }
        if let Some(item) = &self.comment {
        ...
        if let Some(item) = &self.authoritative {
            super::super::codec::value_entry(&mut map, "authoritative", item)?;
        }
        if let Some(item) = &self.comment {
...
/// The \`versionAlgorithm\[x\]\` choice of \`NamingSystem\`.
///
/// Indicates the mechanism used to compare versions to determine which
/// NamingSystem is more current.
...
impl NamingSystemVersionAlgorithm {
