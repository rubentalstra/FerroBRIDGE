...
impl super::super::codec::Json for MedicinalProductDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.comprised_of.is_empty() {
            let mut items = Vec::with_capacity(self.comprised_of.len());
            for item in &self.comprised_of {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("comprisedOf"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_comprised_of: Option<&super::super::codec::Value> = None;
        ...
        let mut field_comprised_of = Vec::new();
        if let Some(raw) = raw_comprised_of {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_comprised_of.push(path.with_index("comprisedOf", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        Ok(Self {
            ...
            comprised_of: field_comprised_of,
...
impl serde::Serialize for MedicinalProductDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if !self.comprised_of.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "comprisedOf", &self.comprised_of)?;
        }
        if !self.contact.is_empty() {
...
impl serde::Serialize for MedicinalProductDefinitionCharacteristic {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.value {
            ...
            Some(MedicinalProductDefinitionCharacteristicValue::Integer(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueInteger", inner)?;
            }
            Some(MedicinalProductDefinitionCharacteristicValue::Markdown(inner)) => {
        ...
        match &self.value {
            ...
            Some(MedicinalProductDefinitionCharacteristicValue::Range(inner)) => {
...
impl super::super::codec::Json for MedicinalProductDefinitionNamePart {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for MedicinalProductDefinitionNamePart {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
...
impl<'de> serde::Deserialize<'de> for MedicinalProductDefinitionNamePart {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("MedicinalProductDefinitionNamePart");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for MedicinalProductDefinitionNameUsage {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for MedicinalProductDefinitionNameUsage {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
...
impl<'de> serde::Deserialize<'de> for MedicinalProductDefinitionNameUsage {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("MedicinalProductDefinitionNameUsage");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
