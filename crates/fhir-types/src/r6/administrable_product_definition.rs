...
/// a patient (after any mixing of multiple components, dissolution etc. has
/// been performed).
...
pub struct AdministrableProductDefinition {
    ...
    pub administrable_dose_form: Option<super::codeable_concept::CodeableConcept>,
    ...
    /// the overall product (or there might only be one item), while in other cases,
    /// an administrable form might use only a subset of the items available in the
    /// overall product. For example, an administrable form might involve combining
    /// a liquid and a powder available as part of an overall product, but not
    /// involve applying the also supplied cream. For consistency, it is acceptable
    /// to refer to the manufactured item in all cases - from complex many-to-many
    /// to simple one-to-one cases - even when there is no transformation or
    /// combining involved between the manufactured form and the administrable form.
    /// For example an oral solid tablet is usually administered without any
    /// transformation or combination, but the administrable form can still be
    /// represented as 'producedFrom' the single manufactured tablet.
    ...
    /// if the ingredients are not specified either using
    /// ManufacturedItemDefinition, or using incoming references from the Ingredient
    /// resource
    ///
    /// The ingredients of this administrable medicinal product. This is only needed
    ...
    ///
    /// A general description of the product, when in its final form, suitable for
    /// administration e.g. effervescent blue liquid, to be swallowed. Intended to
    /// be used when the other structured properties of this resource are
    /// insufficient or cannot be supported. It is not intended to duplicate
    /// information already carried elsewhere.
    ...
    ///
    /// A code that this product is known by, within some formal terminology. May be
    /// a PhPID. PhPID is really a code or a label, and not an identifier, because
    /// it applies to multiple products.
...
impl super::super::codec::Json for AdministrableProductDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.form_of.is_empty() {
            let mut items = Vec::with_capacity(self.form_of.len());
            for item in &self.form_of {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("formOf"),
                super::super::codec::Value::Array(items),
            );
        }
        if let Some(item) = &self.administrable_dose_form {
            object.insert(
        ...
        if !self.produced_from.is_empty() {
            let mut items = Vec::with_capacity(self.produced_from.len());
            for item in &self.produced_from {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("producedFrom"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_form_of: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_produced_from: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("AdministrableProductDefinition") {
        ...
        let mut field_form_of = Vec::new();
        if let Some(raw) = raw_form_of {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_form_of.push(path.with_index("formOf", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        let field_administrable_dose_form = raw_administrable_dose_form
            .map(|value| {
                path.with("administrableDoseForm", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        let field_unit_of_presentation = raw_unit_of_presentation
            ...
            .transpose()?;
        let mut field_produced_from = Vec::new();
        if let Some(raw) = raw_produced_from {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_produced_from.push(path.with_index("producedFrom", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
...
impl serde::Serialize for AdministrableProductDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.administrable_dose_form {
            serde::ser::SerializeMap::serialize_entry(&mut map, "administrableDoseForm", item)?;
        }
        if !self.code.is_empty() {
        ...
        if !self.form_of.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "formOf", &self.form_of)?;
        }
        if let Some(v) = &self.id {
...
impl<'de> serde::Deserialize<'de> for AdministrableProductDefinition {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("AdministrableProductDefinition");
        let object =
...
impl super::super::codec::Json for AdministrableProductDefinitionProperty {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
    ...
    fn from_json(
        ...
        let field_value = match raw_value.suffix {
            ...
            Some(suffix) => Some(path.with("value", |path| {
                AdministrableProductDefinitionPropertyValue::from_json_parts(
                    suffix,
                    raw_value.value,
                    raw_value.element,
                    path,
...
impl serde::Serialize for AdministrableProductDefinitionProperty {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        match &self.value {
            Some(AdministrableProductDefinitionPropertyValue::Boolean(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueBoolean", inner)?;
            }
            Some(AdministrableProductDefinitionPropertyValue::Date(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueDate", inner)?;
            }
            Some(AdministrableProductDefinitionPropertyValue::Markdown(inner)) => {
        ...
        match &self.value {
            Some(AdministrableProductDefinitionPropertyValue::Attachment(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueAttachment",
                    inner.as_ref(),
            ...
            Some(AdministrableProductDefinitionPropertyValue::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueCodeableConcept",
                    inner.as_ref(),
            ...
            Some(AdministrableProductDefinitionPropertyValue::Quantity(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueQuantity",
                    inner.as_ref(),
            ...
            Some(AdministrableProductDefinitionPropertyValue::Range(inner)) => {
                serde::ser::SerializeMap::serialize_entry(&mut map, "valueRange", inner.as_ref())?;
            }
            Some(AdministrableProductDefinitionPropertyValue::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueReference",
                    inner.as_ref(),
...
impl<'de> serde::Deserialize<'de> for AdministrableProductDefinitionProperty {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("AdministrableProductDefinitionProperty");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
/// The \`value\[x\]\` choice of \`AdministrableProductDefinitionProperty\`.
///
/// A value for the characteristic.
...
impl AdministrableProductDefinitionPropertyValue {
...
impl super::super::codec::Json for AdministrableProductDefinitionRouteOfAdministration {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for AdministrableProductDefinitionRouteOfAdministration {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        serde::ser::SerializeMap::serialize_entry(&mut map, "code", &self.code)?;
        if !self.extension.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AdministrableProductDefinitionRouteOfAdministration {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path =
            super::super::codec::Path::root("AdministrableProductDefinitionRouteOfAdministration");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl serde::Serialize for AdministrableProductDefinitionRouteOfAdministrationTargetSpecies {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        serde::ser::SerializeMap::serialize_entry(&mut map, "code", &self.code)?;
        if !self.extension.is_empty() {
