...
pub struct NutritionProduct {
    ...
    /// following is a concatenated list of the ingredients for a peanut butter
    /// would read 'ROASTED PEANUTS, SUGAR, HYDROGENATED VEGETABLE OIL (COTTONSEED,
    /// SOYBEAN AND RAPESEED OIL) TO PREVENT SEPARATION, SALT'.
    pub ingredient_summary: Option<super::primitives::Markdown>,
...
impl super::super::codec::Json for NutritionProduct {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.ingredient_summary {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("ingredientSummary"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_ingredientSummary"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_ingredient_summary: Option<&super::super::codec::Value> = None;
        let mut raw_ingredient_summary_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "ingredientSummary" => {
                    raw_ingredient_summary = Some(value);
                }
                "_ingredientSummary" => {
                    raw_ingredient_summary_element = Some(value);
                }
                "ingredient" => {
        ...
        let field_ingredient_summary =
            match (raw_ingredient_summary, raw_ingredient_summary_element) {
                (None, None) => None,
                (value, element) => Some(path.with("ingredientSummary", |path| {
                    super::super::codec::Primitive::from_json_parts(value, element, path)
                })?),
            };
        ...
        Ok(Self {
            ...
            ingredient_summary: field_ingredient_summary,
...
impl serde::Serialize for NutritionProduct {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.ingredient_summary {
            super::super::codec::element_entry(&mut map, "_ingredientSummary", item)?;
        }
        if let Some(item) = &self.language {
        ...
        if let Some(item) = &self.ingredient_summary {
            super::super::codec::value_entry(&mut map, "ingredientSummary", item)?;
        }
        if !self.instance.is_empty() {
...
pub struct NutritionProductCharacteristic {
    ...
    pub value: NutritionProductCharacteristicValue,
}

impl super::super::codec::Json for NutritionProductCharacteristic {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
    ...
    fn from_json(
        ...
        let field_value = path.with("value", |path| {
            let suffix = raw_value
                .suffix
                .ok_or_else(|| path.error(super::super::codec::DecodeErrorKind::MissingProperty))?;
            NutritionProductCharacteristicValue::from_json_parts(
                suffix,
                raw_value.value,
                raw_value.element,
                path,
...
impl serde::Serialize for NutritionProductCharacteristic {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        match &self.value {
            NutritionProductCharacteristicValue::Base64Binary(inner) => {
                super::super::codec::element_entry(&mut map, "_valueBase64Binary", inner)?;
            }
            NutritionProductCharacteristicValue::Boolean(inner) => {
                super::super::codec::element_entry(&mut map, "_valueBoolean", inner)?;
            }
            NutritionProductCharacteristicValue::String(inner) => {
        ...
        match &self.value {
            NutritionProductCharacteristicValue::Attachment(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueAttachment",
                    inner.as_ref(),
            ...
            NutritionProductCharacteristicValue::CodeableConcept(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueCodeableConcept",
                    inner.as_ref(),
            ...
            NutritionProductCharacteristicValue::Quantity(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueQuantity",
                    inner.as_ref(),
...
impl<'de> serde::Deserialize<'de> for NutritionProductCharacteristic {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("NutritionProductCharacteristic");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
/// The \`value\[x\]\` choice of \`NutritionProductCharacteristic\`.
///
/// The actual characteristic value corresponding to the type.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl NutritionProductCharacteristicValue {
...
pub struct NutritionProductIngredient {
    ...
    /// intolerance.
    pub allergen: Option<super::primitives::Boolean>,
}
...
impl super::super::codec::Json for NutritionProductIngredient {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.allergen {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("allergen"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_allergen"), e);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut raw_allergen: Option<&super::super::codec::Value> = None;
        let mut raw_allergen_element: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "allergen" => {
                    raw_allergen = Some(value);
                }
                "_allergen" => {
                    raw_allergen_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_amount = match raw_amount.suffix {
            ...
            Some(suffix) => Some(path.with("amount", |path| {
                NutritionProductIngredientAmount::from_json_parts(
                    suffix,
                    raw_amount.value,
                    raw_amount.element,
                    path,
        ...
        let field_allergen = match (raw_allergen, raw_allergen_element) {
            (None, None) => None,
            (value, element) => Some(path.with("allergen", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        Ok(Self {
...
impl serde::Serialize for NutritionProductIngredient {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.allergen {
            super::super::codec::element_entry(&mut map, "_allergen", item)?;
        }
        if let Some(item) = &self.allergen {
            super::super::codec::value_entry(&mut map, "allergen", item)?;
        }
        match &self.amount {
            Some(NutritionProductIngredientAmount::Quantity(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "amountQuantity",
                    inner.as_ref(),
            ...
            Some(NutritionProductIngredientAmount::Ratio(inner)) => {
...
/// The \`amount\[x\]\` choice of \`NutritionProductIngredient\`.
///
/// The amount of ingredient that is in the product.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl NutritionProductIngredientAmount {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
...
impl super::super::codec::Json for NutritionProductNutrient {
    ...
    fn from_json(
        ...
        let field_amount = match raw_amount.suffix {
            None => None,
            Some(suffix) => Some(path.with("amount", |path| {
                NutritionProductNutrientAmount::from_json_parts(
                    suffix,
                    raw_amount.value,
                    raw_amount.element,
                    path,
...
impl serde::Serialize for NutritionProductNutrient {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        match &self.amount {
            Some(NutritionProductNutrientAmount::Quantity(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "amountQuantity",
                    inner.as_ref(),
            ...
            Some(NutritionProductNutrientAmount::Ratio(inner)) => {
                serde::ser::SerializeMap::serialize_entry(&mut map, "amountRatio", inner.as_ref())?;
            }
            None => {}
        }
...
/// The \`amount\[x\]\` choice of \`NutritionProductNutrient\`.
///
/// The amount of nutrient expressed in one or more units, either X per pack /
/// per serving / per dose or X amount.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl NutritionProductNutrientAmount {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
