...
pub struct SearchParameter {
    ...
    ///
    /// A formal identifier that is used to identify this search parameter when it
    ...
    /// Jurisdiction of the authority that maintains the search parameter (if
    /// applicable)
    ///
    ...
    /// need to use a different CapabilityStatement searchParam.name to
    ...
    pub alias_code: Vec<super::primitives::Code>,
    ...
    pub base: Vec<super::primitives::Uri>,
    ...
    pub processing_mode: Option<super::primitives::Code>,
    ...
    pub constraint: Option<super::primitives::String>,
    ...
    /// of \[can-be-target (Can Be
    /// Target)\](<https://build.fhir.org/ig/HL7/fhir-extensions/CodeSystem-type-characteristics-code.html#type-characteristics-code-can-be-target>).
    pub target: Vec<super::primitives::Uri>,
...
impl super::super::codec::Json for SearchParameter {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.alias_code.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.alias_code)?;
            object.insert(std::string::String::from("aliasCode"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_aliasCode"), elements);
            }
        }
        ...
        if let Some(item) = &self.processing_mode {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("processingMode"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_processingMode"), e);
            }
        }
        if let Some(item) = &self.constraint {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("constraint"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_constraint"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_alias_code: Option<&super::super::codec::Value> = None;
        let mut raw_alias_code_element: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_processing_mode: Option<&super::super::codec::Value> = None;
        let mut raw_processing_mode_element: Option<&super::super::codec::Value> = None;
        let mut raw_constraint: Option<&super::super::codec::Value> = None;
        let mut raw_constraint_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "aliasCode" => {
                    raw_alias_code = Some(value);
                }
                "_aliasCode" => {
                    raw_alias_code_element = Some(value);
                }
                "base" => {
                    raw_base = Some(value);
                }
                ...
                "processingMode" => {
                    raw_processing_mode = Some(value);
                }
                "_processingMode" => {
                    raw_processing_mode_element = Some(value);
                }
                "constraint" => {
                    raw_constraint = Some(value);
                }
                "_constraint" => {
                    raw_constraint_element = Some(value);
                }
                "target" => {
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                SearchParameterVersionAlgorithm::from_json_parts(
                    suffix,
        ...
        let mut field_alias_code = Vec::new();
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_alias_code, raw_alias_code_element, path)?
                .into_iter()
                .enumerate()
        {
            field_alias_code.push(path.with_index("aliasCode", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        ...
        let field_processing_mode = match (raw_processing_mode, raw_processing_mode_element) {
            (None, None) => None,
            (value, element) => Some(path.with("processingMode", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        let field_constraint = match (raw_constraint, raw_constraint_element) {
            (None, None) => None,
            (value, element) => Some(path.with("constraint", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        ...
        Ok(Self {
            ...
            code: field_code,
            alias_code: field_alias_code,
            base: field_base,
            r#type: field_type,
            expression: field_expression,
            processing_mode: field_processing_mode,
...
impl serde::Serialize for SearchParameter {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        super::super::codec::element_list_entry(&mut map, "_aliasCode", &self.alias_code)?;
        ...
        if let Some(item) = &self.constraint {
            super::super::codec::element_entry(&mut map, "_constraint", item)?;
        }
        if let Some(item) = &self.copyright {
        ...
        if let Some(item) = &self.processing_mode {
            super::super::codec::element_entry(&mut map, "_processingMode", item)?;
        }
        if let Some(item) = &self.publisher {
        ...
        if let Some(SearchParameterVersionAlgorithm::String(inner)) = &self.version_algorithm {
            super::super::codec::element_entry(&mut map, "_versionAlgorithmString", inner)?;
        }
        super::super::codec::value_list_entry(&mut map, "aliasCode", &self.alias_code)?;
        ...
        if let Some(item) = &self.constraint {
            super::super::codec::value_entry(&mut map, "constraint", item)?;
        }
        if !self.contact.is_empty() {
        ...
        if let Some(item) = &self.processing_mode {
            super::super::codec::value_entry(&mut map, "processingMode", item)?;
        }
        if let Some(item) = &self.publisher {
        ...
        match &self.version_algorithm {
            Some(SearchParameterVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(SearchParameterVersionAlgorithm::String(inner)) => {
...
/// The \`versionAlgorithm\[x\]\` choice of \`SearchParameter\`.
///
/// Indicates the mechanism used to compare versions to determine which is more
/// current.
...
impl SearchParameterVersionAlgorithm {
