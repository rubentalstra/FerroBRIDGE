...
pub struct MessageHeader {
    ...
    /// its definition. Events are defined by codes, or by URIs that identify
    /// events, or by reference to EventDefinition or SubscriptionTopic resources
    /// that define the event directly. This element is intentionally unbound, and
    /// the selection of appropriate event codes is delegated to implementations and
    /// implementation guides. For codes, a good set of example codes is found in
    /// \[the V2 event codes\](<https://terminology.hl7.org/ValueSet-v2-0003.html>).
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "eventCanonical" => {
                    raw_event.value("Canonical", value, path)?;
                }
                "_eventCanonical" => {
                    raw_event.element("Canonical", value, path)?;
                }
                "destination" => {
...
impl serde::Serialize for MessageHeader {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.event {
            MessageHeaderEvent::Canonical(inner) => {
                super::super::codec::element_entry(&mut map, "_eventCanonical", inner)?;
            }
            MessageHeaderEvent::Uri(inner) => {
                super::super::codec::element_entry(&mut map, "_eventUri", inner)?;
            }
            MessageHeaderEvent::Coding(_) => {}
        }
        if let Some(item) = &self.implicit_rules {
        ...
        match &self.event {
            MessageHeaderEvent::Canonical(inner) => {
                super::super::codec::value_entry(&mut map, "eventCanonical", inner)?;
            }
...
impl super::super::codec::Json for MessageHeaderDestination {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.endpoint {
            ...
            if let Some(value) = value {
                object.insert(format!("endpoint{suffix}"), value);
            }
            if let Some(element) = element {
                object.insert(format!("_endpoint{suffix}"), element);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_extension: Option<&super::super::codec::Value> = None;
        let mut raw_modifier_extension: Option<&super::super::codec::Value> = None;
        let mut raw_endpoint = super::super::codec::ChoiceSlot::default();
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "endpointUrl" => {
                    raw_endpoint.value("Url", value, path)?;
                }
                "_endpointUrl" => {
                    raw_endpoint.element("Url", value, path)?;
                }
                "endpointReference" => {
                    raw_endpoint.value("Reference", value, path)?;
                }
                "_endpointReference" => {
                    raw_endpoint.element("Reference", value, path)?;
                }
                "name" => {
                    raw_name = Some(value);
                }
        ...
        let field_endpoint = match raw_endpoint.suffix {
            None => None,
            Some(suffix) => Some(path.with("endpoint", |path| {
                MessageHeaderDestinationEndpoint::from_json_parts(
                    suffix,
                    raw_endpoint.value,
                    raw_endpoint.element,
                    path,
                )
            })?),
        };
...
impl serde::Serialize for MessageHeaderDestination {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(MessageHeaderDestinationEndpoint::Url(inner)) = &self.endpoint {
            super::super::codec::element_entry(&mut map, "_endpointUrl", inner)?;
        }
        if let Some(item) = &self.name {
            super::super::codec::element_entry(&mut map, "_name", item)?;
        }
        match &self.endpoint {
            Some(MessageHeaderDestinationEndpoint::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "endpointReference",
                    inner.as_ref(),
            ...
            Some(MessageHeaderDestinationEndpoint::Url(inner)) => {
                super::super::codec::value_entry(&mut map, "endpointUrl", inner)?;
            }
            None => {}
        }
        if !self.extension.is_empty() {
...
/// The \`endpoint\[x\]\` choice of \`MessageHeaderDestination\`.
///
/// Indicates where the message should be routed.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl MessageHeaderDestinationEndpoint {
...
impl super::super::codec::Json for MessageHeaderSource {
    ...
    fn from_json(
        ...
        let field_endpoint = match raw_endpoint.suffix {
            None => None,
            Some(suffix) => Some(path.with("endpoint", |path| {
                MessageHeaderSourceEndpoint::from_json_parts(
                    suffix,
                    raw_endpoint.value,
                    raw_endpoint.element,
                    path,
...
impl serde::Serialize for MessageHeaderSource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(MessageHeaderSourceEndpoint::Url(inner)) = &self.endpoint {
            super::super::codec::element_entry(&mut map, "_endpointUrl", inner)?;
        }
        if let Some(item) = &self.name {
            super::super::codec::element_entry(&mut map, "_name", item)?;
        ...
        match &self.endpoint {
            Some(MessageHeaderSourceEndpoint::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "endpointReference",
                    inner.as_ref(),
            ...
            Some(MessageHeaderSourceEndpoint::Url(inner)) => {
                super::super::codec::value_entry(&mut map, "endpointUrl", inner)?;
            }
            None => {}
        }
...
/// The \`endpoint\[x\]\` choice of \`MessageHeaderSource\`.
///
/// Identifies the routing target to send acknowledgements to.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl MessageHeaderSourceEndpoint {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
