...
pub struct MedicationAdministration {
    ...
    pub occurrence: MedicationAdministrationOccurrence,
    ...
    fn from_json(
        ...
        let field_occurrence = path.with("occurrence", |path| {
            let suffix = raw_occurrence
                .suffix
                .ok_or_else(|| path.error(super::super::codec::DecodeErrorKind::MissingProperty))?;
            MedicationAdministrationOccurrence::from_json_parts(
                suffix,
...
impl serde::Serialize for MedicationAdministration {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let MedicationAdministrationOccurrence::DateTime(inner) = &self.occurrence {
        ...
        match &self.occurrence {
            MedicationAdministrationOccurrence::DateTime(inner) => {
                super::super::codec::value_entry(&mut map, "occurrenceDateTime", inner)?;
            }
            MedicationAdministrationOccurrence::Period(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "occurrencePeriod",
                    inner.as_ref(),
            ...
            MedicationAdministrationOccurrence::Timing(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "occurrenceTiming",
                    inner.as_ref(),
...
/// The \`occurrence\[x\]\` choice of \`MedicationAdministration\`.
///
/// A specific date/time or interval of time during which the administration
/// took place (or did not take place). For many administrations, such as
/// swallowing a tablet the use of dateTime is more appropriate.
...
impl MedicationAdministrationOccurrence {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
