...
pub struct PackagedProductDefinitionPackaging {
    ...
    ///
    /// Is this a part of the packaging (e.g. a cap or bottle stopper), rather than
    /// the packaging itself (e.g. a bottle or vial). The latter type are designed
    /// be a container, but the former are not.
    pub component_part: Option<super::primitives::Boolean>,
    ...
    /// Manufacturer of this packaging item (multiple means these are all potential
    /// manufacturers)
    ///
...
impl super::super::codec::Json for PackagedProductDefinitionPackaging {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if let Some(item) = &self.component_part {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("componentPart"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_componentPart"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_identifier: Option<&super::super::codec::Value> = None;
        let mut raw_type: Option<&super::super::codec::Value> = None;
        let mut raw_component_part: Option<&super::super::codec::Value> = None;
        let mut raw_component_part_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "componentPart" => {
                    raw_component_part = Some(value);
                }
                "_componentPart" => {
                    raw_component_part_element = Some(value);
                }
                "quantity" => {
        ...
        let field_type = raw_type
            ...
            .transpose()?;
        let field_component_part = match (raw_component_part, raw_component_part_element) {
            (None, None) => None,
            (value, element) => Some(path.with("componentPart", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        ...
        Ok(Self {
            ...
            identifier: field_identifier,
            r#type: field_type,
            component_part: field_component_part,
...
impl serde::Serialize for PackagedProductDefinitionPackaging {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.component_part {
            super::super::codec::element_entry(&mut map, "_componentPart", item)?;
        }
        if let Some(item) = &self.quantity {
        ...
        if let Some(item) = &self.component_part {
            super::super::codec::value_entry(&mut map, "componentPart", item)?;
        }
        if !self.contained_item.is_empty() {
            serde::ser::SerializeMap::serialize_entry(
                &mut map,
...
impl<'de> serde::Deserialize<'de> for PackagedProductDefinitionPackaging {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("PackagedProductDefinitionPackaging");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for PackagedProductDefinitionPackagingContainedItem {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for PackagedProductDefinitionPackagingContainedItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.amount {
...
impl<'de> serde::Deserialize<'de> for PackagedProductDefinitionPackagingContainedItem {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path =
            super::super::codec::Path::root("PackagedProductDefinitionPackagingContainedItem");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for PackagedProductDefinitionPackagingProperty {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
    ...
    fn from_json(
        ...
        let field_value = match raw_value.suffix {
            ...
            Some(suffix) => Some(path.with("value", |path| {
                PackagedProductDefinitionPackagingPropertyValue::from_json_parts(
                    suffix,
                    raw_value.value,
                    raw_value.element,
                    path,
...
impl serde::Serialize for PackagedProductDefinitionPackagingProperty {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        match &self.value {
            Some(PackagedProductDefinitionPackagingPropertyValue::Boolean(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueBoolean", inner)?;
            }
            Some(PackagedProductDefinitionPackagingPropertyValue::Date(inner)) => {
        ...
        match &self.value {
            Some(PackagedProductDefinitionPackagingPropertyValue::Attachment(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueAttachment",
                    inner.as_ref(),
            ...
            Some(PackagedProductDefinitionPackagingPropertyValue::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueCodeableConcept",
                    inner.as_ref(),
            ...
            Some(PackagedProductDefinitionPackagingPropertyValue::Quantity(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueQuantity",
                    inner.as_ref(),
...
impl<'de> serde::Deserialize<'de> for PackagedProductDefinitionPackagingProperty {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path =
            super::super::codec::Path::root("PackagedProductDefinitionPackagingProperty");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
/// The \`value\[x\]\` choice of \`PackagedProductDefinitionPackagingProperty\`.
///
/// A value for the characteristic.
...
impl PackagedProductDefinitionPackagingPropertyValue {
