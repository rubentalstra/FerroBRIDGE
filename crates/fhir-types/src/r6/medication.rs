...
pub struct Medication {
    ...
    /// product and may also contract the manufacturing of the product to one or
    /// more companies (organizations).
    pub marketing_authorization_holder: Option<super::reference::Reference>,
    /// powder | tablets | capsule +
    ///
    /// Describes the form of the item. Powder; tablets; capsule.
    pub dose_form: Option<super::codeable_concept::CodeableConcept>,
    /// When the code does not specify the package size, this backbone element can
    /// be used to specify the overall amount of medication in the package.
    pub package_size: Option<MedicationPackageSize>,
    /// Components of a medication. These can be ingredient substances or other
    /// medications, in the case of combination packaged medications
    ///
...
impl super::super::codec::Json for Medication {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.marketing_authorization_holder {
            object.insert(
                std::string::String::from("marketingAuthorizationHolder"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        ...
        if let Some(item) = &self.package_size {
            object.insert(
                std::string::String::from("packageSize"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_marketing_authorization_holder: Option<&super::super::codec::Value> = None;
        let mut raw_dose_form: Option<&super::super::codec::Value> = None;
        let mut raw_package_size: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "marketingAuthorizationHolder" => {
                    raw_marketing_authorization_holder = Some(value);
                }
                "doseForm" => {
                    raw_dose_form = Some(value);
                }
                "packageSize" => {
                    raw_package_size = Some(value);
                }
                "ingredient" => {
        ...
        let field_marketing_authorization_holder = raw_marketing_authorization_holder
            .map(|value| {
                path.with("marketingAuthorizationHolder", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        let field_dose_form = raw_dose_form
            ...
            .transpose()?;
        let field_package_size = raw_package_size
            .map(|value| {
                path.with("packageSize", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            code: field_code,
            status: field_status,
            marketing_authorization_holder: field_marketing_authorization_holder,
            dose_form: field_dose_form,
            package_size: field_package_size,
...
impl serde::Serialize for Medication {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.package_size {
            serde::ser::SerializeMap::serialize_entry(&mut map, "packageSize", item)?;
        }
    ...
    fn from_json(
        ...
        let field_strength = match raw_strength.suffix {
            ...
            Some(suffix) => Some(path.with("strength", |path| {
                MedicationIngredientStrength::from_json_parts(
                    suffix,
                    raw_strength.value,
...
impl serde::Serialize for MedicationIngredient {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.strength {
            Some(MedicationIngredientStrength::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "strengthCodeableConcept",
                    inner.as_ref(),
            ...
            Some(MedicationIngredientStrength::Quantity(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "strengthQuantity",
                    inner.as_ref(),
            ...
            Some(MedicationIngredientStrength::Ratio(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "strengthRatio",
                    inner.as_ref(),
...
/// The \`strength\[x\]\` choice of \`MedicationIngredient\`.
///
/// Specifies how many (or how much) of the items there are in this Medication.
/// For example, 250 mg per tablet. This is expressed as a ratio where the
/// numerator is 250mg and the denominator is 1 tablet but can also be expressed
...
impl MedicationIngredientStrength {
...
impl super::super::codec::Json for MedicationInstance {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for MedicationInstance {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.expiration_date {
...
impl<'de> serde::Deserialize<'de> for MedicationInstance {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("MedicationInstance");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
pub struct MedicationPackageSize {
    ...
    pub number_of_items: Option<super::quantity::Quantity>,
    /// The amount per each item
    ///
    /// The amount per each item, e.g. 10 ml / vial.
    pub amount_per_item: Option<super::ratio::Ratio>,
}

impl super::super::codec::Json for MedicationPackageSize {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if let Some(item) = &self.number_of_items {
            object.insert(
                std::string::String::from("numberOfItems"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        if let Some(item) = &self.amount_per_item {
            object.insert(
                std::string::String::from("amountPerItem"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        Ok(object)
    ...
    fn from_json(
        ...
        let mut raw_extension: Option<&super::super::codec::Value> = None;
        let mut raw_modifier_extension: Option<&super::super::codec::Value> = None;
        let mut raw_number_of_items: Option<&super::super::codec::Value> = None;
        let mut raw_amount_per_item: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "numberOfItems" => {
                    raw_number_of_items = Some(value);
                }
                "amountPerItem" => {
                    raw_amount_per_item = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_number_of_items = raw_number_of_items
            .map(|value| {
                path.with("numberOfItems", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
            ...
            .transpose()?;
        let field_amount_per_item = raw_amount_per_item
            .map(|value| {
                path.with("amountPerItem", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            extension: field_extension,
            modifier_extension: field_modifier_extension,
            number_of_items: field_number_of_items,
            amount_per_item: field_amount_per_item,
        })
    }
}

impl serde::Serialize for MedicationPackageSize {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.amount_per_item {
            serde::ser::SerializeMap::serialize_entry(&mut map, "amountPerItem", item)?;
        }
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        ...
        if let Some(item) = &self.number_of_items {
            serde::ser::SerializeMap::serialize_entry(&mut map, "numberOfItems", item)?;
        }
        serde::ser::SerializeMap::end(map)
    }
}

impl<'de> serde::Deserialize<'de> for MedicationPackageSize {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("MedicationPackageSize");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
