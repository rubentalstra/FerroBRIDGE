...
pub struct CodeSystem {
    ...
    /// for officially endorsing the CodeSystem for use in some setting.
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "caseSensitive" => {
                    raw_case_sensitive = Some(value);
                }
                "_caseSensitive" => {
                    raw_case_sensitive_element = Some(value);
                }
                "valueSet" => {
                ...
                "hierarchyMeaning" => {
                    raw_hierarchy_meaning = Some(value);
                }
                "_hierarchyMeaning" => {
                    raw_hierarchy_meaning_element = Some(value);
                }
                "compositional" => {
                    raw_compositional = Some(value);
                }
                "_compositional" => {
                    raw_compositional_element = Some(value);
                }
                "versionNeeded" => {
                    raw_version_needed = Some(value);
                }
                "_versionNeeded" => {
                    raw_version_needed_element = Some(value);
                }
                "content" => {
                ...
                "supplements" => {
                    raw_supplements = Some(value);
                }
                "_supplements" => {
                    raw_supplements_element = Some(value);
                }
                "count" => {
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                CodeSystemVersionAlgorithm::from_json_parts(
                    suffix,
...
impl serde::Serialize for CodeSystem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(CodeSystemVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        match &self.version_algorithm {
            Some(CodeSystemVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
...
pub struct CodeSystemFilter {
    ...
    ///
    /// CodeSystem.filter.value is represented as a string, and the string value
    /// must be as described in \[Using Filter
...
/// The \`versionAlgorithm\[x\]\` choice of \`CodeSystem\`.
///
/// Indicates the mechanism used to compare versions to determine which
/// CodeSystem is more current.
#[derive(Debug, Clone, PartialEq, Eq)]
