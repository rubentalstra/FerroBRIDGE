...
//! The FHIR primitive types (<https://hl7.org/fhir/R6/datatypes.html#primitive>).
...
/// identifier pattern that meets these constraints.) No whitespace characters
/// are allowed. Ids are case-insensitive.
#[derive(Debug, Clone, Default, PartialEq, Eq)]
pub struct Id {
    /// xml:id (or equivalent in JSON)
    ///
