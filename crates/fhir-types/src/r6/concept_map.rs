...
pub struct ConceptMap {
    ...
    pub allowed_relationship: Vec<super::primitives::Code>,
...
impl super::super::codec::Json for ConceptMap {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.allowed_relationship.is_empty() {
            let (values, elements) =
                super::super::codec::primitive_arrays(&self.allowed_relationship)?;
            object.insert(std::string::String::from("allowedRelationship"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_allowedRelationship"), elements);
            }
        }
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "additionalAttribute" => {
                    raw_additional_attribute = Some(value);
                }
                "allowedRelationship" => {
                    raw_allowed_relationship = Some(value);
                }
                "_allowedRelationship" => {
                    raw_allowed_relationship_element = Some(value);
                }
                "sourceScopeUri" => {
        ...
        let mut field_allowed_relationship = Vec::new();
        for (index, (value, element)) in super::super::codec::pair_arrays(
            raw_allowed_relationship,
            raw_allowed_relationship_element,
            path,
        )?
        .into_iter()
        .enumerate()
        {
            field_allowed_relationship.push(path.with_index(
                "allowedRelationship",
                index,
        ...
        Ok(Self {
            ...
            allowed_relationship: field_allowed_relationship,
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "noMap" => {
                    raw_no_map = Some(value);
                }
                "_noMap" => {
                    raw_no_map_element = Some(value);
                }
                "comment" => {
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "_attribute" => {
                    raw_attribute_element = Some(value);
                }
                "valueCode" => {
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "otherMap" => {
                    raw_other_map = Some(value);
                }
                "_otherMap" => {
                    raw_other_map_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
