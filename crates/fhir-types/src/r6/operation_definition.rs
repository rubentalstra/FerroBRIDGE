...
pub struct OperationDefinition {
    ...
    /// literal address at which an authoritative instance of this operation
    ...
    /// Jurisdiction of the authority that maintains the operation definition (if
    /// applicable)
    ///
    ...
    /// choose.
    pub synchronicity: Option<super::primitives::Code>,
    ...
    pub resource: Vec<super::primitives::Uri>,
...
impl super::super::codec::Json for OperationDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.synchronicity {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("synchronicity"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_synchronicity"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_synchronicity: Option<&super::super::codec::Value> = None;
        let mut raw_synchronicity_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "synchronicity" => {
                    raw_synchronicity = Some(value);
                }
                "_synchronicity" => {
                    raw_synchronicity_element = Some(value);
                }
                "code" => {
                    raw_code = Some(value);
                }
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                OperationDefinitionVersionAlgorithm::from_json_parts(
                    suffix,
        ...
        let field_synchronicity = match (raw_synchronicity, raw_synchronicity_element) {
            (None, None) => None,
            (value, element) => Some(path.with("synchronicity", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        ...
        Ok(Self {
            ...
            synchronicity: field_synchronicity,
            code: field_code,
...
impl serde::Serialize for OperationDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.synchronicity {
            super::super::codec::element_entry(&mut map, "_synchronicity", item)?;
        }
        ...
        if let Some(OperationDefinitionVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        if let Some(item) = &self.synchronicity {
            super::super::codec::value_entry(&mut map, "synchronicity", item)?;
        }
        ...
        match &self.version_algorithm {
            Some(OperationDefinitionVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(OperationDefinitionVersionAlgorithm::String(inner)) => {
...
pub struct OperationDefinitionParameter {
    ...
    pub scope: Vec<super::primitives::Code>,
    /// Minimum Cardinality
    ///
    ...
    pub allowed_type: Vec<super::primitives::Code>,
...
impl super::super::codec::Json for OperationDefinitionParameter {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.scope.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.scope)?;
            object.insert(std::string::String::from("scope"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_scope"), elements);
            }
        }
        ...
        if !self.allowed_type.is_empty() {
            let (values, elements) = super::super::codec::primitive_arrays(&self.allowed_type)?;
            object.insert(std::string::String::from("allowedType"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_allowedType"), elements);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_type: Option<&super::super::codec::Value> = None;
        let mut raw_type_element: Option<&super::super::codec::Value> = None;
        let mut raw_allowed_type: Option<&super::super::codec::Value> = None;
        let mut raw_allowed_type_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "allowedType" => {
                    raw_allowed_type = Some(value);
                }
                "_allowedType" => {
                    raw_allowed_type_element = Some(value);
                }
                "targetProfile" => {
        ...
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_scope, raw_scope_element, path)?
                .into_iter()
                .enumerate()
        {
        ...
        let mut field_allowed_type = Vec::new();
        for (index, (value, element)) in
            super::super::codec::pair_arrays(raw_allowed_type, raw_allowed_type_element, path)?
                .into_iter()
                .enumerate()
        {
            field_allowed_type.push(path.with_index("allowedType", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        ...
        Ok(Self {
            ...
            r#type: field_type,
            allowed_type: field_allowed_type,
...
impl serde::Serialize for OperationDefinitionParameter {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_list_entry(&mut map, "_allowedType", &self.allowed_type)?;
        if let Some(item) = &self.documentation {
        ...
        super::super::codec::element_entry(&mut map, "_name", &self.name)?;
        super::super::codec::element_list_entry(&mut map, "_scope", &self.scope)?;
        if let Some(item) = &self.search_type {
        ...
        super::super::codec::value_list_entry(&mut map, "allowedType", &self.allowed_type)?;
        if let Some(item) = &self.binding {
        ...
        super::super::codec::value_list_entry(&mut map, "scope", &self.scope)?;
        if let Some(item) = &self.search_type {
...
/// The \`versionAlgorithm\[x\]\` choice of \`OperationDefinition\`.
///
/// Indicates the mechanism used to compare versions to determine which is more
/// current.
...
impl OperationDefinitionVersionAlgorithm {
