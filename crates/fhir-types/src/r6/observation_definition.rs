...
pub struct ObservationDefinition {
    ...
    /// etc.) or may be references to specific programs (insurance plans, studies,
    /// etc.) and may be used to assist with indexing and searching for appropriate
    /// ObservationDefinition instances.
    pub use_context: Vec<super::usage_context::UsageContext>,
    /// Jurisdiction of the authority that maintains the this ObservationDefinition
    /// (if applicable)
    ///
    ...
    ///
    /// The body structure on the subject's body where the observation is to be
    /// made.
    ...
    pub supporting_device: Vec<super::codeable_reference::CodeableReference>,
...
impl super::super::codec::Json for ObservationDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.supporting_device.is_empty() {
            let mut items = Vec::with_capacity(self.supporting_device.len());
            for item in &self.supporting_device {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("supportingDevice"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_supporting_device: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "deviceReference" => {
                    raw_device.value("Reference", value, path)?;
                }
                "_deviceReference" => {
                    raw_device.element("Reference", value, path)?;
                }
                "deviceCanonical" => {
                ...
                "supportingDevice" => {
                    raw_supporting_device = Some(value);
                }
                "preferredReportName" => {
        ...
        let field_device = match raw_device.suffix {
            ...
            Some(suffix) => Some(path.with("device", |path| {
                ObservationDefinitionDevice::from_json_parts(
                    suffix,
                    raw_device.value,
                    raw_device.element,
                    path,
        ...
        let mut field_supporting_device = Vec::new();
        if let Some(raw) = raw_supporting_device {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_supporting_device.push(path.with_index(
                    "supportingDevice",
                    index,
                    |path| {
                        super::super::codec::Json::from_json(
        ...
        Ok(Self {
            ...
            device: field_device,
            supporting_device: field_supporting_device,
...
impl serde::Serialize for ObservationDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ObservationDefinitionDevice::Canonical(inner)) = &self.device {
        ...
        match &self.device {
            Some(ObservationDefinitionDevice::Canonical(inner)) => {
                super::super::codec::value_entry(&mut map, "deviceCanonical", inner)?;
            }
            Some(ObservationDefinitionDevice::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "deviceReference",
                    inner.as_ref(),
...
/// The \`device\[x\]\` choice of \`ObservationDefinition\`.
///
/// The measurement model of device or actual device used to produce
/// observations of this type.
...
impl ObservationDefinitionDevice {
...
pub struct ObservationDefinitionQualifiedValue {
    ...
    pub sex_parameter_for_clinical_use: Option<super::primitives::Code>,
...
impl super::super::codec::Json for ObservationDefinitionQualifiedValue {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.sex_parameter_for_clinical_use {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("sexParameterForClinicalUse"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_sexParameterForClinicalUse"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_sex_parameter_for_clinical_use: Option<&super::super::codec::Value> = None;
        let mut raw_sex_parameter_for_clinical_use_element: Option<&super::super::codec::Value> =
            None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "sexParameterForClinicalUse" => {
                    raw_sex_parameter_for_clinical_use = Some(value);
                }
                "_sexParameterForClinicalUse" => {
                    raw_sex_parameter_for_clinical_use_element = Some(value);
                }
                "age" => {
                    raw_age = Some(value);
                }
        ...
        let field_sex_parameter_for_clinical_use = match (
            raw_sex_parameter_for_clinical_use,
            raw_sex_parameter_for_clinical_use_element,
        ) {
            (None, None) => None,
            (value, element) => Some(path.with("sexParameterForClinicalUse", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        ...
        Ok(Self {
            ...
            sex_parameter_for_clinical_use: field_sex_parameter_for_clinical_use,
            age: field_age,
...
impl serde::Serialize for ObservationDefinitionQualifiedValue {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.sex_parameter_for_clinical_use {
            super::super::codec::element_entry(&mut map, "_sexParameterForClinicalUse", item)?;
        }
        if let Some(item) = &self.valid_coded_value_set {
        ...
        if let Some(item) = &self.sex_parameter_for_clinical_use {
            super::super::codec::value_entry(&mut map, "sexParameterForClinicalUse", item)?;
        }
        if let Some(item) = &self.valid_coded_value_set {
