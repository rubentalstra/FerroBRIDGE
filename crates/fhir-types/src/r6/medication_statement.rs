...
pub struct MedicationStatement {
    ...
    ///
    /// Type of medication statement. The committee will revisit these codes,
    /// expecting to use a codesystem from
    ...
    pub dosage: Option<super::dosage_details::DosageDetails>,
