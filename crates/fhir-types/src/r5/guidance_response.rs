...
pub struct GuidanceResponse {
    ...
    pub evaluation_message: Option<super::reference::Reference>,
...
impl super::super::codec::Json for GuidanceResponse {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.evaluation_message {
            object.insert(
    ...
    fn from_json(
        ...
        let field_evaluation_message = raw_evaluation_message
            .map(|value| {
                path.with("evaluationMessage", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
...
impl serde::Serialize for GuidanceResponse {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.evaluation_message {
            serde::ser::SerializeMap::serialize_entry(&mut map, "evaluationMessage", item)?;
        }
        if !self.extension.is_empty() {
