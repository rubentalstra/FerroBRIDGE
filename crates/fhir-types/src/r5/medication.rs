...
pub struct Medication {
    ...
    pub total_volume: Option<super::quantity::Quantity>,
    ...
    ///
    /// A reference to a knowledge resource that provides more information about
    /// this medication.
...
impl super::super::codec::Json for Medication {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.total_volume {
            object.insert(
                std::string::String::from("totalVolume"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_total_volume: Option<&super::super::codec::Value> = None;
        ...
        let field_dose_form = raw_dose_form
            ...
            .transpose()?;
        let field_total_volume = raw_total_volume
            .map(|value| {
                path.with("totalVolume", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            total_volume: field_total_volume,
...
impl serde::Serialize for Medication {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.total_volume {
            serde::ser::SerializeMap::serialize_entry(&mut map, "totalVolume", item)?;
        }
