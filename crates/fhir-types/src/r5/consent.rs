...
pub struct ConsentVerification {
    ...
    /// re-validation.
    pub verification_type: Option<super::codeable_concept::CodeableConcept>,
    ...
    pub verification_date: Vec<super::primitives::DateTime>,
}
...
impl super::super::codec::Json for ConsentVerification {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.verification_type {
            object.insert(
                std::string::String::from("verificationType"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        ...
        if !self.verification_date.is_empty() {
            let (values, elements) =
                super::super::codec::primitive_arrays(&self.verification_date)?;
            object.insert(std::string::String::from("verificationDate"), values);
            if let Some(elements) = elements {
                object.insert(std::string::String::from("_verificationDate"), elements);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut raw_verification_type: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "verificationType" => {
                    raw_verification_type = Some(value);
                }
                "verifiedBy" => {
        ...
        let field_verification_type = raw_verification_type
            .map(|value| {
                path.with("verificationType", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        let field_verified_with = raw_verified_with
            ...
            .transpose()?;
        let mut field_verification_date = Vec::new();
        for (index, (value, element)) in super::super::codec::pair_arrays(
            raw_verification_date,
            raw_verification_date_element,
            path,
        )?
        .into_iter()
        .enumerate()
        {
            field_verification_date.push(path.with_index("verificationDate", index, |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?);
        }
        Ok(Self {
            ...
            verification_type: field_verification_type,
...
impl serde::Serialize for ConsentVerification {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.verification_type {
            serde::ser::SerializeMap::serialize_entry(&mut map, "verificationType", item)?;
        }
