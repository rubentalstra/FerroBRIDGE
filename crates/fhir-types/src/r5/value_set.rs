...
impl super::super::codec::Json for ValueSet {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("ValueSet")),
        );
    ...
    fn from_json(
        ...
        let mut raw_immutable: Option<&super::super::codec::Value> = None;
        let mut raw_immutable_element: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_compose: Option<&super::super::codec::Value> = None;
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                ValueSetVersionAlgorithm::from_json_parts(
                    suffix,
...
impl serde::Serialize for ValueSet {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.immutable {
            super::super::codec::element_entry(&mut map, "_immutable", item)?;
        }
        if let Some(item) = &self.implicit_rules {
        ...
        if let Some(ValueSetVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        if let Some(item) = &self.compose {
            serde::ser::SerializeMap::serialize_entry(&mut map, "compose", item)?;
        }
        if !self.contact.is_empty() {
        ...
        if let Some(item) = &self.immutable {
            super::super::codec::value_entry(&mut map, "immutable", item)?;
        }
        if let Some(item) = &self.implicit_rules {
        ...
        serde::ser::SerializeMap::serialize_entry(&mut map, "resourceType", "ValueSet")?;
        if !self.reviewer.is_empty() {
        ...
        match &self.version_algorithm {
            Some(ValueSetVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
...
impl serde::Serialize for ValueSetCompose {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if !self.exclude.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "exclude", &self.exclude)?;
        }
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        ...
        if !self.include.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "include", &self.include)?;
        }
        if let Some(item) = &self.locked_date {
...
impl serde::Serialize for ValueSetComposeInclude {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        super::super::codec::element_list_entry(&mut map, "_valueSet", &self.value_set)?;
        if let Some(item) = &self.version {
            super::super::codec::element_entry(&mut map, "_version", item)?;
        }
        if !self.concept.is_empty() {
        ...
        super::super::codec::value_list_entry(&mut map, "valueSet", &self.value_set)?;
        if let Some(item) = &self.version {
            super::super::codec::value_entry(&mut map, "version", item)?;
        }
        serde::ser::SerializeMap::end(map)
...
impl super::super::codec::Json for ValueSetComposeIncludeConceptDesignation {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.additional_use.is_empty() {
            let mut items = Vec::with_capacity(self.additional_use.len());
            for item in &self.additional_use {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("additionalUse"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_additional_use: Option<&super::super::codec::Value> = None;
        ...
        let field_use = raw_use
            ...
            .transpose()?;
        let mut field_additional_use = Vec::new();
        if let Some(raw) = raw_additional_use {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_additional_use.push(path.with_index("additionalUse", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
...
impl serde::Serialize for ValueSetComposeIncludeFilter {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_entry(&mut map, "_op", &self.op)?;
        ...
        super::super::codec::value_entry(&mut map, "op", &self.op)?;
...
impl super::super::codec::Json for ValueSetExpansion {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.next {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("next"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_next"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_next: Option<&super::super::codec::Value> = None;
        let mut raw_next_element: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_total_element: Option<&super::super::codec::Value> = None;
        ...
        let field_next = match (raw_next, raw_next_element) {
            (None, None) => None,
            (value, element) => Some(path.with("next", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
...
impl serde::Serialize for ValueSetExpansion {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.identifier {
            super::super::codec::element_entry(&mut map, "_identifier", item)?;
        }
        if let Some(item) = &self.next {
            super::super::codec::element_entry(&mut map, "_next", item)?;
        }
        if let Some(item) = &self.offset {
            super::super::codec::element_entry(&mut map, "_offset", item)?;
        }
        super::super::codec::element_entry(&mut map, "_timestamp", &self.timestamp)?;
        if let Some(item) = &self.total {
            super::super::codec::element_entry(&mut map, "_total", item)?;
        }
        if !self.contains.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "contains", &self.contains)?;
        }
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        ...
        if let Some(item) = &self.identifier {
            super::super::codec::value_entry(&mut map, "identifier", item)?;
        }
        if !self.modifier_extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(
                &mut map,
        ...
        if let Some(item) = &self.next {
            super::super::codec::value_entry(&mut map, "next", item)?;
        }
        if let Some(item) = &self.offset {
        ...
        super::super::codec::value_entry(&mut map, "timestamp", &self.timestamp)?;
        if let Some(item) = &self.total {
...
impl serde::Serialize for ValueSetExpansionContains {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.r#abstract {
            super::super::codec::element_entry(&mut map, "_abstract", item)?;
        }
        if let Some(item) = &self.code {
        ...
        if let Some(item) = &self.r#abstract {
            super::super::codec::value_entry(&mut map, "abstract", item)?;
        }
        if let Some(item) = &self.code {
...
impl super::super::codec::Json for ValueSetExpansionContainsProperty {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if !self.sub_property.is_empty() {
            let mut items = Vec::with_capacity(self.sub_property.len());
            for item in &self.sub_property {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("subProperty"),
                super::super::codec::Value::Array(items),
            );
        }
        Ok(object)
    ...
    fn from_json(
        ...
        let mut raw_sub_property: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
        ...
        let field_value = path.with("value", |path| {
            ...
            ValueSetExpansionContainsPropertyValue::from_json_parts(
                suffix,
                raw_value.value,
                raw_value.element,
                path,
        ...
        let mut field_sub_property = Vec::new();
        if let Some(raw) = raw_sub_property {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_sub_property.push(path.with_index("subProperty", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        Ok(Self {
            ...
            code: field_code,
            value: field_value,
            sub_property: field_sub_property,
        })
    }
}

impl serde::Serialize for ValueSetExpansionContainsProperty {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_entry(&mut map, "_code", &self.code)?;
        match &self.value {
            ValueSetExpansionContainsPropertyValue::Boolean(inner) => {
                super::super::codec::element_entry(&mut map, "_valueBoolean", inner)?;
            }
            ValueSetExpansionContainsPropertyValue::Code(inner) => {
            ...
            ValueSetExpansionContainsPropertyValue::Decimal(inner) => {
                super::super::codec::element_entry(&mut map, "_valueDecimal", inner)?;
            }
            ValueSetExpansionContainsPropertyValue::Integer(inner) => {
                super::super::codec::element_entry(&mut map, "_valueInteger", inner)?;
            }
            ValueSetExpansionContainsPropertyValue::String(inner) => {
                super::super::codec::element_entry(&mut map, "_valueString", inner)?;
            }
            ValueSetExpansionContainsPropertyValue::Coding(_) => {}
        }
        super::super::codec::value_entry(&mut map, "code", &self.code)?;
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        ...
        if !self.sub_property.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "subProperty", &self.sub_property)?;
        }
        match &self.value {
            ValueSetExpansionContainsPropertyValue::Boolean(inner) => {
...
impl<'de> serde::Deserialize<'de> for ValueSetExpansionContainsProperty {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("ValueSetExpansionContainsProperty");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for ValueSetExpansionContainsPropertySubProperty {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
    ...
    fn from_json(
        ...
        let field_value = path.with("value", |path| {
            let suffix = raw_value
                .suffix
                .ok_or_else(|| path.error(super::super::codec::DecodeErrorKind::MissingProperty))?;
            ValueSetExpansionContainsPropertySubPropertyValue::from_json_parts(
                suffix,
                raw_value.value,
                raw_value.element,
                path,
...
impl serde::Serialize for ValueSetExpansionContainsPropertySubProperty {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_entry(&mut map, "_code", &self.code)?;
        match &self.value {
            ValueSetExpansionContainsPropertySubPropertyValue::Boolean(inner) => {
                super::super::codec::element_entry(&mut map, "_valueBoolean", inner)?;
            }
            ValueSetExpansionContainsPropertySubPropertyValue::Code(inner) => {
                super::super::codec::element_entry(&mut map, "_valueCode", inner)?;
            }
            ValueSetExpansionContainsPropertySubPropertyValue::DateTime(inner) => {
                super::super::codec::element_entry(&mut map, "_valueDateTime", inner)?;
            }
            ValueSetExpansionContainsPropertySubPropertyValue::Decimal(inner) => {
                super::super::codec::element_entry(&mut map, "_valueDecimal", inner)?;
            }
            ValueSetExpansionContainsPropertySubPropertyValue::Integer(inner) => {
                super::super::codec::element_entry(&mut map, "_valueInteger", inner)?;
            }
            ValueSetExpansionContainsPropertySubPropertyValue::String(inner) => {
                super::super::codec::element_entry(&mut map, "_valueString", inner)?;
            }
            ValueSetExpansionContainsPropertySubPropertyValue::Coding(_) => {}
        }
        super::super::codec::value_entry(&mut map, "code", &self.code)?;
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
...
impl<'de> serde::Deserialize<'de> for ValueSetExpansionContainsPropertySubProperty {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path =
            super::super::codec::Path::root("ValueSetExpansionContainsPropertySubProperty");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl ValueSetExpansionContainsPropertySubPropertyValue {
...
impl ValueSetExpansionContainsPropertyValue {
    /// The key suffix, the value part, and the `_name` part of this form.
    ///
    /// # Errors
    ///
...
impl serde::Serialize for ValueSetExpansionParameter {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.value {
            Some(ValueSetExpansionParameterValue::Boolean(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueBoolean", inner)?;
            }
            Some(ValueSetExpansionParameterValue::Code(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueCode", inner)?;
            }
            Some(ValueSetExpansionParameterValue::DateTime(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueDateTime", inner)?;
            }
            Some(ValueSetExpansionParameterValue::Decimal(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueDecimal", inner)?;
            }
            Some(ValueSetExpansionParameterValue::Integer(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueInteger", inner)?;
            }
            Some(ValueSetExpansionParameterValue::String(inner)) => {
                super::super::codec::element_entry(&mut map, "_valueString", inner)?;
            }
            Some(ValueSetExpansionParameterValue::Uri(inner)) => {
...
impl super::super::codec::Json for ValueSetExpansionProperty {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for ValueSetExpansionProperty {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        super::super::codec::element_entry(&mut map, "_code", &self.code)?;
        if let Some(item) = &self.uri {
...
impl<'de> serde::Deserialize<'de> for ValueSetExpansionProperty {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("ValueSetExpansionProperty");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for ValueSetScope {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if let Some(item) = &self.inclusion_criteria {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("inclusionCriteria"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_inclusionCriteria"), e);
            }
        }
        if let Some(item) = &self.exclusion_criteria {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("exclusionCriteria"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_exclusionCriteria"), e);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let mut raw_extension: Option<&super::super::codec::Value> = None;
        let mut raw_modifier_extension: Option<&super::super::codec::Value> = None;
        let mut raw_inclusion_criteria: Option<&super::super::codec::Value> = None;
        let mut raw_inclusion_criteria_element: Option<&super::super::codec::Value> = None;
        let mut raw_exclusion_criteria: Option<&super::super::codec::Value> = None;
        let mut raw_exclusion_criteria_element: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => {
                    raw_id = Some(value);
                ...
                "inclusionCriteria" => {
                    raw_inclusion_criteria = Some(value);
                }
                "_inclusionCriteria" => {
                    raw_inclusion_criteria_element = Some(value);
                }
                "exclusionCriteria" => {
                    raw_exclusion_criteria = Some(value);
                }
                "_exclusionCriteria" => {
                    raw_exclusion_criteria_element = Some(value);
                }
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
        ...
        let field_inclusion_criteria =
            match (raw_inclusion_criteria, raw_inclusion_criteria_element) {
                (None, None) => None,
                (value, element) => Some(path.with("inclusionCriteria", |path| {
                    super::super::codec::Primitive::from_json_parts(value, element, path)
                })?),
            };
        let field_exclusion_criteria =
            match (raw_exclusion_criteria, raw_exclusion_criteria_element) {
                (None, None) => None,
                (value, element) => Some(path.with("exclusionCriteria", |path| {
                    super::super::codec::Primitive::from_json_parts(value, element, path)
                })?),
            };
        Ok(Self {
            ...
            extension: field_extension,
            modifier_extension: field_modifier_extension,
            inclusion_criteria: field_inclusion_criteria,
            exclusion_criteria: field_exclusion_criteria,
        })
    }
}

impl serde::Serialize for ValueSetScope {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.exclusion_criteria {
            super::super::codec::element_entry(&mut map, "_exclusionCriteria", item)?;
        }
        if let Some(item) = &self.inclusion_criteria {
            super::super::codec::element_entry(&mut map, "_inclusionCriteria", item)?;
        }
        if let Some(item) = &self.exclusion_criteria {
            super::super::codec::value_entry(&mut map, "exclusionCriteria", item)?;
        }
        if !self.extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(&mut map, "extension", &self.extension)?;
        }
        ...
        if let Some(item) = &self.inclusion_criteria {
            super::super::codec::value_entry(&mut map, "inclusionCriteria", item)?;
        }
        if !self.modifier_extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(
                &mut map,
...
impl<'de> serde::Deserialize<'de> for ValueSetScope {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("ValueSetScope");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
