...
pub struct MessageDefinition {
    ...
    /// additional resources are to be added to the Bundle when building the
    /// message. The GraphDefinition can also specify profiles that apply to the
    /// various resources.
    pub graph: Option<super::primitives::Canonical>,
}
...
impl super::super::codec::Json for MessageDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.graph {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("graph"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_graph"), e);
            }
        }
        Ok(object)
    }
    ...
    fn from_json(
        ...
        let field_graph = match (raw_graph, raw_graph_element) {
            (None, None) => None,
            (value, element) => Some(path.with("graph", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        Ok(Self {
...
impl serde::Serialize for MessageDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.graph {
            super::super::codec::element_entry(&mut map, "_graph", item)?;
        }
        if let Some(item) = &self.implicit_rules {
        ...
        if let Some(item) = &self.graph {
            super::super::codec::value_entry(&mut map, "graph", item)?;
        }
        if let Some(v) = &self.id {
