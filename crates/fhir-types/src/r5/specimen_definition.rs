    ...
    fn from_json(
        ...
        let field_subject = match raw_subject.suffix {
            ...
            Some(suffix) => Some(path.with("subject", |path| {
                SpecimenDefinitionSubject::from_json_parts(
                    suffix,
                    raw_subject.value,
                    raw_subject.element,
                    path,
...
impl serde::Serialize for SpecimenDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.subject {
            Some(SpecimenDefinitionSubject::CodeableConcept(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "subjectCodeableConcept",
                    inner.as_ref(),
            ...
            Some(SpecimenDefinitionSubject::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "subjectReference",
                    inner.as_ref(),
...
/// The \`subject\[x\]\` choice of \`SpecimenDefinition\`.
///
/// A code or group definition that describes the intended subject from which
/// this kind of specimen is to be collected.
...
impl SpecimenDefinitionSubject {
