...
impl super::super::codec::Json for OperationOutcome {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("OperationOutcome")),
        );
...
impl super::super::codec::Json for OperationOutcomeIssue {
    ...
    fn from_json(
        ...
        let mut raw_diagnostics: Option<&super::super::codec::Value> = None;
        let mut raw_diagnostics_element: Option<&super::super::codec::Value> = None;
