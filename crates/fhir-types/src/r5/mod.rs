...
//! FHIR R5 types: the root set the enabled features select and the complete
//! closure of the datatypes and primitives it references, from `hl7.fhir.r5.core` 5.0.0.
//!
