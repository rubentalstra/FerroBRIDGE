...
pub struct DiagnosticReport {
    ...
    /// views of the source images. A GenomicStudy might comprise one or more
    /// analyses, each serving a specific purpose. These analyses may vary in method
    /// (e.g., karyotyping, CNV, or SNV detection), performer, software, devices
