...
pub struct Requirements {
    ...
    pub actor: Vec<super::primitives::Canonical>,
...
pub struct RequirementsStatement {
    ...
    /// or restricts.
    pub derived_from: Option<super::primitives::String>,
    /// A larger requirement that this requirement helps to refine and enable.
    pub parent: Option<super::primitives::String>,
...
impl super::super::codec::Json for RequirementsStatement {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.parent {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("parent"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_parent"), e);
            }
        }
    ...
    fn from_json(
        ...
        let field_parent = match (raw_parent, raw_parent_element) {
            (None, None) => None,
            (value, element) => Some(path.with("parent", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
...
impl serde::Serialize for RequirementsStatement {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.parent {
            super::super::codec::element_entry(&mut map, "_parent", item)?;
        }
        super::super::codec::element_list_entry(&mut map, "_reference", &self.reference)?;
        ...
        if let Some(item) = &self.parent {
            super::super::codec::value_entry(&mut map, "parent", item)?;
        }
        super::super::codec::value_list_entry(&mut map, "reference", &self.reference)?;
