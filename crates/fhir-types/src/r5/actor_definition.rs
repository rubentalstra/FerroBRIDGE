...
pub struct ActorDefinition {
    ...
    pub capabilities: Option<super::primitives::Canonical>,
...
impl super::super::codec::Json for ActorDefinition {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.capabilities {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
    ...
    fn from_json(
        ...
        let field_capabilities = match (raw_capabilities, raw_capabilities_element) {
            (None, None) => None,
            (value, element) => Some(path.with("capabilities", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
...
impl serde::Serialize for ActorDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.capabilities {
            super::super::codec::element_entry(&mut map, "_capabilities", item)?;
        }
        if let Some(item) = &self.copyright {
        ...
        if let Some(item) = &self.capabilities {
            super::super::codec::value_entry(&mut map, "capabilities", item)?;
        }
        if !self.contact.is_empty() {
