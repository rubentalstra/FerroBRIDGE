...
pub struct SupplyRequest {
    ...
    pub deliver_for: Option<super::reference::Reference>,
...
impl super::super::codec::Json for SupplyRequest {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.deliver_for {
            object.insert(
                std::string::String::from("deliverFor"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        object.insert(
    ...
    fn from_json(
        ...
        let mut raw_deliver_for: Option<&super::super::codec::Value> = None;
        ...
        let field_deliver_for = raw_deliver_for
            .map(|value| {
                path.with("deliverFor", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
...
impl serde::Serialize for SupplyRequest {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.deliver_for {
            serde::ser::SerializeMap::serialize_entry(&mut map, "deliverFor", item)?;
        }
        if let Some(item) = &self.deliver_from {
