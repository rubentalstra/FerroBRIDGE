    ...
    fn from_json(
        ...
        let field_cite_as = match raw_cite_as.suffix {
            ...
            Some(suffix) => Some(path.with("citeAs", |path| {
                ArtifactAssessmentCiteAs::from_json_parts(
                    suffix,
                    raw_cite_as.value,
                    raw_cite_as.element,
                    path,
...
impl serde::Serialize for ArtifactAssessment {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ArtifactAssessmentCiteAs::Markdown(inner)) = &self.cite_as {
        ...
        match &self.cite_as {
            Some(ArtifactAssessmentCiteAs::Markdown(inner)) => {
                super::super::codec::value_entry(&mut map, "citeAsMarkdown", inner)?;
            }
            Some(ArtifactAssessmentCiteAs::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "citeAsReference",
                    inner.as_ref(),
...
/// The \`citeAs\[x\]\` choice of \`ArtifactAssessment\`.
///
/// Display of or reference to the bibliographic citation of the comment,
/// classifier, or rating.
#[derive(Debug, Clone, PartialEq, Eq)]
...
pub struct ArtifactAssessmentContent {
    ...
    pub information_type: Option<super::primitives::Code>,
...
impl super::super::codec::Json for ArtifactAssessmentContent {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.information_type {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("informationType"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_informationType"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_extension: Option<&super::super::codec::Value> = None;
        let mut raw_modifier_extension: Option<&super::super::codec::Value> = None;
        let mut raw_information_type: Option<&super::super::codec::Value> = None;
        let mut raw_information_type_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "informationType" => {
                    raw_information_type = Some(value);
                }
                "_informationType" => {
                    raw_information_type_element = Some(value);
                }
                "summary" => {
        ...
        let field_information_type = match (raw_information_type, raw_information_type_element) {
            (None, None) => None,
            (value, element) => Some(path.with("informationType", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        ...
        Ok(Self {
            ...
            extension: field_extension,
            modifier_extension: field_modifier_extension,
            information_type: field_information_type,
...
impl serde::Serialize for ArtifactAssessmentContent {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.information_type {
            super::super::codec::element_entry(&mut map, "_informationType", item)?;
        }
        ...
        if let Some(item) = &self.information_type {
            super::super::codec::value_entry(&mut map, "informationType", item)?;
        }
        if !self.modifier_extension.is_empty() {
            serde::ser::SerializeMap::serialize_entry(
                &mut map,
