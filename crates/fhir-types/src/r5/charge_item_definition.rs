    ...
    fn from_json(
        ...
        let field_version_algorithm = match raw_version_algorithm.suffix {
            ...
            Some(suffix) => Some(path.with("versionAlgorithm", |path| {
                ChargeItemDefinitionVersionAlgorithm::from_json_parts(
                    suffix,
...
impl serde::Serialize for ChargeItemDefinition {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ChargeItemDefinitionVersionAlgorithm::String(inner)) = &self.version_algorithm {
        ...
        match &self.version_algorithm {
            Some(ChargeItemDefinitionVersionAlgorithm::Coding(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "versionAlgorithmCoding",
                    inner.as_ref(),
            ...
            Some(ChargeItemDefinitionVersionAlgorithm::String(inner)) => {
...
pub struct ChargeItemDefinitionApplicability {
    ...
    pub related_artifact: Option<super::related_artifact::RelatedArtifact>,
}
...
impl super::super::codec::Json for ChargeItemDefinitionApplicability {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.related_artifact {
            object.insert(
    ...
    fn from_json(
        ...
        let field_effective_period = raw_effective_period
            ...
            .transpose()?;
        let field_related_artifact = raw_related_artifact
            .map(|value| {
                path.with("relatedArtifact", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
...
impl serde::Serialize for ChargeItemDefinitionApplicability {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.related_artifact {
            serde::ser::SerializeMap::serialize_entry(&mut map, "relatedArtifact", item)?;
        }
        serde::ser::SerializeMap::end(map)
    }
}
...
/// The \`versionAlgorithm\[x\]\` choice of \`ChargeItemDefinition\`.
///
/// Indicates the mechanism used to compare versions to determine which is more
/// current.
...
impl ChargeItemDefinitionVersionAlgorithm {
