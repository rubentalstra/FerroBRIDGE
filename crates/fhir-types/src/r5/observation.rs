...
impl super::super::codec::Json for Observation {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.instantiates {
            let (suffix, value, element) = item.to_json_parts()?;
            if let Some(value) = value {
                object.insert(format!("instantiates{suffix}"), value);
            }
            if let Some(element) = element {
                object.insert(format!("_instantiates{suffix}"), element);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_instantiates = super::super::codec::ChoiceSlot::default();
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "instantiatesCanonical" => {
                    raw_instantiates.value("Canonical", value, path)?;
                }
                "_instantiatesCanonical" => {
                    raw_instantiates.element("Canonical", value, path)?;
                }
                "instantiatesReference" => {
                    raw_instantiates.value("Reference", value, path)?;
                }
                "_instantiatesReference" => {
                    raw_instantiates.element("Reference", value, path)?;
                }
                "basedOn" => {
        ...
        let field_instantiates = match raw_instantiates.suffix {
            None => None,
            Some(suffix) => Some(path.with("instantiates", |path| {
                ObservationInstantiates::from_json_parts(
                    suffix,
                    raw_instantiates.value,
                    raw_instantiates.element,
                    path,
                )
            })?),
        };
...
impl serde::Serialize for Observation {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ObservationInstantiates::Canonical(inner)) = &self.instantiates {
            super::super::codec::element_entry(&mut map, "_instantiatesCanonical", inner)?;
        }
        if let Some(item) = &self.issued {
        ...
        match &self.instantiates {
            Some(ObservationInstantiates::Canonical(inner)) => {
                super::super::codec::value_entry(&mut map, "instantiatesCanonical", inner)?;
            }
            Some(ObservationInstantiates::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "instantiatesReference",
                    inner.as_ref(),
        ...
        match &self.value {
            ...
            Some(ObservationValue::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueReference",
                    inner.as_ref(),
...
impl serde::Serialize for ObservationComponent {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.value {
            ...
            Some(ObservationComponentValue::Reference(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueReference",
                    inner.as_ref(),
...
/// The \`instantiates\[x\]\` choice of \`Observation\`.
///
/// The reference to a FHIR ObservationDefinition resource that provides the
/// definition that is adhered to in whole or in part by this Observation
/// instance.
