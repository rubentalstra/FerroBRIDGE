...
impl super::super::codec::Json for SubscriptionTopic {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if !self.resource_trigger.is_empty() {
            let mut items = Vec::with_capacity(self.resource_trigger.len());
            for item in &self.resource_trigger {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("resourceTrigger"),
                super::super::codec::Value::Array(items),
            );
        }
        if !self.event_trigger.is_empty() {
            let mut items = Vec::with_capacity(self.event_trigger.len());
            ...
            object.insert(
                std::string::String::from("eventTrigger"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_resource_trigger: Option<&super::super::codec::Value> = None;
        let mut raw_event_trigger: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "resourceTrigger" => {
                    raw_resource_trigger = Some(value);
                }
                "eventTrigger" => {
                    raw_event_trigger = Some(value);
                }
                "canFilterBy" => {
        ...
        let field_effective_period = raw_effective_period
            ...
            .transpose()?;
        let mut field_resource_trigger = Vec::new();
        if let Some(raw) = raw_resource_trigger {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_resource_trigger.push(path.with_index("resourceTrigger", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        let mut field_event_trigger = Vec::new();
        if let Some(raw) = raw_event_trigger {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_event_trigger.push(path.with_index("eventTrigger", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        Ok(Self {
            ...
            resource_trigger: field_resource_trigger,
            event_trigger: field_event_trigger,
...
impl super::super::codec::Json for SubscriptionTopicCanFilterBy {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for SubscriptionTopicCanFilterBy {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
...
impl<'de> serde::Deserialize<'de> for SubscriptionTopicCanFilterBy {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("SubscriptionTopicCanFilterBy");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for SubscriptionTopicEventTrigger {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        object.insert(
            ...
            super::super::codec::Value::Object(super::super::codec::Json::to_json(&self.event)?),
        );
...
impl serde::Serialize for SubscriptionTopicEventTrigger {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.description {
            super::super::codec::element_entry(&mut map, "_description", item)?;
...
impl<'de> serde::Deserialize<'de> for SubscriptionTopicEventTrigger {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("SubscriptionTopicEventTrigger");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for SubscriptionTopicNotificationShape {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for SubscriptionTopicNotificationShape {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
...
impl<'de> serde::Deserialize<'de> for SubscriptionTopicNotificationShape {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("SubscriptionTopicNotificationShape");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
pub struct SubscriptionTopicResourceTrigger {
    ...
    /// "Patient" maps to <http://hl7.org/fhir/StructureDefinition/Patient>. For
...
impl super::super::codec::Json for SubscriptionTopicResourceTrigger {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for SubscriptionTopicResourceTrigger {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.description {
            super::super::codec::element_entry(&mut map, "_description", item)?;
...
impl<'de> serde::Deserialize<'de> for SubscriptionTopicResourceTrigger {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("SubscriptionTopicResourceTrigger");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for SubscriptionTopicResourceTriggerQueryCriteria {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for SubscriptionTopicResourceTriggerQueryCriteria {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.current {
...
impl<'de> serde::Deserialize<'de> for SubscriptionTopicResourceTriggerQueryCriteria {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path =
            super::super::codec::Path::root("SubscriptionTopicResourceTriggerQueryCriteria");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
