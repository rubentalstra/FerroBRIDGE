...
impl serde::Serialize for DataRequirementValueFilter {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(DataRequirementValueFilterValue::DateTime(inner)) = &self.value {
            super::super::codec::element_entry(&mut map, "_valueDateTime", inner)?;
        }
        if let Some(item) = &self.comparator {
        ...
        match &self.value {
            Some(DataRequirementValueFilterValue::DateTime(inner)) => {
                super::super::codec::value_entry(&mut map, "valueDateTime", inner)?;
            }
            Some(DataRequirementValueFilterValue::Duration(inner)) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "valueDuration",
                    inner.as_ref(),
            ...
            Some(DataRequirementValueFilterValue::Period(inner)) => {
                serde::ser::SerializeMap::serialize_entry(&mut map, "valuePeriod", inner.as_ref())?;
            }
            None => {}
        }
