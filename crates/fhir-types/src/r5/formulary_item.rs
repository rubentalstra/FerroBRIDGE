...
impl super::super::codec::Json for FormularyItem {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("FormularyItem")),
        );
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("FormularyItem") {
...
impl serde::Serialize for FormularyItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        serde::ser::SerializeMap::serialize_entry(&mut map, "resourceType", "FormularyItem")?;
        if let Some(item) = &self.status {
...
impl<'de> serde::Deserialize<'de> for FormularyItem {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("FormularyItem");
        let object =
