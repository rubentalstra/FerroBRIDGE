...
pub struct ClinicalImpression {
    ...
    pub change_pattern: Option<super::codeable_concept::CodeableConcept>,
...
impl super::super::codec::Json for ClinicalImpression {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.change_pattern {
            object.insert(
                std::string::String::from("changePattern"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_change_pattern: Option<&super::super::codec::Value> = None;
        ...
        let field_change_pattern = raw_change_pattern
            .map(|value| {
                path.with("changePattern", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            change_pattern: field_change_pattern,
...
impl serde::Serialize for ClinicalImpression {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.change_pattern {
            serde::ser::SerializeMap::serialize_entry(&mut map, "changePattern", item)?;
        }
        if !self.contained.is_empty() {
