...
pub struct Coverage {
    ...
    /// an auto accident then only coverages (1) and (2) above would be applicatble
    /// and would apply in the order specified in parenthesis.
    ...
    /// insurance coverage.
    pub insurance_plan: Option<super::reference::Reference>,
}
...
impl super::super::codec::Json for Coverage {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.insurance_plan {
            object.insert(
                std::string::String::from("insurancePlan"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        Ok(object)
    ...
    fn from_json(
        ...
        let mut raw_insurance_plan: Option<&super::super::codec::Value> = None;
        ...
        let field_insurance_plan = raw_insurance_plan
            .map(|value| {
                path.with("insurancePlan", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            insurance_plan: field_insurance_plan,
        })
    }
}
...
impl serde::Serialize for Coverage {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.insurance_plan {
            serde::ser::SerializeMap::serialize_entry(&mut map, "insurancePlan", item)?;
        }
        if let Some(item) = &self.insurer {
