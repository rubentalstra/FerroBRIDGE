...
pub struct EvidenceReportRelatesToTarget {
    ...
    pub display: Option<super::primitives::Markdown>,
    /// Target of the relationship Resource reference.
    pub resource: Option<super::reference::Reference>,
}

impl super::super::codec::Json for EvidenceReportRelatesToTarget {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl serde::Serialize for EvidenceReportRelatesToTarget {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.display {
...
impl<'de> serde::Deserialize<'de> for EvidenceReportRelatesToTarget {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("EvidenceReportRelatesToTarget");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
