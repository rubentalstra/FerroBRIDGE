...
pub struct RiskEvidenceSynthesis {
    ...
    /// research.
    pub exposure: Option<super::reference::Reference>,
    /// What outcome?
    ///
...
impl super::super::codec::Json for RiskEvidenceSynthesis {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            ...
            super::super::codec::Value::String(std::string::String::from("RiskEvidenceSynthesis")),
        );
        ...
        if let Some(item) = &self.exposure {
            object.insert(
        ...
        if let Some(item) = &self.risk_estimate {
            object.insert(
                std::string::String::from("riskEstimate"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_risk_estimate: Option<&super::super::codec::Value> = None;
        let mut raw_certainty: Option<&super::super::codec::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("RiskEvidenceSynthesis") {
        ...
        let field_exposure = raw_exposure
            .map(|value| {
                path.with("exposure", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        let field_sample_size = raw_sample_size
            ...
            .transpose()?;
        let field_risk_estimate = raw_risk_estimate
            .map(|value| {
                path.with("riskEstimate", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        Ok(Self {
            ...
            risk_estimate: field_risk_estimate,
...
impl serde::Serialize for RiskEvidenceSynthesis {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.exposure {
            serde::ser::SerializeMap::serialize_entry(&mut map, "exposure", item)?;
        }
        if !self.extension.is_empty() {
        ...
        if let Some(item) = &self.risk_estimate {
            serde::ser::SerializeMap::serialize_entry(&mut map, "riskEstimate", item)?;
        }
        if let Some(item) = &self.sample_size {
...
impl<'de> serde::Deserialize<'de> for RiskEvidenceSynthesis {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RiskEvidenceSynthesis");
        let object =
...
impl super::super::codec::Json for RiskEvidenceSynthesisCertainty {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl<'de> serde::Deserialize<'de> for RiskEvidenceSynthesisCertainty {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RiskEvidenceSynthesisCertainty");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for RiskEvidenceSynthesisCertaintyCertaintySubcomponent {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl<'de> serde::Deserialize<'de> for RiskEvidenceSynthesisCertaintyCertaintySubcomponent {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path =
            super::super::codec::Path::root("RiskEvidenceSynthesisCertaintyCertaintySubcomponent");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
pub struct RiskEvidenceSynthesisRiskEstimate {
    ...
    pub denominator_count: Option<super::primitives::Integer>,
    /// Number with the outcome
    ///
    /// The number of group members with the outcome of interest.
    pub numerator_count: Option<super::primitives::Integer>,
...
impl super::super::codec::Json for RiskEvidenceSynthesisRiskEstimate {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
        ...
        if let Some(item) = &self.denominator_count {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("denominatorCount"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_denominatorCount"), e);
            }
        }
        if let Some(item) = &self.numerator_count {
            if let Some(v) = super::super::codec::Primitive::value_json(item)? {
                object.insert(std::string::String::from("numeratorCount"), v);
            }
            if let Some(e) = super::super::codec::Primitive::element_json(item)? {
                object.insert(std::string::String::from("_numeratorCount"), e);
            }
        }
    ...
    fn from_json(
        ...
        let mut raw_denominator_count: Option<&super::super::codec::Value> = None;
        let mut raw_denominator_count_element: Option<&super::super::codec::Value> = None;
        let mut raw_numerator_count: Option<&super::super::codec::Value> = None;
        let mut raw_numerator_count_element: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "denominatorCount" => {
                    raw_denominator_count = Some(value);
                }
                "_denominatorCount" => {
                    raw_denominator_count_element = Some(value);
                }
                "numeratorCount" => {
                    raw_numerator_count = Some(value);
                }
                "_numeratorCount" => {
                    raw_numerator_count_element = Some(value);
                }
                "precisionEstimate" => {
        ...
        let field_unit_of_measure = raw_unit_of_measure
            ...
            .transpose()?;
        let field_denominator_count = match (raw_denominator_count, raw_denominator_count_element) {
            (None, None) => None,
            (value, element) => Some(path.with("denominatorCount", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        let field_numerator_count = match (raw_numerator_count, raw_numerator_count_element) {
            (None, None) => None,
            (value, element) => Some(path.with("numeratorCount", |path| {
                super::super::codec::Primitive::from_json_parts(value, element, path)
            })?),
        };
        ...
        Ok(Self {
            ...
            denominator_count: field_denominator_count,
            numerator_count: field_numerator_count,
...
impl serde::Serialize for RiskEvidenceSynthesisRiskEstimate {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let mut map = serde::Serializer::serialize_map(serializer, None)?;
        if let Some(item) = &self.denominator_count {
            super::super::codec::element_entry(&mut map, "_denominatorCount", item)?;
        }
        if let Some(item) = &self.description {
            super::super::codec::element_entry(&mut map, "_description", item)?;
        }
        if let Some(item) = &self.numerator_count {
            super::super::codec::element_entry(&mut map, "_numeratorCount", item)?;
        }
        if let Some(item) = &self.value {
            super::super::codec::element_entry(&mut map, "_value", item)?;
        }
        if let Some(item) = &self.denominator_count {
            super::super::codec::value_entry(&mut map, "denominatorCount", item)?;
        }
        if let Some(item) = &self.description {
            super::super::codec::value_entry(&mut map, "description", item)?;
        }
        ...
        if let Some(item) = &self.numerator_count {
            super::super::codec::value_entry(&mut map, "numeratorCount", item)?;
        }
        if !self.precision_estimate.is_empty() {
            serde::ser::SerializeMap::serialize_entry(
                &mut map,
...
impl<'de> serde::Deserialize<'de> for RiskEvidenceSynthesisRiskEstimate {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RiskEvidenceSynthesisRiskEstimate");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for RiskEvidenceSynthesisRiskEstimatePrecisionEstimate {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl<'de> serde::Deserialize<'de> for RiskEvidenceSynthesisRiskEstimatePrecisionEstimate {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path =
            super::super::codec::Path::root("RiskEvidenceSynthesisRiskEstimatePrecisionEstimate");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl super::super::codec::Json for RiskEvidenceSynthesisSampleSize {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
...
impl<'de> serde::Deserialize<'de> for RiskEvidenceSynthesisSampleSize {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("RiskEvidenceSynthesisSampleSize");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
