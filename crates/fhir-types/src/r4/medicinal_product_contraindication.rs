...
pub struct MedicinalProductContraindication {
    ...
    pub disease: Option<super::codeable_concept::CodeableConcept>,
    ...
    pub therapeutic_indication: Vec<super::reference::Reference>,
    /// Information about the use of the medicinal product in relation to other
...
impl super::super::codec::Json for MedicinalProductContraindication {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        if let Some(item) = &self.disease {
            object.insert(
                std::string::String::from("disease"),
                super::super::codec::Value::Object(super::super::codec::Json::to_json(item)?),
            );
        }
        ...
        if !self.therapeutic_indication.is_empty() {
            let mut items = Vec::with_capacity(self.therapeutic_indication.len());
            for item in &self.therapeutic_indication {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("therapeuticIndication"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_disease: Option<&super::super::codec::Value> = None;
        ...
        let mut raw_therapeutic_indication: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("MedicinalProductContraindication") {
                ...
                "therapeuticIndication" => {
                    raw_therapeutic_indication = Some(value);
                }
                "otherTherapy" => {
        ...
        let field_disease = raw_disease
            .map(|value| {
                path.with("disease", |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(
                            super::super::codec::expect_single(value, path)?,
                            path,
        ...
        let mut field_therapeutic_indication = Vec::new();
        if let Some(raw) = raw_therapeutic_indication {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_therapeutic_indication.push(path.with_index(
                    "therapeuticIndication",
                    index,
                    |path| {
                        super::super::codec::Json::from_json(
        ...
        Ok(Self {
            ...
            disease: field_disease,
            disease_status: field_disease_status,
            comorbidity: field_comorbidity,
            therapeutic_indication: field_therapeutic_indication,
...
impl serde::Serialize for MedicinalProductContraindication {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(item) = &self.disease {
            serde::ser::SerializeMap::serialize_entry(&mut map, "disease", item)?;
        }
        if let Some(item) = &self.disease_status {
...
impl<'de> serde::Deserialize<'de> for MedicinalProductContraindication {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("MedicinalProductContraindication");
        let object =
...
pub struct MedicinalProductContraindicationOtherTherapy {
    ...
    pub medication: MedicinalProductContraindicationOtherTherapyMedication,
}

impl super::super::codec::Json for MedicinalProductContraindicationOtherTherapy {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        let mut object = super::super::codec::Object::new();
        if let Some(v) = &self.id {
            object.insert(
    ...
    fn from_json(
        ...
        let field_medication = path.with("medication", |path| {
            let suffix = raw_medication
                .suffix
                .ok_or_else(|| path.error(super::super::codec::DecodeErrorKind::MissingProperty))?;
            MedicinalProductContraindicationOtherTherapyMedication::from_json_parts(
                suffix,
...
impl serde::Serialize for MedicinalProductContraindicationOtherTherapy {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        match &self.medication {
            MedicinalProductContraindicationOtherTherapyMedication::CodeableConcept(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "medicationCodeableConcept",
                    inner.as_ref(),
            ...
            MedicinalProductContraindicationOtherTherapyMedication::Reference(inner) => {
                serde::ser::SerializeMap::serialize_entry(
                    &mut map,
                    "medicationReference",
                    inner.as_ref(),
...
impl<'de> serde::Deserialize<'de> for MedicinalProductContraindicationOtherTherapy {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path =
            super::super::codec::Path::root("MedicinalProductContraindicationOtherTherapy");
        let object =
            super::super::codec::expect_object(&value, &path).map_err(serde::de::Error::custom)?;
        super::super::codec::Json::from_json(object, &mut path).map_err(serde::de::Error::custom)
    }
...
impl MedicinalProductContraindicationOtherTherapyMedication {
