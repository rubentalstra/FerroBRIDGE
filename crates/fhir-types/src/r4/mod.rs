...
//! FHIR R4 types: the root set the enabled features select and the complete
//! closure of the datatypes and primitives it references, from `hl7.fhir.r4.core` 4.0.1.
//!
