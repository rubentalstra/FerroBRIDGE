...
impl super::super::codec::Json for Evidence {
    fn to_json(&self) -> Result<super::super::codec::Object, super::super::codec::EncodeError> {
        ...
        object.insert(
            std::string::String::from("exposureBackground"),
            super::super::codec::Value::Object(super::super::codec::Json::to_json(
                &self.exposure_background,
            )?),
        );
        if !self.exposure_variant.is_empty() {
            let mut items = Vec::with_capacity(self.exposure_variant.len());
            for item in &self.exposure_variant {
                items.push(super::super::codec::Value::Object(
                    super::super::codec::Json::to_json(item)?,
                ));
            }
            object.insert(
                std::string::String::from("exposureVariant"),
                super::super::codec::Value::Array(items),
            );
        }
    ...
    fn from_json(
        ...
        let mut raw_exposure_background: Option<&super::super::codec::Value> = None;
        let mut raw_exposure_variant: Option<&super::super::codec::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "exposureBackground" => {
                    raw_exposure_background = Some(value);
                }
                "exposureVariant" => {
                    raw_exposure_variant = Some(value);
                }
                "outcome" => {
        ...
        let field_exposure_background = path.with("exposureBackground", |path| {
            let value = raw_exposure_background
        ...
        let mut field_exposure_variant = Vec::new();
        if let Some(raw) = raw_exposure_variant {
            for (index, value) in super::super::codec::expect_array(raw, path)?
                .iter()
                .enumerate()
            {
                field_exposure_variant.push(path.with_index("exposureVariant", index, |path| {
                    super::super::codec::Json::from_json(
                        super::super::codec::expect_object(value, path)?,
                        path,
                    )
        ...
        Ok(Self {
            ...
            exposure_background: field_exposure_background,
            exposure_variant: field_exposure_variant,
