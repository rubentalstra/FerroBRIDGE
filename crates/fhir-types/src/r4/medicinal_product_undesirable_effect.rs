...
pub struct MedicinalProductUndesirableEffect {
    ...
    pub symptom_condition_effect: Option<super::codeable_concept::CodeableConcept>,
...
impl super::super::codec::Json for MedicinalProductUndesirableEffect {
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                "resourceType" => {
                    if value.as_str() != Some("MedicinalProductUndesirableEffect") {
...
impl serde::Serialize for MedicinalProductUndesirableEffect {
...
impl<'de> serde::Deserialize<'de> for MedicinalProductUndesirableEffect {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let value = <super::super::codec::Value as serde::Deserialize>::deserialize(deserializer)?;
        let mut path = super::super::codec::Path::root("MedicinalProductUndesirableEffect");
        let object =
