...
A bidirectional path model over FHIR JSON guided by the FHIR element table, for mapping engines that write resources as well as read them.
...
[FerroBRIDGE issue #81](https://github.com/rubentalstra/FerroBRIDGE/issues/81),
