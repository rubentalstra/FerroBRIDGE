...
The OMOCL mapping file model: the AST, the authored JSON schema and the projection from OMOCL columns to OMOP CDM columns.
...
[FerroBRIDGE issue #87](https://github.com/rubentalstra/FerroBRIDGE/issues/87),
