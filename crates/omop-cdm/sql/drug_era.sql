...
--
-- The PostgreSQL form of the "Drug Eras" script of the OMOP CDM SQL scripts
-- page (https://ohdsi.github.io/CommonDataModel/sqlScripts.html), source
-- site/sqlScripts.qmd of OHDSI/CommonDataModel at tag v5.4.3.
...
DROP TABLE IF EXISTS pg_temp.tmp_de;
...
(-- Normalize DRUG_EXPOSURE_END_DATE to either the existing drug exposure end date, or add days supply, or add 1 day to the start date
  ...
  JOIN @cdmDatabaseSchema.concept_ancestor ca ON ca.descendant_concept_id = d.drug_concept_id
  JOIN @cdmDatabaseSchema.concept c ON ca.ancestor_concept_id = c.concept_id
...
INSERT INTO @cdmDatabaseSchema.drug_era(drug_era_id,person_id, drug_concept_id, drug_era_start_date, drug_era_end_date, drug_exposure_count, gap_days)
SELECT
  *
FROM tmp_de;
