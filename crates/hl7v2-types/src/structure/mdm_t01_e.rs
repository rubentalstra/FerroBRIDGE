...
//! The `MDM_T01-E` message structure.
...
/// The top-level nodes of [`MDM_T01_E`], one `static` so a structure with the same tree links to it.
pub static MDM_T01_E_NODES: [Node; 14] = [
    ...
    Node::Group(Group {
        ...
        children: &[
            Node::Segment(SegmentRef {
                id: "MDM_T01-E.12-COMMON_ORDER.1-ORC",
                position: 1,
            ...
            Node::Segment(SegmentRef {
                id: "MDM_T01-E.12-COMMON_ORDER.2-PRT",
                position: 2,
                segment: &segment::prt::PRT,
                cardinality: Cardinality {
                    min: 0,
            ...
            Node::Group(Group {
                id: "MDM_T01-E.12-COMMON_ORDER.3-TIMING",
                position: 3,
                name: "TIMING",
                cardinality: Cardinality {
                    min: 0,
                ...
                children: &[
                    Node::Segment(SegmentRef {
                        id: "MDM_T01-E.12-COMMON_ORDER.3-TIMING.1-TQ1",
                        position: 1,
                    ...
                    Node::Segment(SegmentRef {
                        id: "MDM_T01-E.12-COMMON_ORDER.3-TIMING.2-TQ2",
                        position: 2,
            ...
            Node::Segment(SegmentRef {
                id: "MDM_T01-E.12-COMMON_ORDER.4-OBR",
                position: 4,
            ...
            Node::Segment(SegmentRef {
                id: "MDM_T01-E.12-COMMON_ORDER.5-PRT",
                position: 5,
                segment: &segment::prt::PRT,
                cardinality: Cardinality {
                    min: 0,
            ...
            Node::Segment(SegmentRef {
                id: "MDM_T01-E.12-COMMON_ORDER.6-NTE",
                position: 6,
