...
//! The `RSP_K23-B` message structure.
...
/// The top-level nodes of [`RSP_K23_B`], one `static` so a structure with the same tree links to it.
pub static RSP_K23_B_NODES: [Node; 9] = [
    ...
    Node::Group(Group {
        ...
        children: &[Node::Segment(SegmentRef {
            id: "RSP_K23-B.8-QUERY_RESPONSE.1-PID",
            position: 1,
