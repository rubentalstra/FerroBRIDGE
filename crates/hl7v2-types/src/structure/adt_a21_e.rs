...
//! The `ADT_A21-E` message structure.
...
/// The top-level nodes of [`ADT_A21_E`], one `static` so a structure with the same tree links to it.
pub static ADT_A21_E_NODES: [Node; 14] = [
    ...
    Node::Group(Group {
        ...
        children: &[
            Node::Segment(SegmentRef {
                id: "ADT_A21-E.14-OBSERVATION.1-OBX",
                position: 1,
            ...
            Node::Segment(SegmentRef {
                id: "ADT_A21-E.14-OBSERVATION.2-PRT",
                position: 2,
