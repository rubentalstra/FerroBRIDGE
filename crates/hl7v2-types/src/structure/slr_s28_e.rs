...
//! The `SLR_S28-E` message structure.

use crate::model::{Cardinality, Max, Node, SegmentRef, SegmentStatus, Structure};
use crate::segment;

/// The top-level nodes of [`SLR_S28_E`], one `static` so a structure with the same tree links to it.
pub static SLR_S28_E_NODES: [Node; 4] = [
