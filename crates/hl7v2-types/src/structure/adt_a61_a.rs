...
//! The `ADT_A61-A` message structure.

use crate::model::{Cardinality, Max, Node, SegmentRef, SegmentStatus, Structure};
use crate::segment;

/// The top-level nodes of [`ADT_A61_A`], one `static` so a structure with the same tree links to it.
pub static ADT_A61_A_NODES: [Node; 16] = [
...
/// The `ADT_A61-A` message structure definition, `http://hl7.org/v2/StructureDefinition/ADT_A61-A`.
pub static ADT_A61_A: Structure = Structure {
    id: "ADT_A61-A",
    url: Some("http://hl7.org/v2/StructureDefinition/ADT_A61-A"),
    version: "2.9.1",
    withdrawn_as_of: None,
    nodes: &ADT_A61_A_NODES,
};
