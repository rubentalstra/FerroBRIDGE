...
//! The `QBP_Q11-A` message structure.
...
/// The top-level nodes of [`QBP_Q11_A`], one `static` so a structure with the same tree links to it.
pub static QBP_Q11_A_NODES: [Node; 8] = [
