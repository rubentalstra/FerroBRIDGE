...
//! The `ADT_A54-A` message structure.

use crate::model::{Cardinality, Max, Node, SegmentRef, SegmentStatus, Structure};
use crate::segment;

/// The top-level nodes of [`ADT_A54_A`], one `static` so a structure with the same tree links to it.
pub static ADT_A54_A_NODES: [Node; 16] = [
...
/// The `ADT_A54-A` message structure definition, `http://hl7.org/v2/StructureDefinition/ADT_A54-A`.
pub static ADT_A54_A: Structure = Structure {
    id: "ADT_A54-A",
    url: Some("http://hl7.org/v2/StructureDefinition/ADT_A54-A"),
    version: "2.9.1",
    withdrawn_as_of: None,
    nodes: &ADT_A54_A_NODES,
};
