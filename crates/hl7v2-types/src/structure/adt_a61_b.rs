...
//! The `ADT_A61-B` message structure.

use crate::model::{Cardinality, Max, Node, SegmentRef, SegmentStatus, Structure};
use crate::segment;

/// The top-level nodes of [`ADT_A61_B`], one `static` so a structure with the same tree links to it.
pub static ADT_A61_B_NODES: [Node; 16] = [
...
/// The `ADT_A61-B` message structure definition, `http://hl7.org/v2/StructureDefinition/ADT_A61-B`.
pub static ADT_A61_B: Structure = Structure {
    id: "ADT_A61-B",
    url: Some("http://hl7.org/v2/StructureDefinition/ADT_A61-B"),
    version: "2.9.1",
    withdrawn_as_of: None,
    nodes: &ADT_A61_B_NODES,
};
