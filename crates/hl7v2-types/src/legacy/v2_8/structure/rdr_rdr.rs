...
//! The `RDR_RDR` message structure of the 2.8 tables, withdrawn as of 2.9.1.
...
pub static RDR_RDR: Structure = Structure {
    ...
    nodes: &[
        ...
        Node::Segment(SegmentRef {
            id: "RDR_RDR.2-MSA",
            position: 2,
            segment: &crate::legacy::v2_8::segment::msa::MSA,
            cardinality: Cardinality {
                min: 1,
                max: Max::Bounded(1),
            },
        ...
        Node::Segment(SegmentRef {
            id: "RDR_RDR.3-ERR",
            position: 3,
            segment: &crate::legacy::v2_8::segment::err::ERR,
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Node::Group(Group {
            ...
            children: &[
                Node::Segment(SegmentRef {
                    ...
                    position: 1,
                    segment: &crate::legacy::v2_8::segment::qrd::QRD,
                    cardinality: Cardinality {
                        min: 1,
                        max: Max::Bounded(1),
                    },
                ...
                Node::Segment(SegmentRef {
                    ...
                    position: 2,
                    segment: &crate::legacy::v2_8::segment::qrf::QRF,
                    cardinality: Cardinality {
                        min: 0,
                        max: Max::Bounded(1),
                    },
                        ...
                        Node::Group(Group {
                            ...
                            children: &[
                                ...
                                Node::Segment(SegmentRef {
                                    ...
                                    position: 3,
                                    segment: &crate::legacy::v2_8::segment::rxr::RXR,
                                    cardinality: Cardinality {
                                        min: 1,
                                        max: Max::Unbounded,
                                    },
