...
/// The `OBR` segment of the 2.8.1 tables.
pub static OBR: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_8_1::data_type::MOC)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 26,
            name: "Parent Result +",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_8_1::data_type::PRL)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_8_1::data_type::EIP)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_8_1::data_type::NDL)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
