...
/// The `MSH` segment of the 2.8.2 tables.
pub static MSH: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            position: 9,
            name: "Message Type",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_8_2::data_type::MSG)),
            cardinality: Cardinality {
                min: 1,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 11,
            name: "Processing ID",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_8_2::data_type::PT)),
            cardinality: Cardinality {
                min: 1,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 12,
            name: "Version ID",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_8_2::data_type::VID)),
            cardinality: Cardinality {
                min: 1,
                max: Max::Bounded(1),
            },
