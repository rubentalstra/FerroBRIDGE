...
/// The `OM2` segment of the 2.7.1 tables.
pub static OM2: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_7_1::data_type::RFR)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_7_1::data_type::DLT)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
