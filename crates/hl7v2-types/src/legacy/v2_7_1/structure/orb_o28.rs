...
//! The `ORB_O28` message structure of the 2.7.1 tables.
    ...
    Node::Group(Group {
        ...
        children: &[Node::Group(Group {
            ...
            children: &[
                ...
                Node::Group(Group {
                    id: "ORB_O28.7-RESPONSE.1-PATIENT.2-ORDER",
                    position: 2,
                    name: "ORDER",
                    cardinality: Cardinality {
                        min: 0,
                    ...
                    children: &[
                        Node::Segment(SegmentRef {
                            id: "ORB_O28.7-RESPONSE.1-PATIENT.2-ORDER.1-ORC",
                            position: 1,
                        ...
                        Node::Group(Group {
                            id: "ORB_O28.7-RESPONSE.1-PATIENT.2-ORDER.2-TIMING",
                            position: 2,
                            name: "TIMING",
                            cardinality: Cardinality {
                                min: 0,
                            ...
                            children: &[
                                Node::Segment(SegmentRef {
                                    id: "ORB_O28.7-RESPONSE.1-PATIENT.2-ORDER.2-TIMING.1-TQ1",
                                    position: 1,
                                ...
                                Node::Segment(SegmentRef {
                                    id: "ORB_O28.7-RESPONSE.1-PATIENT.2-ORDER.2-TIMING.2-TQ2",
                                    position: 2,
                        ...
                        Node::Segment(SegmentRef {
                            id: "ORB_O28.7-RESPONSE.1-PATIENT.2-ORDER.3-BPO",
                            position: 3,
