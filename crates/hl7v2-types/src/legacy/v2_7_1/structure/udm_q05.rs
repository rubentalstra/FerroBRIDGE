...
//! The `UDM_Q05` message structure of the 2.7.1 tables, withdrawn as of 2.9.1.
...
pub static UDM_Q05: Structure = Structure {
    ...
    nodes: &[
        ...
        Node::Segment(SegmentRef {
            id: "UDM_Q05.4-URD",
            position: 4,
            segment: &crate::legacy::v2_7_1::segment::urd::URD,
            cardinality: Cardinality {
                min: 1,
                max: Max::Bounded(1),
            },
        ...
        Node::Segment(SegmentRef {
            id: "UDM_Q05.5-URS",
            position: 5,
            segment: &crate::legacy::v2_7_1::segment::urs::URS,
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
