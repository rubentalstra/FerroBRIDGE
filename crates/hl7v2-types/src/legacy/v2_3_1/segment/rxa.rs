...
//! The `RXA` segment: RXA - pharmacy/treatment administration segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `RXA` segment of the 2.3.1 tables.
pub static RXA: Segment = Segment {
    id: "RXA",
    url: None,
    name: "RXA - pharmacy/treatment administration segment",
    fields: &[
        Field {
            id: "RXA.1",
            position: 1,
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_3_1::data_type::LA2)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0227,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
