...
//! The `AIP` segment: AIP - appointment information - personnel resource segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `AIP` segment of the 2.3.1 tables.
pub static AIP: Segment = Segment {
    id: "AIP",
    url: None,
    name: "AIP - appointment information - personnel resource segment",
    fields: &[
        Field {
            id: "AIP.1",
            position: 1,
