...
//! The `ODS` segment: ODS - dietary orders, supplements, and preferences segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `ODS` segment of the 2.3.1 tables.
pub static ODS: Segment = Segment {
    id: "ODS",
    url: None,
    name: "ODS - dietary orders, supplements, and preferences segment",
    fields: &[
        Field {
            id: "ODS.1",
            position: 1,
