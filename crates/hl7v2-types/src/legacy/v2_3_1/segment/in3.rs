...
//! The `IN3` segment: IN3 - insurance additional information, certification segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `IN3` segment of the 2.3.1 tables.
pub static IN3: Segment = Segment {
    id: "IN3",
    url: None,
    name: "IN3 - insurance additional information, certification segment",
    fields: &[
        Field {
            id: "IN3.1",
            position: 1,
        ...
        Field {
            ...
            position: 5,
            name: "Penalty",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_3_1::data_type::MOP)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 11,
            name: "Days",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_3_1::data_type::DTN)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0233,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            name: "Appeal Reason",
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0345,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0346,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_3_1::data_type::PCF)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
