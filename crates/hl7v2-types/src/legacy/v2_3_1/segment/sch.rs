...
//! The `SCH` segment: SCH - schedule activity information segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `SCH` segment of the 2.3.1 tables.
pub static SCH: Segment = Segment {
    id: "SCH",
    url: None,
    name: "SCH - schedule activity information segment",
    fields: &[
        Field {
            id: "SCH.1",
            position: 1,
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0276,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0277,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
