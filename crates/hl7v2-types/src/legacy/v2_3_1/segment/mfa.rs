...
//! The `MFA` segment: MFA - master file acknowledgment segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `MFA` segment of the 2.3.1 tables.
pub static MFA: Segment = Segment {
    id: "MFA",
    url: None,
    name: "MFA - master file acknowledgment segment",
    fields: &[
        Field {
            id: "MFA.1",
            position: 1,
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0181,
            )),
            cardinality: Cardinality {
                min: 1,
                max: Max::Bounded(1),
