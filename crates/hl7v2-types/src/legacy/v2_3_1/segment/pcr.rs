...
//! The `PCR` segment: PCR - possible causal relationship segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `PCR` segment of the 2.3.1 tables.
pub static PCR: Segment = Segment {
    id: "PCR",
    url: None,
    name: "PCR - possible causal relationship segment",
    fields: &[
        Field {
            id: "PCR.1",
            position: 1,
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0247,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
