...
//! The `RXE` segment: RXE - pharmacy/treatment encoded order segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `RXE` segment of the 2.3.1 tables.
pub static RXE: Segment = Segment {
    id: "RXE",
    url: None,
    name: "RXE - pharmacy/treatment encoded order segment",
    fields: &[
        Field {
            id: "RXE.1",
            position: 1,
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3_1::data_type::CE_0292,
            )),
            cardinality: Cardinality {
                min: 1,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_3_1::data_type::LA1)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
