...
//! The `AIG` segment: AIG - appointment information - general resource segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `AIG` segment of the 2.3.1 tables.
pub static AIG: Segment = Segment {
    id: "AIG",
    url: None,
    name: "AIG - appointment information - general resource segment",
    fields: &[
        Field {
            id: "AIG.1",
            position: 1,
