...
/// The `ERR` segment of the 2.5.1 tables.
pub static ERR: Segment = Segment {
    ...
    fields: &[
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::ELD)),
        ...
        Field {
            ...
            position: 2,
            name: "Error Location",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::ERL)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
