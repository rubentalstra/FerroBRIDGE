...
/// The `IN3` segment of the 2.5.1 tables.
pub static IN3: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            position: 5,
            name: "Penalty",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::MOP)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 11,
            name: "Days",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::DTN)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::ICD)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
