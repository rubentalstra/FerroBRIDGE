...
/// The `IN2` segment of the 2.5.1 tables.
pub static IN2: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::RMC)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::PTA)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::DDI)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 47,
            name: "Job Code/Class",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5_1::data_type::JCC)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
