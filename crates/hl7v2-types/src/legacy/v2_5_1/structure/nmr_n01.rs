...
//! The `NMR_N01` message structure of the 2.5.1 tables, withdrawn as of 2.7.
...
pub static NMR_N01_NODES: [Node; 6] = [
    ...
    Node::Group(Group {
        id: "NMR_N01.6-CLOCK_AND_STATS_WITH_NOTES_ALT",
        position: 6,
        ...
        children: &[
            Node::Segment(SegmentRef {
                id: "NMR_N01.6-CLOCK_AND_STATS_WITH_NOTES_ALT.1-NCK",
                position: 1,
            ...
            Node::Segment(SegmentRef {
                id: "NMR_N01.6-CLOCK_AND_STATS_WITH_NOTES_ALT.2-NTE",
                position: 2,
            ...
            Node::Segment(SegmentRef {
                id: "NMR_N01.6-CLOCK_AND_STATS_WITH_NOTES_ALT.3-NST",
                position: 3,
            ...
            Node::Segment(SegmentRef {
                id: "NMR_N01.6-CLOCK_AND_STATS_WITH_NOTES_ALT.4-NTE",
                position: 4,
                segment: &crate::legacy::v2_5::segment::nte::NTE,
                cardinality: Cardinality {
                    min: 0,
            ...
            Node::Segment(SegmentRef {
                id: "NMR_N01.6-CLOCK_AND_STATS_WITH_NOTES_ALT.5-NSC",
                position: 5,
            ...
            Node::Segment(SegmentRef {
                id: "NMR_N01.6-CLOCK_AND_STATS_WITH_NOTES_ALT.6-NTE",
                position: 6,
                segment: &crate::legacy::v2_5::segment::nte::NTE,
                cardinality: Cardinality {
                    min: 0,
