...
//! The `ORB_O28` message structure of the 2.5.1 tables.
...
pub static ORB_O28_NODES: [Node; 6] = [
    ...
    Node::Group(Group {
        ...
        children: &[Node::Group(Group {
            id: "ORB_O28.6-RESPONSE.1-PATIENT",
            position: 1,
            name: "PATIENT",
            cardinality: Cardinality {
                min: 0,
            ...
            children: &[
                Node::Segment(SegmentRef {
                    id: "ORB_O28.6-RESPONSE.1-PATIENT.1-PID",
                    position: 1,
                ...
                Node::Group(Group {
                    id: "ORB_O28.6-RESPONSE.1-PATIENT.2-ORDER",
                    position: 2,
                    name: "ORDER",
                    cardinality: Cardinality {
                        min: 0,
                    ...
                    children: &[
                        Node::Segment(SegmentRef {
                            id: "ORB_O28.6-RESPONSE.1-PATIENT.2-ORDER.1-ORC",
                            position: 1,
                        ...
                        Node::Group(Group {
                            id: "ORB_O28.6-RESPONSE.1-PATIENT.2-ORDER.2-TIMING",
                            position: 2,
                            name: "TIMING",
                            cardinality: Cardinality {
                                min: 0,
                            ...
                            children: &[
                                Node::Segment(SegmentRef {
                                    id: "ORB_O28.6-RESPONSE.1-PATIENT.2-ORDER.2-TIMING.1-TQ1",
                                    position: 1,
                                ...
                                Node::Segment(SegmentRef {
                                    id: "ORB_O28.6-RESPONSE.1-PATIENT.2-ORDER.2-TIMING.2-TQ2",
                                    position: 2,
                        ...
                        Node::Segment(SegmentRef {
                            id: "ORB_O28.6-RESPONSE.1-PATIENT.2-ORDER.3-BPO",
                            position: 3,
