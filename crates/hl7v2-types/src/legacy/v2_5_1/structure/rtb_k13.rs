...
//! The `RTB_K13` message structure of the 2.5.1 tables.
...
pub static RTB_K13_NODES: [Node; 8] = [
    ...
    Node::Group(Group {
        ...
        children: &[
            Node::Segment(SegmentRef {
                id: "RTB_K13.7-ROW_DEFINITION.1-RDF",
                position: 1,
            ...
            Node::Segment(SegmentRef {
                id: "RTB_K13.7-ROW_DEFINITION.2-RDT",
                position: 2,
