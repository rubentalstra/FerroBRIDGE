...
pub static ORF_R04_NODES: [Node; 9] = [
    ...
    Node::Group(Group {
        ...
        children: &[
            ...
            Node::Group(Group {
                id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER",
                position: 2,
                name: "ORDER",
                cardinality: Cardinality {
                    min: 1,
                ...
                children: &[
                    Node::Segment(SegmentRef {
                        id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.1-ORC",
                        position: 1,
                    ...
                    Node::Segment(SegmentRef {
                        id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.2-OBR",
                        position: 2,
                    ...
                    Node::Segment(SegmentRef {
                        id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.3-NTE",
                        position: 3,
                        segment: &crate::legacy::v2_5::segment::nte::NTE,
                        cardinality: Cardinality {
                            min: 0,
                    ...
                    Node::Group(Group {
                        id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.4-TIMING_QTY",
                        position: 4,
                        name: "TIMING_QTY",
                        cardinality: Cardinality {
                            min: 0,
                        ...
                        children: &[
                            Node::Segment(SegmentRef {
                                id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.4-TIMING_QTY.1-TQ1",
                                position: 1,
                            ...
                            Node::Segment(SegmentRef {
                                id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.4-TIMING_QTY.2-TQ2",
                                position: 2,
                    ...
                    Node::Segment(SegmentRef {
                        id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.5-CTD",
                        position: 5,
                    ...
                    Node::Group(Group {
                        id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.6-OBSERVATION",
                        position: 6,
                        name: "OBSERVATION",
                        cardinality: Cardinality {
                            min: 1,
                        ...
                        children: &[
                            Node::Segment(SegmentRef {
                                id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.6-OBSERVATION.1-OBX",
                                position: 1,
                            ...
                            Node::Segment(SegmentRef {
                                id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.6-OBSERVATION.2-NTE",
                                position: 2,
                                segment: &crate::legacy::v2_5::segment::nte::NTE,
                                cardinality: Cardinality {
                                    min: 0,
                    ...
                    Node::Segment(SegmentRef {
                        id: "ORF_R04.6-QUERY_RESPONSE.2-ORDER.7-CTI",
                        position: 7,
