...
/// The `OBR` segment of the 2.6 tables.
pub static OBR: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_6::data_type::MOC)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 26,
            name: "Parent Result +",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_6::data_type::PRL)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_6::data_type::NDL)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
