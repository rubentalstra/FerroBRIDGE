        ...
        children: &[
            ...
            Node::Group(Group {
                ...
                children: &[
                    ...
                    Node::Group(Group {
                        id: "RDR_RDR.6-DEFINITION.4-ORDER.2-ENCODING",
                        position: 2,
                        name: "ENCODING",
                        cardinality: Cardinality {
                            min: 0,
                        ...
                        children: &[
                            Node::Segment(SegmentRef {
                                id: "RDR_RDR.6-DEFINITION.4-ORDER.2-ENCODING.1-RXE",
                                position: 1,
                            ...
                            Node::Segment(SegmentRef {
                                id: "RDR_RDR.6-DEFINITION.4-ORDER.2-ENCODING.2-RXR",
                                position: 2,
                            ...
                            Node::Segment(SegmentRef {
                                id: "RDR_RDR.6-DEFINITION.4-ORDER.2-ENCODING.3-RXC",
                                position: 3,
                    ...
                    Node::Group(Group {
                        id: "RDR_RDR.6-DEFINITION.4-ORDER.3-DISPENSE",
                        position: 3,
                        name: "DISPENSE",
                        cardinality: Cardinality {
                            min: 1,
                        ...
                        children: &[
                            Node::Segment(SegmentRef {
                                id: "RDR_RDR.6-DEFINITION.4-ORDER.3-DISPENSE.1-RXD",
                                position: 1,
                            ...
                            Node::Segment(SegmentRef {
                                id: "RDR_RDR.6-DEFINITION.4-ORDER.3-DISPENSE.2-RXR",
                                position: 2,
                                segment: &crate::legacy::v2_6::segment::rxr::RXR,
                                cardinality: Cardinality {
                                    min: 1,
                            ...
                            Node::Segment(SegmentRef {
                                id: "RDR_RDR.6-DEFINITION.4-ORDER.3-DISPENSE.3-RXC",
                                position: 3,
                                segment: &crate::legacy::v2_6::segment::rxc::RXC,
                                cardinality: Cardinality {
                                    min: 0,
