...
/// The `INV` segment of the 2.4 tables.
    ...
    fields: &[
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0451,
            )),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0383,
            )),
            cardinality: Cardinality {
                min: 1,
                max: Max::Unbounded,
        ...
        Field {
            ...
            name: "Substance Type",
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0384,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0385,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0386,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
