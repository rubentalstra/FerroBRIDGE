...
/// The `STF` segment of the 2.4 tables.
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0184,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0069,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::DIN)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0185,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
