    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0048,
            )),
            cardinality: Cardinality {
                min: 1,
                max: Max::Unbounded,
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::VR)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
