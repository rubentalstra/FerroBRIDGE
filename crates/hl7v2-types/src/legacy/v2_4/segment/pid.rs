...
/// The `PID` segment of the 2.4 tables.
pub static PID: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::DLN)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0172,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::HD)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            name: "Species Code",
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0446,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            name: "Breed Code",
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0447,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0429,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
