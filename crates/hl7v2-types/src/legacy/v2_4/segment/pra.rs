...
/// The `PRA` segment of the 2.4 tables.
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0358,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
        ...
        Field {
            ...
            position: 5,
            name: "Specialty",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::SPD)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::PLN)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            position: 7,
            name: "Privileges",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::PIP)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0401,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
