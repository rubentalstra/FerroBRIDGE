...
/// The `UB1` segment of the 2.4 tables.
pub static UB1: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::UVC)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(8),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0348,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0349,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_4::data_type::OCD)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(5),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_4::data_type::CE_0351,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
