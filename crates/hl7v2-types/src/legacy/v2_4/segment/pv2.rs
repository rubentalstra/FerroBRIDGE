...
pub static PV2: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CE_0430")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CE_0431")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CE_0432")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CE_0433")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CE_0434")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CE_0435")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
