...
/// The `PV1` segment of the 2.3 tables.
pub static PV1: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_3::data_type::CM_DLD)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            table: Some(Table {
                id: "0192",
                value_set: "http://terminology.hl7.org/ValueSet/v2-0192",
            }),
            standards_status: None,
        },
        Field {
