...
pub static OBR: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CM_SPS")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CM_MOC")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 26,
            name: "Parent Result",
            data_type: Some(DataTypeRef::Legacy("CM_PRL")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            position: 29,
            name: "Parent Number",
            data_type: Some(DataTypeRef::Legacy("CM_EIP")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy("CM_NDL")),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
