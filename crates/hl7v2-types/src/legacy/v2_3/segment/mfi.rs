...
//! The `MFI` segment: Master file identification segment.

use crate::model::{Cardinality, DataTypeRef, Field, Length, Max, Optionality, Segment, Table};

/// The `MFI` segment of the 2.3 tables.
pub static MFI: Segment = Segment {
    id: "MFI",
    url: None,
    name: "Master file identification segment",
    fields: &[
        Field {
            id: "MFI.1",
            position: 1,
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3::data_type::CE_0175,
            )),
        ...
        Field {
            ...
            table: Some(Table {
                id: "0176",
                value_set: "http://terminology.hl7.org/ValueSet/v2-0176",
            }),
            standards_status: None,
        },
        Field {
