...
pub static NTE: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            position: 3,
            name: "Comment",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_3::data_type::FT)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
