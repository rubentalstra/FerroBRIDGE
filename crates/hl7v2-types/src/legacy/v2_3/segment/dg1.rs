...
/// The `DG1` segment of the 2.3 tables.
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3::data_type::CE_0051,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3::data_type::CE_0118,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3::data_type::CE_0055,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
        ...
        Field {
            ...
            name: "Outlier Type",
            data_type: Some(DataTypeRef::Legacy(
                &crate::legacy::v2_3::data_type::CE_0083,
            )),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
