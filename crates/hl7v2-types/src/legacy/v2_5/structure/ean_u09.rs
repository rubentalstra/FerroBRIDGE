...
//! The `EAN_U09` message structure of the 2.5 tables.
...
pub static EAN_U09_NODES: [Node; 5] = [
    ...
    Node::Group(Group {
        ...
        children: &[
            Node::Segment(SegmentRef {
                id: "EAN_U09.4-NOTIFICATION.1-NDS",
                position: 1,
                segment: &crate::legacy::v2_5::segment::nds::NDS,
                cardinality: Cardinality {
                    min: 1,
                    max: Max::Bounded(1),
                },
            ...
            Node::Segment(SegmentRef {
                id: "EAN_U09.4-NOTIFICATION.2-NTE",
                position: 2,
