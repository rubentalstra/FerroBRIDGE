...
//! The `ADT_A01` message structure of the 2.5 tables.
...
pub static ADT_A01_NODES: [Node; 22] = [
    ...
    Node::Segment(SegmentRef {
        id: "ADT_A01.22-PDA",
        position: 22,
        segment: &crate::legacy::v2_5::segment::pda::PDA,
        cardinality: Cardinality {
            min: 0,
            max: Max::Bounded(1),
        },
