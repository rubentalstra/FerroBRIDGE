...
/// The `STF` segment of the 2.5 tables.
pub static STF: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5::data_type::DIN)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5::data_type::DLN)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5::data_type::DR)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Bounded(1),
            },
