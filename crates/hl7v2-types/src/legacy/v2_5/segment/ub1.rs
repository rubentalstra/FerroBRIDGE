...
/// The `UB1` segment of the 2.5 tables.
pub static UB1: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5::data_type::UVC)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5::data_type::OCD)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
