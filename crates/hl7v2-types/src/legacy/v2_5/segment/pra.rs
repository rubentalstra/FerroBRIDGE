...
/// The `PRA` segment of the 2.5 tables.
pub static PRA: Segment = Segment {
    ...
    fields: &[
        ...
        Field {
            ...
            position: 5,
            name: "Specialty",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5::data_type::SPD)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
        ...
        Field {
            ...
            position: 7,
            name: "Privileges",
            data_type: Some(DataTypeRef::Legacy(&crate::legacy::v2_5::data_type::PIP)),
            cardinality: Cardinality {
                min: 0,
                max: Max::Unbounded,
            },
