...
version is 0.0.2-rc.1.

| Item | Pin | Repeated in |
|---|---|---|
| Product version | 0.0.2-rc.1 | root `Cargo.toml` `[workspace.package]` `version` (#20), `CITATION.cff` `version` (#18), the `ghcr.io/rubentalstra/ferrobridge` image tag default in `compose.yaml` (#22) |
