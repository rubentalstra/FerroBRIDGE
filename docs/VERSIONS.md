...
| `openehr-query` | 0.0.69 | `docs/architecture.md`, later the root `Cargo.toml` `[workspace.dependencies]` |
...
| Item | Pin | Repeated in |
|---|---|---|
| Product version | 0.0.2 | root `Cargo.toml` `[workspace.package]` `version` (#20), `CITATION.cff` `version` (#18), the `ghcr.io/rubentalstra/ferrobridge` image tag default in `compose.yaml` (#22) |
