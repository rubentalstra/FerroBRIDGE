...
(`fhir-types`, `hl7v2-types`, `openehr-mapping-core`, `fhirconnect`, `omocl`,
`omop-cdm`, `ferrobridge-term`, `ferrobridge-hl7v2`) so other projects can
depend on them. The server (`app/*`) and the tools (`tools/*`) are never
published.
